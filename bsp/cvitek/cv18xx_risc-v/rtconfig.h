...
#define SOC_TYPE_CV180XB_QFN
#define BOARD_TYPE_MILKV_DUO_SPINOR
#define BSP_ROOTFS_TYPE_DISKFS
#define CVI_COMPS_ENABLE
#define CVI_OSDRV_ENABLE
#define CVI_MPI_ENABLE
#define CVI_MEDIA_PLAT_ENABLE
