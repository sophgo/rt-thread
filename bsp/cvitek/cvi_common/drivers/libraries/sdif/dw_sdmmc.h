...
#define DW_SDIO0_BASE               0x04300000
#define DW_SDIO1_BASE               0x04310000
#define DW_SDIO2_BASE               0x04320000
...
/*
* EMMC Card is connected to SDIO0
* SD Card is connected to SDIO1
* WIFI Card is connected to SDIO2
*/
#define SDIO0_IRQ           BSP_SDIO0_IRQ_BASE
#define SDIO1_IRQ           BSP_SDIO1_IRQ_BASE
#define SDIO2_IRQ           BSP_SDIO2_IRQ_BASE
#define SDIO0_BASE          DW_SDIO0_BASE
#define SDIO1_BASE          DW_SDIO1_BASE
