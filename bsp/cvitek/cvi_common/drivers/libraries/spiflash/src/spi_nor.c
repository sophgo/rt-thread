...
#define INFO(_jedec_id, _ext_id, _sector_size, _n_sectors, _flags)                           \
    .id =                                                                                    \
        {                                                                                    \
            ((_jedec_id) >> 16) & 0xff, ((_jedec_id) >> 8) & 0xff, (_jedec_id) & 0xff,       \
            ((_ext_id) >> 8) & 0xff,    (_ext_id) & 0xff,                                    \
    },                                                                                       \
    .id_len = (!(_jedec_id) ? 0 : (3 + ((_ext_id) ? 2 : 0))), .sector_size = (_sector_size), \
    .n_sectors = (_n_sectors), .page_size = 256, .flags = (_flags),

const struct flash_info spi_flash_ids[] = {
    /* The CVITEK Support List Of Spi Nor Flash */
    {"JY25VQ128A", INFO(0x1c4018, 0x0, 64 * 1024, 256, RD_FULL | WR_FULL | SECT_4K)},
    {"JY25VQ64A", INFO(0x4a4017, 0x0, 64 * 1024, 128, RD_FULL | WR_FULL | SECT_4K)},
    /* Juyang 32M Nor Flash(JY25VQ256A) uses the same wafers as MXIC */
    {"MX25L25645G",
     INFO(0xc22019, 0x0, 64 * 1024, 512, RD_FULL | WR_FULL | SECT_4K | NOR_4B_OPCODES)},
    {"MX25L12835F", INFO(0xc22018, 0x0, 64 * 1024, 256, RD_FULL | WR_FULL | SECT_4K)},
    {"EN25QH128A", INFO(0x1c7018, 0x0, 64 * 1024, 256, RD_FULL | WR_FULL | SECT_4K)},
    {"EN25QX128A", INFO(0x1c7118, 0x0, 64 * 1024, 256, RD_FULL | WR_FULL | SECT_4K)},
    {"EN25QH256A",
     INFO(0x1c7019, 0x0, 64 * 1024, 512, RD_FULL | WR_FULL | SECT_4K | NOR_4B_OPCODES)},
    {"W25Q256JV-IQ",
     INFO(0xef4019, 0x0, 64 * 1024, 512, RD_FULL | WR_FULL | SECT_4K | NOR_4B_OPCODES)},
    {"W25Q128JV-IQ", INFO(0xef4018, 0x0, 64 * 1024, 256, RD_FULL | WR_FULL | SECT_4K)},
    {"W25Q64JV-IQ", INFO(0xef4017, 0x0, 64 * 1024, 128, RD_FULL | WR_FULL | SECT_4K)},
    {"GD25Q128E", INFO(0xc84018, 0x0, 64 * 1024, 256, RD_FULL | WR_FULL | SECT_4K)},
    {"GD25Q256E",
     INFO(0xc84019, 0x0, 64 * 1024, 512, RD_FULL | WR_FULL | SECT_4K | NOR_4B_OPCODES)},
    {"GD25Q64E", INFO(0xc84017, 0x0, 64 * 1024, 128, RD_FULL | WR_FULL | SECT_4K)},
    {"XM25QH64C", INFO(0x204017, 0x0, 64 * 1024, 128, RD_FULL | WR_FULL | SECT_4K)},
    {"XM25QH128C", INFO(0x204018, 0x0, 64 * 1024, 256, RD_FULL | WR_FULL | SECT_4K)},
    {"XM25QH256C",
     INFO(0x204019, 0x0, 64 * 1024, 512, RD_FULL | WR_FULL | SECT_4K | NOR_4B_OPCODES)},
    {"XM25QH256B",
     INFO(0x206019, 0x0, 64 * 1024, 512, RD_FULL | WR_FULL | SECT_4K | NOR_4B_OPCODES)},
    {"XM25QU256B",
     INFO(0x207019, 0x0, 64 * 1024, 512, RD_FULL | WR_FULL | SECT_4K | NOR_4B_OPCODES)},
    {"IS25LP128F", INFO(0x9d6018, 0x0, 64 * 1024, 256, RD_FULL | WR_FULL | SECT_4K)},
    {"IS25LP256E",
     INFO(0x9d6019, 0x0, 64 * 1024, 512, RD_FULL | WR_FULL | SECT_4K | NOR_4B_OPCODES)},
    {"KH25L6433FM2I", INFO(0xc22017, 0x0, 64 * 1024, 128, RD_FULL | WR_FULL | SECT_4K)},
    //{ "KH25L12833FM2I", INFO(0xc22018, 0x0, 64 * 1024, 256,
    //      RD_FULL | SECT_4K) },
    {"ZB25VQ32D", INFO(0x5E4016, 0x0, 64 * 1024, 64, RD_FULL | WR_FULL | SECT_4K)},
    {"ZB25VQ64B", INFO(0x5E4017, 0x0, 64 * 1024, 128, RD_FULL | WR_FULL | SECT_4K)},
    {"ZB25Q256A",
     INFO(0x5E4019, 0x0, 64 * 1024, 512, RD_FULL | WR_FULL | SECT_4K | NOR_4B_OPCODES)},
    {"ZB25VQ128A", INFO(0x5E4018, 0x0, 64 * 1024, 256, RD_FULL | WR_FULL | SECT_4K)},
    {"ZB25VQ128D", INFO(0x5E8018, 0x0, 64 * 1024, 256, RD_FULL | WR_FULL | SECT_4K)},
    {"S25FL128L",
     INFO(0x016018, 0x0, 64 * 1024, 256, RD_FULL | WR_QPP | SECT_4K | _10_DUMMY_CYCLE)},
    {"S25FL256L", INFO(0x016019, 0x0, 64 * 1024, 512,
                       RD_FULL | WR_QPP | SECT_4K | NOR_4B_OPCODES | _10_DUMMY_CYCLE)},
    {"XT25F64F", INFO(0x0B4017, 0x0, 64 * 1024, 128, RD_FULL | WR_QPP | SECT_4K)},
    {"XT25F128F", INFO(0x0B4018, 0x0, 64 * 1024, 256, RD_FULL | WR_QPP | SECT_4K)},
    {"FM25Q64", INFO(0xF83217, 0x0, 64 * 1024, 128, RD_FULL | WR_QPP | SECT_4K)},
    {"FM25Q64A", INFO(0xA14017, 0x0, 64 * 1024, 128, RD_FULL | WR_QPP | SECT_4K)},
    {"FM25Q128A", INFO(0xA14018, 0x0, 64 * 1024, 128, RD_FULL | WR_QPP | SECT_4K)},
    {"BY25Q64ES", INFO(0x684017, 0x0, 64 * 1024, 128, RD_FULL | WR_QPP | SECT_4K)},
    {"BY25Q128AS", INFO(0x684018, 0x0, 64 * 1024, 256, RD_FULL | WR_QPP | SECT_4K)},
    {"BY25Q256FS",
     INFO(0x684919, 0x0, 64 * 1024, 512, RD_FULL | WR_QPP | SECT_4K | NOR_4B_OPCODES)},
    {"PY25Q128HA", INFO(0x852018, 0x0, 64 * 1024, 256, RD_FULL | WR_QPP | SECT_4K)},
    {"PY25Q64HA", INFO(0x852017, 0x0, 64 * 1024, 128, RD_FULL | WR_QPP | SECT_4K)},
    {"P25Q64SH", INFO(0x856017, 0x0, 64 * 1024, 128, RD_FULL | WR_QPP | SECT_4K)},
    {"PY25Q256H",
     INFO(0x852019, 0x0, 64 * 1024, 512, RD_FULL | WR_FULL | SECT_4K | NOR_4B_OPCODES)},
    {"GM25Q64A", INFO(0x1c4017, 0x0, 64 * 1024, 128, RD_FULL | WR_QPP | SECT_4K)},
    {"GD25F64F", INFO(0xc84317, 0x0, 64 * 1024, 128,
                      RD_FULL | WR_QPP | SECT_4K | _10_DUMMY_CYCLE | NO_QE | ADJUST_DUMMY)},
    {"TH25Q64HA", INFO(0xCD6017, 0x0, 64 * 1024, 128, RD_FULL | WR_QPP | SECT_4K)},
...
void print_message(struct spi_nor *nor)
{
    ...
    printf("\tnor flash:%s\n", info->name);
    printf("\tID:");
    for (i = 0; i < info->id_len; i++) printf("%x ", info->id[i]);
    printf("\n");
...
static uint8_t spi_nor_convert_opcode(uint8_t opcode, const uint8_t table[][2], int size)
{
    int i;

    for (i = 0; i < size; i++)
        if (table[i][0] == opcode) return table[i][1];
                                                ...
                                                uint32_t base_time, uint64_t time)
{
    ...
    while (!timeout) {
        ...
        if (op == ERASE)
            rt_hw_us_delay(base_time * 1000);
        else
            rt_hw_us_delay(base_time);
...
const struct erase_op erase_op[4] = {{CVI_SPINOR_OP_SE, 0x10000, 400, "block erase"},
...
int cvi_spif_erase(struct spi_nor *nor, uint32_t to, uint32_t len)
{
    ...
    if (len == info->sector_size * info->n_sectors) {
        ...
        while (len) {
            ...
            if (adjust_erase_argumen(nor, &op, to, len)) return -1;
...
int spi_nor_rescan(struct spi_nor *nor)
{
    ...
    if (info->flags & ADJUST_DUMMY) set_dummy(nor);

#define USE_4K_ERASE_SECTION
    ...
    if (nor->addr_width == 4 && (info->flags & NOR_4B_OPCODES)) {
        ...
        if (ret) printf("set 4 bytes for flash failed!\n");
    }
    return 0;
}
