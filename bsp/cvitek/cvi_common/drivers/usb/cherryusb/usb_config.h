...
#define CONFIG_USB_DWC2_DMA_ENABLE 1
#define CONFIG_USB_BULK_UVC 0
#define CONFIG_UVC_SWITCH_BY_PIN 0

// TODO: modify to 2 would lead to vi event handlder create failed
// #define CONFIG_USBD_UVC_NUM 2
#define CONFIG_USBD_UVC_NUM 1
#define CONFIG_UVC_MJPEG_BITRATE 20480
#define CONFIG_UVC_H264_H265_BITRATE 4096
#define CONFIG_UVC_CROP_BEFORE_SCALE 0
#define CONFIG_UVC_COMM_FUNC 1
