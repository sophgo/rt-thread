...
MSH_CMD_EXPORT_ALIAS(winusb_in_test, winusb_in_test, usb winusb_in_test input);
...
MSH_CMD_EXPORT_ALIAS(winusb_out_test, winusb_out_test, usb winusb_out_test  output);