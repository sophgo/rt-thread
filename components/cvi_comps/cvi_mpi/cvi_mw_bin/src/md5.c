...
static void md5_block_data_order(MD5_CTX *c, const void *data_, size_t num)
{
    ...
    for (; num--;) {
        ...
        unsigned MD32_REG_T XX0, XX1, XX2, XX3, XX4, XX5, XX6, XX7, XX8, XX9, XX10, XX11, XX12,
            XX13, XX14, XX15;
#define X(i) XX##i
#else
...
static Int32 MD5_Init(MD5_CTX *c)
{
    c->A   = INIT_DATA_A;
    c->B   = INIT_DATA_B;
    c->C   = INIT_DATA_C;
...
static Int32 MD5_Update(MD5_CTX *c, const void *data_, size_t len)
{
    const unsigned char *data = data_;
    unsigned char       *p;
    Uint32               l;
...
static Int32 MD5_Final(Uint8 *md, MD5_CTX *c)
{
...
static void MD5(const Uint8 *d, size_t n, Uint8 *md)
{
    MD5_CTX c;
