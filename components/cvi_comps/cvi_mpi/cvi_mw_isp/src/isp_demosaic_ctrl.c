...
static CVI_U8 cfa_ghp_lut[32] = {8,  8,  8,  8,  10, 10, 10, 10, 12, 12, 12, 12, 14, 14, 14, 14,
                                 16, 16, 16, 16, 20, 20, 20, 20, 24, 24, 24, 24, 28, 28, 31, 31};

const struct isp_module_ctrl demosaic_mod = {.init    = isp_demosaic_ctrl_init,
...
static CVI_S32 isp_demosaic_ctrl_preprocess(VI_PIPE ViPipe, ISP_ALGO_RESULT_S *algoResult)
{
    ...
    if (!demosaic_attr->Enable || runtime->is_module_bypass) return ret;
...
#undef AUTO
    ...
    for (CVI_U32 i = 0; i < 2; i++) {
        ...
        runtime->demosaic_param_in.DetailGaintOut[i] =
            runtime->demosaic_demoire_attr.DetailGaintOut[i];
    }
...
static CVI_S32 isp_demosaic_ctrl_process(VI_PIPE ViPipe)
{
    ...
    ret = isp_algo_demosaic_main((struct demosaic_param_in *)&runtime->demosaic_param_in,
...
static CVI_S32 isp_demosaic_ctrl_postprocess(VI_PIPE ViPipe)
{
    ...
    if (is_postprocess_update == CVI_FALSE) {
        ...
        cfg_0->REG_10.bits.CFA_GSIG_TOL  = cfg_0->REG_10.bits.CFA_RBSIG_TOL =
            runtime->demosaic_attr.FineStr;
        ...
        cfg_1->REG_130.bits.CFA_CMOIRE_PTCLR_X0 =
            runtime->demosaic_demoire_attr.ProtectColorGainIn[0];
        cfg_1->REG_130.bits.CFA_CMOIRE_PTCLR_Y0 =
            runtime->demosaic_demoire_attr.ProtectColorGainOut[0];
        cfg_1->REG_134.bits.CFA_CMOIRE_PTCLR_SLP0 =
            runtime->demosaic_param_out.ProtectColorGainSlope;
        cfg_1->REG_138.bits.CFA_CMOIRE_PTCLR_X1 =
            runtime->demosaic_demoire_attr.ProtectColorGainIn[1];
        cfg_1->REG_138.bits.CFA_CMOIRE_PTCLR_Y1 =
            runtime->demosaic_demoire_attr.ProtectColorGainOut[1];
        cfg_1->REG_13C.bits.CFA_CMOIRE_PROTCLR1_ENABLE =
            cfg_1->REG_13C.bits.CFA_CMOIRE_PROTCLR2_ENABLE =
                cfg_1->REG_13C.bits.CFA_CMOIRE_PROTCLR3_ENABLE =
                    demosaic_demoire_attr->ProtectColorEnable;
        cfg_1->REG_140.bits.CFA_CMOIRE_PROTCLR1 =
            runtime->demosaic_demoire_attr.UserDefineProtectColor1;
        cfg_1->REG_140.bits.CFA_CMOIRE_PROTCLR2 =
            runtime->demosaic_demoire_attr.UserDefineProtectColor2;
        cfg_1->REG_144.bits.CFA_CMOIRE_PROTCLR3 =
            runtime->demosaic_demoire_attr.UserDefineProtectColor3;
        ...
        cfg_1->REG_160.bits.CFA_CMOIRE_LUMAGAIN_ENABLE =
            demosaic_demoire_attr->DetailDetectLumaEnable;
        ...
        cfg_2->REG_A8.bits.CFA_YMOIRE_LUT_SLOPE =
            runtime->demosaic_demoire_attr.DetailSmoothMapSlope;
    }
...
CVI_S32 isp_demosaic_ctrl_get_demosaic_demoire_attr(
    VI_PIPE ViPipe, const ISP_DEMOSAIC_DEMOIRE_ATTR_S **pstDemosaicDemoireAttr)
{
...
CVI_S32 isp_demosaic_ctrl_set_demosaic_demoire_attr(
    VI_PIPE ViPipe, const ISP_DEMOSAIC_DEMOIRE_ATTR_S *pstDemosaicDemoireAttr)
{
    if (pstDemosaicDemoireAttr == CVI_NULL) {
        return CVI_FAILURE;
