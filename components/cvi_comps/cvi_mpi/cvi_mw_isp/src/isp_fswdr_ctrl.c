...
const struct isp_module_ctrl fswdr_mod = {.init    = isp_fswdr_ctrl_init,
...
CVI_S32 isp_fswdr_ctrl_set_run_ctrl_mark(VI_PIPE                                ViPipe,
                                         const struct isp_module_run_ctrl_mark *mark)
{
    CVI_S32                        ret     = CVI_SUCCESS;
    struct isp_fswdr_ctrl_runtime *runtime = _get_fswdr_ctrl_runtime(ViPipe);
...
#undef AUTO
    ...
    runtime->fswdr_param_in.WDRCombineSNRAwareSmoothLevel =
        fswdr_attr->WDRCombineSNRAwareSmoothLevel;
    ...
    runtime->fswdr_param_in.WDRCombineSNRAwareToleranceLevel =
        runtime->fswdr_attr.WDRCombineSNRAwareToleranceLevel;
    ...
    runtime->fswdr_param_in.WDRMotionCombineMinWeight =
        runtime->fswdr_attr.WDRMotionCombineMinWeight;
    runtime->fswdr_param_in.WDRMotionCombineMaxWeight =
        runtime->fswdr_attr.WDRMotionCombineMaxWeight;
...
#ifndef ENABLE_ISP_C906L
    ret = isp_algo_fswdr_main((struct fswdr_param_in *)&runtime->fswdr_param_in,
...
static CVI_S32 isp_fswdr_ctrl_postprocess(VI_PIPE ViPipe)
{
    ...
    if (is_postprocess_update == CVI_FALSE) {
        ...
        cfg_2->FS_MOTION_LUT_SLOPE_0.bits.FS_MOTION_LUT_SLOPE_0 =
            runtime->fswdr_param_out.WDRMtSlope[0];
        cfg_2->FS_MOTION_LUT_SLOPE_0.bits.FS_MOTION_LUT_SLOPE_1 =
            runtime->fswdr_param_out.WDRMtSlope[1];
        cfg_2->FS_MOTION_LUT_SLOPE_1.bits.FS_MOTION_LUT_SLOPE_2 =
            runtime->fswdr_param_out.WDRMtSlope[2];
        ...
        cfg_3->FS_LMAP_DARK_WGT.bits.FS_LMAP_GUIDE_DARK_WGT_L =
            fswdr_attr->DarkToneRefinedMaxWeight;
        cfg_3->FS_LMAP_DARK_WGT.bits.FS_LMAP_GUIDE_DARK_WGT_H =
            fswdr_attr->DarkToneRefinedMinWeight;
        ...
        cfg_3->FS_LMAP_BRIT_WGT.bits.FS_LMAP_GUIDE_BRIT_WGT_L =
            fswdr_attr->BrightToneRefinedMaxWeight;
        cfg_3->FS_LMAP_BRIT_WGT.bits.FS_LMAP_GUIDE_BRIT_WGT_H =
            fswdr_attr->BrightToneRefinedMinWeight;
...
static CVI_S32 isp_fswdr_ctrl_mmap(VI_PIPE ViPipe)
{
    ...
    memblk->vir_addr = (void *)memblk->vir_addr;
