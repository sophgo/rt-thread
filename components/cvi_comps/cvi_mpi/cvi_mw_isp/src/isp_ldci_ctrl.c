...
const struct isp_module_ctrl ldci_mod = {.init    = isp_ldci_ctrl_init,
...
static CVI_S32 isp_ldci_ctrl_preprocess(VI_PIPE ViPipe, ISP_ALGO_RESULT_S *algoResult)
{
    ...
    if (!ldci_attr->Enable || runtime->is_module_bypass) return ret;
...
#define AUTO(_attr, _param, type) \
    runtime->_attr._param = INTERPOLATE_LINEAR(ViPipe, type, _attr->stAuto._param)
        ...
        runtime->ldci_attr.LumaPosWgt.Sigma =
            INTERPOLATE_LINEAR(ViPipe, INTPLT_POST_ISO, au8PosSigma);
        runtime->ldci_attr.LumaPosWgt.Mean =
            INTERPOLATE_LINEAR(ViPipe, INTPLT_POST_ISO, au8PosMean);
...
static CVI_S32 isp_ldci_ctrl_process(VI_PIPE ViPipe)
{
    ...
    ret = isp_algo_ldci_main((struct ldci_param_in *)&runtime->ldci_param_in,
...
static CVI_S32 isp_ldci_ctrl_postprocess(VI_PIPE ViPipe)
{
    ...
    if (is_postprocess_update == CVI_FALSE) {
        ...
        ldci_1_cfg->LDCI_TONE_CURVE_IDX_00.bits.LDCI_TONE_CURVE_IDX_00 =
            pldci_param->au8ToneCurveIdx[0];
        ldci_1_cfg->LDCI_TONE_CURVE_IDX_00.bits.LDCI_TONE_CURVE_IDX_01 =
            pldci_param->au8ToneCurveIdx[1];
        ldci_1_cfg->LDCI_TONE_CURVE_IDX_00.bits.LDCI_TONE_CURVE_IDX_02 =
            pldci_param->au8ToneCurveIdx[2];
        ldci_1_cfg->LDCI_TONE_CURVE_IDX_00.bits.LDCI_TONE_CURVE_IDX_03 =
            pldci_param->au8ToneCurveIdx[3];
        ldci_1_cfg->LDCI_TONE_CURVE_IDX_00.bits.LDCI_TONE_CURVE_IDX_04 =
            pldci_param->au8ToneCurveIdx[4];
        ldci_1_cfg->LDCI_TONE_CURVE_IDX_00.bits.LDCI_TONE_CURVE_IDX_05 =
            pldci_param->au8ToneCurveIdx[5];
        ldci_1_cfg->LDCI_TONE_CURVE_IDX_00.bits.LDCI_TONE_CURVE_IDX_06 =
            pldci_param->au8ToneCurveIdx[6];
        ldci_1_cfg->LDCI_TONE_CURVE_IDX_00.bits.LDCI_TONE_CURVE_IDX_07 =
            pldci_param->au8ToneCurveIdx[7];
        ...
        ldci_2_cfg->LDCI_SUB_INTERP_NORM_LR.bits.LDCI_SUB_INTERP_NORM_LR =
            pldci_coef->u16SubInterpNormLR;
        ldci_2_cfg->LDCI_SUB_INTERP_NORM_LR.bits.LDCI_SUB_INTERP_NORM_UD =
            pldci_coef->u16SubInterpNormUD;
        ...
        ldci_3_cfg->LDCI_SUB_INTERP_NORM_LR1.bits.LDCI_SUB_INTERP_NORM_LR1 =
            pldci_coef->u16SubInterpNormLR1;
        ldci_3_cfg->LDCI_SUB_INTERP_NORM_LR1.bits.LDCI_SUB_INTERP_NORM_UD1 =
            pldci_coef->u16SubInterpNormUD1;
