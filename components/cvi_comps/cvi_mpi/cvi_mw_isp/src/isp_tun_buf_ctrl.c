...
CVI_S32 isp_tun_buf_invalid(VI_PIPE ViPipe)
{
    ...
    MW_COMPAT_InvalidateCache(runtime->post_addr, post_vir[idx],
...
static CVI_S32 isp_tuningBuf_map(VI_PIPE ViPipe)
{
    ...
    fe_vir[idx]   = (void *)runtime->fe_addr;
    be_vir[idx]   = (void *)runtime->be_addr;
    post_vir[idx] = (void *)runtime->post_addr;
