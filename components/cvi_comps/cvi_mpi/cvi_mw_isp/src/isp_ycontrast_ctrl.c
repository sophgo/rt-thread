...
const struct isp_module_ctrl ycontrast_mod = {.init    = isp_ycontrast_ctrl_init,
...
static CVI_S32 isp_ycontrast_ctrl_check_ycontrast_attr_valid(
    const ISP_YCONTRAST_ATTR_S *pstYContrastAttr);
...
static CVI_S32 isp_ycontrast_ctrl_process(VI_PIPE ViPipe)
{
    ...
    ret = isp_algo_ycontrast_main((struct ycontrast_param_in *)&runtime->ycontrast_param_in,
...
//-----------------------------------------------------------------------------
CVI_S32 isp_ycontrast_ctrl_get_ycontrast_attr(VI_PIPE                      ViPipe,
                                              const ISP_YCONTRAST_ATTR_S **pstYContrastAttr)
{
...
CVI_S32 isp_ycontrast_ctrl_set_ycontrast_attr(VI_PIPE                     ViPipe,
                                              const ISP_YCONTRAST_ATTR_S *pstYContrastAttr)
{
    if (pstYContrastAttr == CVI_NULL) {
        return CVI_FAILURE;
