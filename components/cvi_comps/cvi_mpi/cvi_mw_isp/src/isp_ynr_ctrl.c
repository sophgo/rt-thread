...
const struct isp_module_ctrl ynr_mod = {.init    = isp_ynr_ctrl_init,
...
static CVI_S32 isp_ynr_ctrl_check_ynr_filter_attr_valid(
    const ISP_YNR_FILTER_ATTR_S *pstYNRFilterAttr);
static CVI_S32 isp_ynr_ctrl_check_ynr_motion_attr_valid(
...
static CVI_S32 isp_ynr_ctrl_preprocess(VI_PIPE ViPipe, ISP_ALGO_RESULT_S *algoResult)
{
    ...
    if (!ynr_attr->Enable || runtime->is_module_bypass) return ret;
...
#undef AUTO
    ...
    for (CVI_U32 i = 0; i < 9; i++) runtime->ynr_param_in.CCM[i] = ccm_info.CCM[i] / 1024.0;
...
static CVI_S32 isp_ynr_ctrl_process(VI_PIPE ViPipe)
{
    ...
    ret = isp_algo_ynr_main((struct ynr_param_in *)&runtime->ynr_param_in,
...
static CVI_S32 isp_ynr_ctrl_postprocess(VI_PIPE ViPipe)
{
    ...
    if (is_postprocess_update == CVI_FALSE) {
        ...
        cfg_1->NS0_LUMA_TH_00.bits.YNR_NS0_LUMA_TH_00 =
            runtime->ynr_param_out.NoiseCoringBaseLuma[0];
        cfg_1->NS0_LUMA_TH_01.bits.YNR_NS0_LUMA_TH_01 =
            runtime->ynr_param_out.NoiseCoringBaseLuma[1];
        cfg_1->NS0_LUMA_TH_02.bits.YNR_NS0_LUMA_TH_02 =
            runtime->ynr_param_out.NoiseCoringBaseLuma[2];
        cfg_1->NS0_LUMA_TH_03.bits.YNR_NS0_LUMA_TH_03 =
            runtime->ynr_param_out.NoiseCoringBaseLuma[3];
        cfg_1->NS0_LUMA_TH_04.bits.YNR_NS0_LUMA_TH_04 =
            runtime->ynr_param_out.NoiseCoringBaseLuma[4];
        cfg_1->NS0_LUMA_TH_05.bits.YNR_NS0_LUMA_TH_05 =
            runtime->ynr_param_out.NoiseCoringBaseLuma[5];
        ...
        cfg_1->NS0_OFFSET_00.bits.YNR_NS0_OFFSET_00 =
            runtime->ynr_param_out.NoiseCoringBaseOffset[0];
        cfg_1->NS0_OFFSET_01.bits.YNR_NS0_OFFSET_01 =
            runtime->ynr_param_out.NoiseCoringBaseOffset[1];
        cfg_1->NS0_OFFSET_02.bits.YNR_NS0_OFFSET_02 =
            runtime->ynr_param_out.NoiseCoringBaseOffset[2];
        cfg_1->NS0_OFFSET_03.bits.YNR_NS0_OFFSET_03 =
            runtime->ynr_param_out.NoiseCoringBaseOffset[3];
        cfg_1->NS0_OFFSET_04.bits.YNR_NS0_OFFSET_04 =
            runtime->ynr_param_out.NoiseCoringBaseOffset[4];
        cfg_1->NS0_OFFSET_05.bits.YNR_NS0_OFFSET_05 =
            runtime->ynr_param_out.NoiseCoringBaseOffset[5];

        cfg_1->NS1_LUMA_TH_00.bits.YNR_NS1_LUMA_TH_00 =
            runtime->ynr_param_out.NoiseCoringAdvLuma[0];
        cfg_1->NS1_LUMA_TH_01.bits.YNR_NS1_LUMA_TH_01 =
            runtime->ynr_param_out.NoiseCoringAdvLuma[1];
        cfg_1->NS1_LUMA_TH_02.bits.YNR_NS1_LUMA_TH_02 =
            runtime->ynr_param_out.NoiseCoringAdvLuma[2];
        cfg_1->NS1_LUMA_TH_03.bits.YNR_NS1_LUMA_TH_03 =
            runtime->ynr_param_out.NoiseCoringAdvLuma[3];
        cfg_1->NS1_LUMA_TH_04.bits.YNR_NS1_LUMA_TH_04 =
            runtime->ynr_param_out.NoiseCoringAdvLuma[4];
        cfg_1->NS1_LUMA_TH_05.bits.YNR_NS1_LUMA_TH_05 =
            runtime->ynr_param_out.NoiseCoringAdvLuma[5];
        ...
        cfg_1->NS1_OFFSET_00.bits.YNR_NS1_OFFSET_00 =
            runtime->ynr_param_out.NoiseCoringAdvOffset[0];
        cfg_1->NS1_OFFSET_01.bits.YNR_NS1_OFFSET_01 =
            runtime->ynr_param_out.NoiseCoringAdvOffset[1];
        cfg_1->NS1_OFFSET_02.bits.YNR_NS1_OFFSET_02 =
            runtime->ynr_param_out.NoiseCoringAdvOffset[2];
        cfg_1->NS1_OFFSET_03.bits.YNR_NS1_OFFSET_03 =
            runtime->ynr_param_out.NoiseCoringAdvOffset[3];
        cfg_1->NS1_OFFSET_04.bits.YNR_NS1_OFFSET_04 =
            runtime->ynr_param_out.NoiseCoringAdvOffset[4];
        cfg_1->NS1_OFFSET_05.bits.YNR_NS1_OFFSET_05 =
            runtime->ynr_param_out.NoiseCoringAdvOffset[5];
        ...
        cfg_3->WEIGHT_V.bits.YNR_WEIGHT_V       = cfg_3->WEIGHT_H.bits.YNR_WEIGHT_H =
            runtime->ynr_filter_attr.VhDirFiltStr;
        cfg_3->WEIGHT_D45.bits.YNR_WEIGHT_D45 = cfg_3->WEIGHT_D135.bits.YNR_WEIGHT_D135 =
            runtime->ynr_filter_attr.AaDirFiltStr;
        ...
        cfg_4->RES_MOT_LUT_10.bits.YNR_RES_MOT_LUT_10 =
            runtime->ynr_motion_attr.MotionCoringWgt[10];
        cfg_4->RES_MOT_LUT_11.bits.YNR_RES_MOT_LUT_11 =
            runtime->ynr_motion_attr.MotionCoringWgt[11];
        cfg_4->RES_MOT_LUT_12.bits.YNR_RES_MOT_LUT_12 =
            runtime->ynr_motion_attr.MotionCoringWgt[12];
        cfg_4->RES_MOT_LUT_13.bits.YNR_RES_MOT_LUT_13 =
            runtime->ynr_motion_attr.MotionCoringWgt[13];
        cfg_4->RES_MOT_LUT_14.bits.YNR_RES_MOT_LUT_14 =
            runtime->ynr_motion_attr.MotionCoringWgt[14];
        cfg_4->RES_MOT_LUT_15.bits.YNR_RES_MOT_LUT_15 =
            runtime->ynr_motion_attr.MotionCoringWgt[15];
    }
...
CVI_S32 isp_ynr_ctrl_get_ynr_filter_attr(VI_PIPE                       ViPipe,
                                         const ISP_YNR_FILTER_ATTR_S **pstYNRFilterAttr)
{
...
CVI_S32 isp_ynr_ctrl_set_ynr_filter_attr(VI_PIPE                      ViPipe,
                                         const ISP_YNR_FILTER_ATTR_S *pstYNRFilterAttr)
{
    if (pstYNRFilterAttr == CVI_NULL) {
        return CVI_FAILURE;
...
CVI_S32 isp_ynr_ctrl_get_ynr_motion_attr(VI_PIPE                          ViPipe,
                                         const ISP_YNR_MOTION_NR_ATTR_S **pstYNRMotionNRAttr)
{
...
CVI_S32 isp_ynr_ctrl_set_ynr_motion_attr(VI_PIPE                         ViPipe,
                                         const ISP_YNR_MOTION_NR_ATTR_S *pstYNRMotionNRAttr)
{
    if (pstYNRMotionNRAttr == CVI_NULL) {
        return CVI_FAILURE;
