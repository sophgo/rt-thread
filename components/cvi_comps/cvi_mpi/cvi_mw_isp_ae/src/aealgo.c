...
const CVI_S16 Log2x100Tbl[LOG2_TB_SIZE] = {
    0,   0,   100, 158, 200, 232, 258, 281, 300, 317, 332, 346, 358, 370,  381,  391,  400, 409,
    417, 425, 432, 439, 446, 452, 458, 464, 470, 475, 481, 486, 491, 495,  500,  504,  509, 513,
    517, 521, 525, 529, 532, 536, 539, 543, 546, 549, 552, 555, 558, 561,  564,  567,  570, 573,
    575, 578, 581, 583, 586, 588, 591, 593, 595, 598, 600, 602, 604, 607,  609,  611,  613, 615,
    617, 619, 621, 623, 625, 627, 629, 630, 632, 634, 636, 638, 639, 641,  643,  644,  646, 648,
    649, 651, 652, 654, 655, 657, 658, 660, 661, 663, 664, 666, 667, 669,  670,  671,  673, 674,
    675, 677, 678, 679, 681, 682, 683, 685, 686, 687, 688, 689, 691, 692,  693,  694,  695, 697,
    698, 699, 700, 701, 702, 703, 704, 706, 707, 708, 709, 710, 711, 712,  713,  714,  715, 716,
    717, 718, 719, 720, 721, 722, 723, 724, 725, 726, 727, 728, 729, 729,  730,  731,  732, 733,
    734, 735, 736, 737, 738, 738, 739, 740, 741, 742, 743, 743, 744, 745,  746,  747,  748, 748,
    749, 750, 751, 752, 752, 753, 754, 755, 755, 756, 757, 758, 758, 759,  760,  761,  761, 762,
    763, 764, 764, 765, 766, 767, 767, 768, 769, 769, 770, 771, 771, 772,  773,  773,  774, 775,
    775, 776, 777, 777, 778, 779, 779, 780, 781, 781, 782, 783, 783, 784,  785,  785,  786, 786,
    787, 788, 788, 789, 789, 790, 791, 791, 792, 792, 793, 794, 794, 795,  795,  796,  797, 797,
    798, 798, 799, 799, 800, 801, 801, 802, 802, 803, 803, 804, 804, 805,  806,  806,  807, 807,
    808, 808, 809, 809, 810, 810, 811, 811, 812, 812, 813, 813, 814, 814,  815,  815,  816, 816,
    817, 817, 818, 818, 819, 819, 820, 820, 821, 821, 822, 822, 823, 823,  824,  824,  825, 825,
    826, 826, 827, 827, 828, 828, 829, 829, 829, 830, 830, 831, 831, 832,  832,  833,  833, 834,
    834, 834, 835, 835, 836, 836, 837, 837, 838, 838, 838, 839, 839, 840,  840,  841,  841, 841,
    842, 842, 843, 843, 843, 844, 844, 845, 845, 846, 846, 846, 847, 847,  848,  848,  848, 849,
    849, 850, 850, 850, 851, 851, 852, 852, 852, 853, 853, 854, 854, 854,  855,  855,  855, 856,
    856, 857, 857, 857, 858, 858, 858, 859, 859, 860, 860, 860, 861, 861,  861,  862,  862, 863,
    863, 863, 864, 864, 864, 865, 865, 865, 866, 866, 867, 867, 867, 868,  868,  868,  869, 869,
    869, 870, 870, 870, 871, 871, 871, 872, 872, 872, 873, 873, 873, 874,  874,  874,  875, 875,
    875, 876, 876, 876, 877, 877, 877, 878, 878, 878, 879, 879, 879, 880,  880,  880,  881, 881,
    881, 882, 882, 882, 883, 883, 883, 884, 884, 884, 885, 885, 885, 885,  886,  886,  886, 887,
    887, 887, 888, 888, 888, 889, 889, 889, 889, 890, 890, 890, 891, 891,  891,  892,  892, 892,
    892, 893, 893, 893, 894, 894, 894, 895, 895, 895, 895, 896, 896, 896,  897,  897,  897, 897,
    898, 898, 898, 899, 899, 899, 899, 900, 900, 900, 901, 901, 901, 901,  902,  902,  902, 903,
    903, 903, 903, 904, 904, 904, 904, 905, 905, 905, 906, 906, 906, 906,  907,  907,  907, 907,
    908, 908, 908, 908, 909, 909, 909, 910, 910, 910, 910, 911, 911, 911,  911,  912,  912, 912,
    912, 913, 913, 913, 913, 914, 914, 914, 914, 915, 915, 915, 915, 916,  916,  916,  916, 917,
    917, 917, 917, 918, 918, 918, 918, 919, 919, 919, 919, 920, 920, 920,  920,  921,  921, 921,
    921, 922, 922, 922, 922, 923, 923, 923, 923, 924, 924, 924, 924, 925,  925,  925,  925, 926,
    926, 926, 926, 926, 927, 927, 927, 927, 928, 928, 928, 928, 929, 929,  929,  929,  929, 930,
    930, 930, 930, 931, 931, 931, 931, 932, 932, 932, 932, 932, 933, 933,  933,  933,  934, 934,
    934, 934, 934, 935, 935, 935, 935, 936, 936, 936, 936, 936, 937, 937,  937,  937,  938, 938,
    938, 938, 938, 939, 939, 939, 939, 939, 940, 940, 940, 940, 941, 941,  941,  941,  941, 942,
    942, 942, 942, 942, 943, 943, 943, 943, 943, 944, 944, 944, 944, 945,  945,  945,  945, 945,
    946, 946, 946, 946, 946, 947, 947, 947, 947, 947, 948, 948, 948, 948,  948,  949,  949, 949,
    949, 949, 950, 950, 950, 950, 950, 951, 951, 951, 951, 951, 952, 952,  952,  952,  952, 953,
    953, 953, 953, 953, 954, 954, 954, 954, 954, 954, 955, 955, 955, 955,  955,  956,  956, 956,
    956, 956, 957, 957, 957, 957, 957, 958, 958, 958, 958, 958, 958, 959,  959,  959,  959, 959,
    960, 960, 960, 960, 960, 961, 961, 961, 961, 961, 961, 962, 962, 962,  962,  962,  963, 963,
    963, 963, 963, 963, 964, 964, 964, 964, 964, 965, 965, 965, 965, 965,  965,  966,  966, 966,
    966, 966, 967, 967, 967, 967, 967, 967, 968, 968, 968, 968, 968, 968,  969,  969,  969, 969,
    969, 970, 970, 970, 970, 970, 970, 971, 971, 971, 971, 971, 971, 972,  972,  972,  972, 972,
    972, 973, 973, 973, 973, 973, 973, 974, 974, 974, 974, 974, 974, 975,  975,  975,  975, 975,
    975, 976, 976, 976, 976, 976, 976, 977, 977, 977, 977, 977, 977, 978,  978,  978,  978, 978,
    978, 979, 979, 979, 979, 979, 979, 980, 980, 980, 980, 980, 980, 981,  981,  981,  981, 981,
    981, 982, 982, 982, 982, 982, 982, 982, 983, 983, 983, 983, 983, 983,  984,  984,  984, 984,
    984, 984, 985, 985, 985, 985, 985, 985, 985, 986, 986, 986, 986, 986,  986,  987,  987, 987,
    987, 987, 987, 987, 988, 988, 988, 988, 988, 988, 989, 989, 989, 989,  989,  989,  989, 990,
    990, 990, 990, 990, 990, 991, 991, 991, 991, 991, 991, 991, 992, 992,  992,  992,  992, 992,
    992, 993, 993, 993, 993, 993, 993, 994, 994, 994, 994, 994, 994, 994,  995,  995,  995, 995,
    995, 995, 995, 996, 996, 996, 996, 996, 996, 996, 997, 997, 997, 997,  997,  997,  997, 998,
    998, 998, 998, 998, 998, 998, 999, 999, 999, 999, 999, 999, 999, 1000, 1000, 1000,
};
...
char *AE_GetTimestampStr(void)
{
    ...
    snprintf(str, sizeof(str), "%02d:%02d:%02d.%03d ", tm->tm_hour, tm->tm_min, tm->tm_sec,
...
void AE_SetFastBootExposure(VI_PIPE ViPipe, CVI_U32 expLine, CVI_U32 again, CVI_U32 dgain,
                            CVI_U32 ispdgain)
{
...
void AE_GetFastBootExposure(VI_PIPE ViPipe, CVI_U32 expLine, CVI_U32 again, CVI_U32 dgain,
                            CVI_U32 ispdgain)
{
    CVI_U8 sID = AE_ViPipe2sID(ViPipe);
...
void AE_GetFastBootExposureEntry(CVI_U8 sID, CVI_S16 *tvEntry, CVI_S16 *svEntry)
{
    ...
    AAA_LIMIT(stAeFastBootExposure[sID].u32ExpLine, AeInfo[sID].u32ExpLineMin,
              AeInfo[sID].u32ExpLineMax);
    AAA_LIMIT(stAeFastBootExposure[sID].stGain.u32AGain, AeInfo[sID].u32AGainMin,
              AeInfo[sID].u32AGainMax);
    AAA_LIMIT(stAeFastBootExposure[sID].stGain.u32DGain, AeInfo[sID].u32DGainMin,
              AeInfo[sID].u32DGainMax);
    AAA_LIMIT(stAeFastBootExposure[sID].stGain.u32ISPDGain, AeInfo[sID].u32ISPDGainMin,
...
{
    CVI_U16 RValue[AE_MAX_WDR_FRAME_NUM], GValue[AE_MAX_WDR_FRAME_NUM],
        BValue[AE_MAX_WDR_FRAME_NUM];
    ...
    CVI_U16 tmpMaxLuma[AE_MAX_WDR_FRAME_NUM]                  = {0},
            tmpMinLuma[AE_MAX_WDR_FRAME_NUM]                  = {0xffff, 0xffff};
        ...
        for (column = 0; column < AeInfo[sID].u8GridHNum; column++) {
            ...
            for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
                ...
                GValue[i] = (AeInfo[sID].pu16AeStatistics[i][row][column][1] +
                             AeInfo[sID].pu16AeStatistics[i][row][column][2]) /
                            2;
                BValue[i] = AeInfo[sID].pu16AeStatistics[i][row][column][0];

                if (RValue[i] > AE_MAX_LUMA) RValue[i] = AE_MAX_LUMA;

                if (GValue[i] > AE_MAX_LUMA) GValue[i] = AE_MAX_LUMA;

                if (BValue[i] > AE_MAX_LUMA) BValue[i] = AE_MAX_LUMA;
                ...
                if (gridWeightRatio >= HIGH_LIGHT_ZONE_WEIGHT_RATIO_THR) {
                    if (gridMaxLuma[i] > highLightBufLumaThr) highLightBufCnt[i][GRID_BASE]++;

                    if (gridMaxLuma[i] > highLightLumaThr) highLightCnt[i][GRID_BASE]++;

                    if (gridMaxLuma[i] < lowLightBufLumaThr) lowLightBufCnt[i][GRID_BASE]++;

                    if (gridMaxLuma[i] < lowLightLumaThr) lowLightCnt[i][GRID_BASE]++;
                }
            }
            ...
            if (AeInfo[sID].bWDRMode) {
                ...
                if (pstAeExposureAttrInfo[sID]->enMeterMode == AE_METER_HIGHLIGHT_PRIORITY) {
                    ...
                    if (gridMaxLuma[AE_LE] > wdrLEHighBinThr) gridHighBinCnt[AE_LE]++;
    ...
    for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
        ...
        AeInfo[sID].u16ROILuma[i] = (roiGridCnt[i]) ? roiGridLumaSum[i] / roiGridCnt[i] : 0xffff;
        ...
        AeInfo[sID].u16HighRatio[i][HISTOGRAM_BASE] =
            highLightCnt[i][HISTOGRAM_BASE] * 1000 / hisSum[i];
        AeInfo[sID].u16HighBufRatio[i][HISTOGRAM_BASE] =
            highLightBufCnt[i][HISTOGRAM_BASE] * 1000 / hisSum[i];
        AeInfo[sID].u16LowRatio[i][HISTOGRAM_BASE] =
            lowLightCnt[i][HISTOGRAM_BASE] * 1000 / hisSum[i];
        AeInfo[sID].u16LowBufRatio[i][HISTOGRAM_BASE] =
            lowLightBufCnt[i][HISTOGRAM_BASE] * 1000 / hisSum[i];
    }
}
...
void AE_CalculateWindowBvStep(CVI_U8 sID)
{
    ...
    for (row = 0; row < AeInfo[sID].u8GridVNum; row++) {
        for (column = 0; column < AeInfo[sID].u8GridHNum; column++) {
            ...
            if (tmpBVLuma < AE_METER_MIN_LUMA) tmpBVLuma = AE_METER_MIN_LUMA;
            if (tmpBVLuma > highLightThr) {
                highLightCnt++;
            }
            if (tmpBVLuma <= highLightThr || highLightCnt >= wdrHighBinThrCntThr) {
                tmpBVStep =
    ...
    tmpBVStep =
        (Log2x100Tbl[tmpLuma] - Log2x100Tbl[AeInfo[sID].u16AdjustTargetLuma[AE_LE]]) * ENTRY_PER_BV;
    tmpBVStep = (tmpBVStep > 0) ? ((tmpBVStep + 50) / 100) : ((tmpBVStep - 50) / 100);
...
void AE_GetWDRFrameAvgBvStep(CVI_U8 sID)
{
    ...
    tmpBVStep = (Log2x100Tbl[AeInfo[sID].u16LvFrameLuma[AE_LE]] - Log2x100Tbl[LeFrameMaxLuma]) *
                ENTRY_PER_BV;
    tmpBVStep = (tmpBVStep > 0) ? ((tmpBVStep + 50) / 100) : ((tmpBVStep - 50) / 100);
...
void AE_CalculateBvStep(CVI_U8 sID)
{
    ...
    for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
        ...
        tmpBVStep = (Log2x100Tbl[tmpFrameLuma] - Log2x100Tbl[AeInfo[sID].u16AdjustTargetLuma[i]]) *
                    ENTRY_PER_BV;
        tmpBVStep = (tmpBVStep > 0) ? ((tmpBVStep + 50) / 100) : ((tmpBVStep - 50) / 100);
        ...
        if (i == AE_LE && pstAeExposureAttrInfo[sID]->enMeterMode != AE_METER_HIGHLIGHT_PRIORITY) {
            ...
            bvStepDiff =
                ((AeInfo[sID].s16WindowBvStepEntry - AeInfo[sID].s16lumaBvStepEntry[AE_LE]) *
                 AeInfo[sID].u8BvStepWeight[i]) /
                100;
            ...
            if (pstAeExposureAttrInfo[sID]->bHistStatAdjust) {
                ...
                bvStepDiff += ((AeInfo[sID].s16LumaReduceBvStepEntry -
                               ...
                               AeInfo[sID].u8LumaReduceWeight[i]) /
                              100;
            }
...
void AE_CalculateSmoothBvStep(CVI_U8 sID)
{
    ...
    if (AeInfo[sID].u8ConvergeMode[AE_LE] == CONVERGE_FAST) return;
    ...
    for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
        ...
        if (AeInfo[sID].bMeterEveryFrame) {
            ...
            if (AeInfo[sID].u32frmCnt <=
                AeInfo[sID].u8BootWaitFrameNum + AeInfo[sID].u8MeterFramePeriod) {
                // for max 1/4 step
            ...
            if (upStatus[i] == 1 && AeInfo[sID].u8MeterFramePeriod > 1) {
                ...
                // for max 1/4 step
                bsDiff =
                    bsDiff * (AeInfo[sID].u8MeterFramePeriod - 1) / AeInfo[sID].u8MeterFramePeriod;
            }
            ...
            if (AeInfo[sID].stSmoothApex[i][0].s16BVEntry != BV_AUTO_ENTRY &&
                ...
                bsDiff =
                    (AeInfo[sID].stSmoothApex[i][AeInfo[sID].u8MeterFramePeriod - 1].s16BVEntry -
...
void AE_GetTVEntryLimit(CVI_U8 sID, CVI_S16 *MinEntry, CVI_S16 *MaxEntry)
{
    ...
    minRouteTvEntry = (pstAeExposureAttrInfo[sID]->bAERouteExValid)
                          ? AeInfo[sID].s16MinRouteExTVEntry
                          : AeInfo[sID].s16MinRouteTVEntry;
    maxRouteTvEntry = (pstAeExposureAttrInfo[sID]->bAERouteExValid)
                          ? AeInfo[sID].s16MaxRouteExTVEntry
                          : AeInfo[sID].s16MaxRouteTVEntry;

    if (AeInfo[sID].enSlowShutterStatus == AE_ENTER_SLOW_SHUTTER) {
        AeInfo[sID].s16MinTVEntry =
            AAA_MAX(AeInfo[sID].s16MinRangeTVEntry, AeInfo[sID].s16MinFpsSensorTVEntry);
    } else {
...
void AE_GetISOEntryLimit(CVI_U8 sID, CVI_S16 *MinEntry, CVI_S16 *MaxEntry)
{
    ...
    sID              = AE_CheckSensorID(sID);
    minRouteISOEntry = (pstAeExposureAttrInfo[sID]->bAERouteExValid)
                           ? AeInfo[sID].s16MinRouteExISOEntry
                           : AeInfo[sID].s16MinRouteISOEntry;
    maxRouteISOEntry = (pstAeExposureAttrInfo[sID]->bAERouteExValid)
...
void AE_GetTargetRange(CVI_U8 sID, CVI_S16 LvX100, CVI_S32 *ptargetMin, CVI_S32 *ptargetMax)
{
    ...
    if (AeInfo[sID].bWDRMode) {
        leTargetLumaOffset =
            pstAeExposureAttrInfo[sID]->stAuto.u8Compensation - AE_DEFAULT_TARGET_LUMA;
        seTargetLumaOffset =
            pstAeWDRExposureAttrInfo[sID]->u8SECompensation - AE_DEFAULT_TARGET_LUMA;
        if (LvX100 <= minLVx100 || LvX100 >= maxLVx100) {
            ...
            if (LvX100 < 0) {
                ptargetMin[AE_LE] =
                    AE_Interpolation(targetMinSeg[AE_LE], targetMinSeg[AE_LE][1] - AAA_ABS(LvX100) +
                                                              targetMinSeg[AE_LE][0]);
                ptargetMax[AE_LE] =
                    AE_Interpolation(targetMaxSeg[AE_LE], targetMaxSeg[AE_LE][1] - AAA_ABS(LvX100) +
                                                              targetMaxSeg[AE_LE][0]);
            } else {
            ...
            if (LvX100 < 0) {
                ptargetMin[AE_SE] =
                    AE_Interpolation(targetMinSeg[AE_SE], targetMinSeg[AE_SE][1] - AAA_ABS(LvX100) +
                                                              targetMinSeg[AE_SE][0]);
                ptargetMax[AE_SE] =
                    AE_Interpolation(targetMaxSeg[AE_SE], targetMaxSeg[AE_SE][1] - AAA_ABS(LvX100) +
                                                              targetMaxSeg[AE_SE][0]);
            } else {
...
CVI_S16 AE_CalculateROITargetOffset(CVI_U8 sID, CVI_U8 wdrIdx, CVI_S16 *offset, CVI_S16 downLimit,
                                    CVI_S16 upLimit, CVI_S32 targetMin, CVI_S32 targetMax)
{
    ...
    if (downLimit == upLimit || AeInfo[sID].u16ROIWeightThr == 0xffff || AeFaceDetect[sID].bMode)
        return 0;
    ...
    if (AeInfo[sID].u16ROILuma[wdrIdx] > roiHighLumaThr) {
        tmpOffset =
            (tmpOffset - roiTargetStep <= downLimit) ? downLimit : tmpOffset - roiTargetStep;
        AeInfo[sID].u8AdjustTargetStatus[wdrIdx] = AE_ADJUST_TO_MIN;
    } else if (AeInfo[sID].u16ROILuma[wdrIdx] < roiLowLumaThr) {
        tmpOffset = (tmpOffset + roiTargetStep >= upLimit) ? upLimit : tmpOffset + roiTargetStep;
        AeInfo[sID].u8AdjustTargetStatus[wdrIdx] = AE_ADJUST_TO_MAX;
    } else {
        if (AeInfo[sID].u16ROILuma[wdrIdx] < roiHighLumaThr / 2 && tmpOffset <= center) {
            roiTargetStep = roiTargetStep / 2;
            tmpOffset = (tmpOffset + roiTargetStep >= center) ? center : tmpOffset + roiTargetStep;
            AeInfo[sID].u8AdjustTargetStatus[wdrIdx] = AE_ADJUST_MIN_TO_MED;
        } else if (AeInfo[sID].u16ROILuma[wdrIdx] > roiLowLumaThr && tmpOffset >= center) {
            roiTargetStep = roiTargetStep / 2;
            tmpOffset = (tmpOffset - roiTargetStep <= center) ? center : tmpOffset - roiTargetStep;
...
#define MIN_STEP  2
    ...
    if (AeInfo[sID].u8ConvergeMode[AE_LE] == CONVERGE_FAST) {
        ...
        bvStep[AE_LE] =
            (bvStep[AE_LE] > 0) ? ((bvStep[AE_LE] + 50) / 100) : ((bvStep[AE_LE] - 50) / 100);
    ...
    newAeTargetY[AE_LE] = pstAeExposureAttrInfo[sID]->stAuto.u8Compensation
                          << 2;  // 8 bits shift to 10 bits
    ...
    for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
        ...
        if (targetMax[i] < targetMin[i]) targetMax[i] = targetMin[i];
        ...
        highBufRatio[i] =
            (highBufRatio[i] > highBufRatioThr) ? highBufRatio[i] - highBufRatioThr : 0;
        ...
        if (AeInfo[sID].bWDRMode) {
            if (i == AE_LE) {
                upLimit[i] = (targetMax[i] - pstAeExposureAttrInfo[sID]->stAuto.u8Compensation)
                             << 2;
                downLimit[i] = (targetMin[i] - pstAeExposureAttrInfo[sID]->stAuto.u8Compensation)
                               << 2;
                ...
                upLimit[i] = (targetMax[i] - pstAeWDRExposureAttrInfo[sID]->u8SECompensation) << 2;
                downLimit[i] = (targetMin[i] - pstAeWDRExposureAttrInfo[sID]->u8SECompensation)
                               << 2;
            }

            if (upLimit[i] < downLimit[i]) upLimit[i] = downLimit[i];

            AAA_LIMIT(lumaOffset[sID][i], downLimit[i], upLimit[i]);
        } else {
            upLimit[i]   = (targetMax[i] - pstAeExposureAttrInfo[sID]->stAuto.u8Compensation) << 2;
            downLimit[i] = (targetMin[i] - pstAeExposureAttrInfo[sID]->stAuto.u8Compensation) << 2;
            targetStep   = AAA_MAX(MIN_STEP, targetStep);
        ...
        newAeTargetY[i] = (newAeTargetY[i] + lumaOffset[sID][i] < MIN_AE_TARGET)
                              ? MIN_AE_TARGET
                              : newAeTargetY[i] + lumaOffset[sID][i];
        ...
        if (curAeTargetY[sID][i] && !paramUpdate) {
            if (newAeTargetY[i] > curAeTargetY[sID][i])
                newAeTargetY[i] =
                    curAeTargetY[sID][i] + (newAeTargetY[i] - curAeTargetY[sID][i]) / 2;
            else if (newAeTargetY[i] < curAeTargetY[sID][i])
                newAeTargetY[i] =
                    curAeTargetY[sID][i] - (curAeTargetY[sID][i] - newAeTargetY[i]) / 2;
        }
    ...
    AeInfo[sID].u16AdjustTargetLuma[AE_LE] =
        AeInfo[sID].u16AdjustTargetLuma[AE_LE] * evBias / AE_GAIN_BASE;

    if (AeInfo[sID].u16AdjustTargetLuma[AE_LE] > AE_MAX_LUMA)
        AeInfo[sID].u16AdjustTargetLuma[AE_LE] = AE_MAX_LUMA;

    if (AeInfo[sID].bWDRMode) {
        AeInfo[sID].u16AdjustTargetLuma[AE_SE] =
            AeInfo[sID].u16AdjustTargetLuma[AE_SE] * AE_GAIN_BASE /
    ...
    if (AE_GetDebugMode(sID) == 25) {
        for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
            printf("(%d)TL:%u cTL:%u EvBias:%d\n", i, newAeTargetY[i], curAeTargetY[sID][i],
                   pstAeExposureAttrInfo[sID]->stAuto.u16EVBias);
            ...
            printf("L(%u):%u bv:%d bs:%d WDR_R:%u\n", sID, AeInfo[sID].u16FrameLuma[i],
                   AeInfo[sID].stApex[i].s16BVEntry, bvStep[i], AeInfo[sID].u32WDRExpRatio);
...
void AE_GetBvStepRangeByTolerance(CVI_U8 target, CVI_U16 tolerance, CVI_S16 *minBvStep,
                                  CVI_S16 *maxBvStep)
{
                                ...
                                CVI_S16 tmpBvEntry, CVI_S16 tmpBvStep)
{
    ...
    if (mode == 0) {
        ...
        if (AAA_ABS(diffEntry) <= ENTRY_PER_EV / 10) {
            ...
            *tmpConvBvEntry = (tmpBvStep > 0) ? tmpBvEntry + step * 2 : tmpBvEntry - step * 2;
...
void AE_CalculateConverge(CVI_U8 sID)
{
    ...
    if (AeInfo[sID].bWDRMode) {
        AE_GetBvStepRangeByTolerance(AeInfo[sID].u16AdjustTargetLuma[AE_LE] >> 2,
                                     pstAeExposureAttrInfo[sID]->stAuto.u8Tolerance,
                                     &toleranceMinBvStep[AE_LE], &toleranceMaxBvStep[AE_LE]);
        AE_GetBvStepRangeByTolerance(AeInfo[sID].u16AdjustTargetLuma[AE_SE] >> 2,
                                     pstAeWDRExposureAttrInfo[sID]->u16Tolerance,
                                     &toleranceMinBvStep[AE_SE], &toleranceMaxBvStep[AE_SE]);
    } else {
        AE_GetBvStepRangeByTolerance(AeInfo[sID].u16AdjustTargetLuma[AE_LE] >> 2,
                                     pstAeExposureAttrInfo[sID]->stAuto.u8Tolerance,
                                     &toleranceMinBvStep[AE_LE], &toleranceMaxBvStep[AE_LE]);
    ...
    if (AeInfo[sID].u8ConvergeMode[AE_LE] == CONVERGE_FAST) {
        ...
        if (AeInfo[sID].u8FastConvergeFrmCnt % meterPeriod == 0 ||
            ...
            for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
                if (AeInfo[sID].u32frmCnt < (meterPeriod + 2) &&
                    stAeBootFastConverge[sID].bEnable) {
        ...
        for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
            ...
            bvEntry[i]                   = convergeBvEntry[i] =
                AE_LimitBVEntry(sID, AeInfo[sID].stApex[i].s16BVEntry);
            ...
            if (i == AE_LE) {
                if (absBvStep[i] > ENTRY_PER_EV / 10) {
                    if (bvStep[i] > 0) {
                        ...
                        convergeSpeed[i] =
                            (delayFrmCnt[sID][WHITE_DELAY] <= whiteDelay) ? 0 : convergeSpeed[i];
                    } else {
                        delayFrmCnt[sID][BLACK_DELAY]++;
                        delayFrmCnt[sID][WHITE_DELAY] = 0;
                        convergeSpeed[i] =
                            (delayFrmCnt[sID][BLACK_DELAY] <= blackDelay) ? 0 : convergeSpeed[i];
                    }
                } else {
                    AeInfo[sID].u8ConvergeMode[i] = CONVERGE_NORMAL;

                    tmpHistError =
                        (AeInfo[sID].u16AdjustTargetLuma[i] * AE_CalculatePow2(absBvStep[i])) -
                        AeInfo[sID].u16AdjustTargetLuma[i];
            ...
            isOverRange[i] = ((bvEntry[i] >= maxBvEntry && bvStep[i] >= 0) ||
            ...
            if (isOverRange[i]) {
                ...
                if (bvStep[i] < toleranceMinBvStep[i] || bvStep[i] > toleranceMaxBvStep[i]) {
                    ...
                    if (absBvStep[i] <= ENTRY_PER_EV / 5) {
                        ...
                        convergeBvEntry[i] = (bvStep[i] > 0)
                                                 ? ((bvEntry[i] * (64 - convergeSpeed[i]) +
                                                     (bvEntry[i] + bvStep[i]) * convergeSpeed[i]) +
                                                    32) >>
                                                       6
                                                 : ((bvEntry[i] * (64 - convergeSpeed[i]) +
                                                     (bvEntry[i] + bvStep[i]) * convergeSpeed[i]) -
                    ...
                    finetuneFrmCnt[sID][i] = (finetuneFrmCnt[sID][i] > 10 * meterPeriod)
                                                 ? 10 * meterPeriod
                                                 : finetuneFrmCnt[sID][i] + 1;
                    if (finetuneFrmCnt[sID][i] > 5 * meterPeriod && absBvStep[i] > 1) {
                        convergeBvEntry[i] =
                            (bvStep[i] > 0) ? convergeBvEntry[i] + 1 : convergeBvEntry[i] - 1;
                        finetuneFrmCnt[sID][i] = 0;
                    }
                }
            }
            ...
            isOverRange[i] = ((convergeBvEntry[i] >= maxBvEntry && bvStep[i] >= 0) ||
                              (convergeBvEntry[i] <= minBvEntry && bvStep[i] <= 0))
                                 ? 1
                                 : 0;
            ...
            if (isOverRange[i] ||
                (absCurBvStep[i] <= stableBvStep && preAbsBvStep[sID][i] <= stableBvStep)) {
            ...
            if (stableFrmCnt[sID][i] > 2 * meterPeriod) AeInfo[sID].u16ConvergeFrameCnt[i] = 0;
...
void AE_SetManualExposure(CVI_U8 sID)
{
    ...
    pstAeExposureAttrInfo[sID]->stAuto.stExpTimeRange =
        pstAeMpiExposureAttr[sID]->stAuto.stExpTimeRange;
    pstAeExposureAttrInfo[sID]->stAuto.stAGainRange =
        pstAeMpiExposureAttr[sID]->stAuto.stAGainRange;
    pstAeExposureAttrInfo[sID]->stAuto.stDGainRange =
        pstAeMpiExposureAttr[sID]->stAuto.stDGainRange;
    pstAeExposureAttrInfo[sID]->stAuto.stISPDGainRange =
        pstAeMpiExposureAttr[sID]->stAuto.stISPDGainRange;
    pstAeExposureAttrInfo[sID]->stAuto.stISONumRange =
        pstAeMpiExposureAttr[sID]->stAuto.stISONumRange;
...
void AE_ConfigDBTypeDgain(CVI_U8 sID, AE_GAIN *pstGain)
{
    ...
    if (AeInfo[sID].u8DGainAccuType == AE_ACCURACY_DB) {
        ...
        if (AeInfo[sID].bDGainSwitchToAGain) {  // sensor dgain -> sensor again
            ...
            if (aeGain.u32DGain != dGain) {
                aeGain.u32ISPDGain =
                    (CVI_U64)aeGain.u32ISPDGain * aeGain.u32DGain / AAA_DIV_0_TO_1(dGain);
...
void AE_GetLimitExposure(CVI_U8 sID, AE_EXPOSURE *exp, CVI_U8 *path)
{
    ...
    *path     = 0;
    finalExp  = *exp;
    totalGain = AE_CalTotalGain(exp->stExpGain.u32AGain, exp->stExpGain.u32DGain,
                                exp->stExpGain.u32ISPDGain);
    ...
    if (AE_GetDebugMode(sID) == 42) {
        printf("Tv:%d Sv:%d Time:%u AG:%u DG:%u IG:%u\n", AeInfo[sID].stApex[AE_LE].s16TVEntry,
               AeInfo[sID].stApex[AE_LE].s16SVEntry, AeInfo[sID].stExp[AE_LE].u32ExpTime,
    ...
    if (pstAeExposureAttrInfo[sID]->stAuto.enGainType == AE_TYPE_ISO) {
        ...
        if (finalExp.u32ExpTime == exp->u32ExpTime && finalISO == curISO) return;
    ...
    curExposure = (CVI_U64)exp->u32ExpTime * exp->stExpGain.u32AGain * exp->stExpGain.u32DGain *
                  exp->stExpGain.u32ISPDGain;
        ...
        if (pstAeExposureAttrInfo[sID]->stAuto.enGainType == AE_TYPE_ISO) {
            ...
            *path = 3;
            ...
            if (finalExp.stExpGain.u32AGain != tmpAGain) {
                tmpDGain =
                    curExposure / ((CVI_U64)finalExp.u32ExpTime * finalExp.stExpGain.u32AGain *
                                   finalExp.stExpGain.u32ISPDGain);
                ...
                if (finalExp.stExpGain.u32DGain != tmpDGain) {
                    finalExp.stExpGain.u32ISPDGain =
                        curExposure / ((CVI_U64)finalExp.u32ExpTime * finalExp.stExpGain.u32AGain *
                                       finalExp.stExpGain.u32DGain);
                    AAA_LIMIT(finalExp.stExpGain.u32ISPDGain, minISPDGain, maxISPDGain);
                }
            }
            finalExp.u32ExpTime =
                curExposure / ((CVI_U64)finalExp.stExpGain.u32AGain * finalExp.stExpGain.u32DGain *
                               finalExp.stExpGain.u32ISPDGain);
            *path = 4;
        }
    }
    ...
    if (AE_GetDebugMode(sID) == 42) {
        ...
        printf("T:%u-%u ISO:%u-%u AG:%u-%u DG:%u-%u IG:%u-%u P:%d\n", minTime, maxTime, minISO,
               maxISO, minAGain, maxAGain, minDGain, maxDGain, minISPDGain, maxISPDGain, *path);
...
void AE_ConfigExposure(CVI_U8 sID)
{
    ...
    for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
        AE_GetIdealExpTimeByEntry(sID, AeInfo[sID].stApex[i].s16TVEntry,
                                  &AeInfo[sID].stExp[i].fIdealExpTime);
        ...
        if (pstAeExposureAttrInfo[sID]->bAERouteExValid)
            ...
            AE_GetExpGainByEntry(sID, AeInfo[sID].stApex[i].s16SVEntry,
                                 &AeInfo[sID].stExp[i].stExpGain);
...
void AE_ConfigManualExposure(CVI_U8 sID)
{
    ...
    if (pstAeExposureAttrInfo[sID]->bByPass) return;
    ...
    maxAGain =
        AAA_MIN(pstAeExposureAttrInfo[sID]->stAuto.stAGainRange.u32Max, AeInfo[sID].u32AGainMax);

    autoTotalGain = (CVI_U64)autoGain.u32AGain * autoGain.u32DGain * autoGain.u32ISPDGain;
    ...
    if (pstAeExposureAttrInfo[sID]->stManual.enGainType == AE_TYPE_GAIN) {
        if (pstAeExposureAttrInfo[sID]->stManual.enAGainOpType == OP_TYPE_MANUAL) aGainFix = 1;
        if (pstAeExposureAttrInfo[sID]->stManual.enDGainOpType == OP_TYPE_MANUAL) dGainFix = 1;
    ...
    finalTotalGain = (CVI_U64)finalGain.u32AGain * finalGain.u32DGain * finalGain.u32ISPDGain;
    ...
    if (AE_GetDebugMode(sID) == 96) {
        ...
        printf("TF:%d ISOF:%d UISO:%d AF:%d DF:%d IDF:%d\n",
               ...
               pstAeExposureAttrInfo[sID]->stManual.enISONumOpType, aGainFix, dGainFix,
               ispDGainFix);
        printf("Auto T:%u ISO:%d AG:%u DG:%u IG:%u\n", autoTime, autoISONum, autoGain.u32AGain,
               autoGain.u32DGain, autoGain.u32ISPDGain);
        printf("Manu T:%u ISO:%d AG:%u DG:%u IG:%u\n", finalTime, finalISONum, aGain, dGain,
               ispDGain);
    }
}

void AE_GetTVSVExposureRoute(CVI_U8 sID, AE_WDR_FRAME wdrFrm,
                             PSEXPOSURE_TV_SV_CURVE *pPreviewTVSVExposureCurve, CVI_U8 *curveSize)
{
    ...
    if (AeInfo[sID].bPubFpsChange) {
        routeSize = (pstAeExposureAttrInfo[sID]->bAERouteExValid)
                        ? pstAeRouteExInfo[sID][wdrFrm]->u32TotalNum
                        : pstAeRouteInfo[sID][wdrFrm]->u32TotalNum;
...
void AE_GetAntiFlickerTVSVEntry(CVI_U8 sID, CVI_S16 *pTvEntry, CVI_S16 *pSvEntry)
{
    ...
    if (pstAeExposureAttrInfo[sID]->stAuto.stAntiflicker.enMode == ISP_ANTIFLICKER_NORMAL_MODE) {
        ...
        if (routeChange) tmpSvEntry = AE_LimitISOEntry(sID, tmpSvEntry);
    }
...
void AE_GetRouteTVSVEntry(CVI_U8 sID, AE_WDR_FRAME wdrFrm, CVI_S16 BvEntry, CVI_S16 *pTvEntry,
                          CVI_S16 *pSvEntry)
{
    CVI_U8                 i = 0;
    ...
    sID = AE_CheckSensorID(sID);
    if (!AeInfo[sID].bWDRUseSameGain && wdrFrm == AE_SE) {
        tmpWdrFrm = AE_SE;
    } else {
        tmpWdrFrm = AE_LE;
    }
    ...
    minBvEntry =
        psTVSVCurve[curveRouteNum - 1].NodeTvEntry - psTVSVCurve[curveRouteNum - 1].NodeSvEntry;
    ...
    *pSvEntry = rangeSvEntry;
    ...
    if (AE_GetDebugMode(sID) == 47) {
        ...
        printf("Min Bv:%d Tv:%d Sv:%d\n", AeInfo[sID].s16MinTVEntry - AeInfo[sID].s16MaxISOEntry,
               AeInfo[sID].s16MinTVEntry, AeInfo[sID].s16MaxISOEntry);
        printf("Bv:%d rTv:%d rSv:%d Tv:%d Sv:%d\n", BvEntry, rangeTvEntry, rangeSvEntry, *pTvEntry,
               *pSvEntry);
...
void AE_GetWDRLESEEntry(CVI_U8 sID, AE_APEX *LE, AE_APEX *SE)
{
    ...
    if (!AeInfo[sID].bWDRUseSameGain) return;
    ...
    if (AE_GetDebugMode(sID) == 44) {
        printf("GM:%d lBv:%d Tv:%d->%d Sv:%d->%d sBv:%d Tv:%d->%d Sv:%d->%d\n",
               AeInfo[sID].enWDRGainMode, LE->s16BVEntry, LE->s16TVEntry, leExp.s16TVEntry,
               LE->s16SVEntry, leExp.s16SVEntry, SE->s16BVEntry, SE->s16TVEntry, seExp.s16TVEntry,
               SE->s16SVEntry, seExp.s16SVEntry);
    }
...
void AE_ConfigExposureRoute(CVI_U8 sID)
{
    ...
    if (AeInfo[sID].bWDRMode) {
        AE_GetRouteTVAVSVEntry(sID, AE_LE, AeInfo[sID].stApex[AE_LE].s16BVEntry, &tmpTvEntry,
                               &tmpAvEntry, &tmpSvEntry);
        ...
        sensorMaxBvEntry =
            AeInfo[sID].s16MaxSensorTVEntry - AeInfo[sID].s16MinSensorISOEntry - WDRRatioEntry;
        ...
        WDRRatioMaxEntry =
            AeInfo[sID].stApex[AE_LE].s16BVEntry + ENTRY_PER_EV * (log(WDRMaxRatio) / log(2));
        AAA_LIMIT(AeInfo[sID].stApex[AE_SE].s16BVEntry, WDRRatioMinEntry, WDRRatioMaxEntry);
    }

    for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i)
        AE_GetRouteTVAVSVEntry(sID, i, AeInfo[sID].stApex[i].s16BVEntry,
                               &AeInfo[sID].stApex[i].s16TVEntry, &AeInfo[sID].stApex[i].s16AVEntry,
...
void AE_ConfigSmoothExposure(CVI_U8 sID)
{
    ...
    for (k = 0; k < AeInfo[sID].u8AeMaxFrameNum; ++k) {
        ...
        for (i = 0; i < AeInfo[sID].u8MeterFramePeriod; ++i) {
            ...
            for (j = 0; j <= i; ++j) tmpBv[k] += bvStep[k][j];

            AeInfo[sID].stSmoothApex[k][i].s16BVEntry =
                (AeInfo[sID].u8ConvergeMode[k] == CONVERGE_FAST) ? AeInfo[sID].stApex[k].s16BVEntry
                                                                 : tmpBv[k];
...
void AE_GetSmoothTvAvSvEntry(CVI_U8 sID, CVI_U32 frmNo)
{
    ...
    for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
        if (AeInfo[sID].stSmoothApex[i][0].s16BVEntry != BV_AUTO_ENTRY) {
            AeInfo[sID].stApex[i].s16TVEntry = AeInfo[sID].stSmoothApex[i][index].s16TVEntry;
            AeInfo[sID].stApex[i].s16AVEntry = AeInfo[sID].stSmoothApex[i][index].s16AVEntry;
            AeInfo[sID].stApex[i].s16SVEntry = AeInfo[sID].stSmoothApex[i][index].s16SVEntry;
        }
    }
}
...
void AE_GetExpTimeByEntry(CVI_U8 sID, CVI_S16 tvEntry, CVI_U32 *ptime)
{
    ...
    if (tvEntry == AeInfo[sID].s16MinSensorTVEntry) time = AeInfo[sID].u32ExpTimeMax;
...
void AE_GetExposureTimeIdealLine(CVI_U8 sID, CVI_FLOAT time, CVI_FLOAT *line)
{
    ...
    sID     = AE_CheckSensorID(sID);
    tmpLine = time / AeInfo[sID].fExpLineTime;
    if (time == AeInfo[sID].u32ExpTimeMax) tmpLine = AeInfo[sID].u32ExpLineMax;
    AAA_LIMIT(tmpLine, AeInfo[sID].u32ExpLineMin, AeInfo[sID].u32ExpLineMax);
    *line = tmpLine;
}
...
{
    CVI_U32 isoNumTable[] = {100,   200,   400,   800,    1600,   3200,  6400,
    ...
    if (AeInfo[sID].enBlcType == AE_BLC_TYPE_LADDER) {
        totalGain = AE_CalTotalGain(AeInfo[sID].u32AGainMax, pStGain->u32DGain, AE_GAIN_BASE);
        AE_GetISONumByGain(totalGain, &isoNum);
        isoTableSize = ARRAY_SIZE(isoNumTable);

        for (i = 0; i < isoTableSize; ++i) {
            if (isoNum <= isoNumTable[i]) break;
        }

        isoNum = (i < isoTableSize) ? isoNumTable[i] : isoNumTable[isoTableSize - 1];
    } else {
        totalGain = AE_CalTotalGain(pStGain->u32AGain, pStGain->u32DGain, AE_GAIN_BASE);
        AE_GetISONumByGain(totalGain, &isoNum);
    }
...
{
    sID = AE_CheckSensorID(sID);
    memcpy(meterLuma, AeInfo[sID].u16MeterLuma[AE_LE],
           AE_ZONE_ROW * AE_ZONE_COLUMN * sizeof(CVI_U16));
}
    ...
    for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
        if (AeInfo[sID].u8ConvergeMode[AE_LE] == CONVERGE_FAST) {
            if (AeInfo[sID].u8FastConvergeFrmCnt % AeInfo[sID].u8MeterFramePeriod == 0) {
                tmpLVX100[sID][i] =
                    700 + (AeInfo[sID].stApex[i].s16TVEntry - AeInfo[sID].stApex[i].s16SVEntry +
                           AeInfo[sID].s16LvBvStep[i] - EVTT_ENTRY_1_30SEC) *
                              100 / ENTRY_PER_EV;
    ...
    if (pstAeExposureAttrInfo[sID]) {
        if (pstAeExposureAttrInfo[sID]->enOpType == OP_TYPE_MANUAL) {
            memcpy((CVI_U8 *)&fLightValue,
                   (CVI_U8 *)&pstAeExposureAttrInfo[sID]->stAuto.au32Reserve[0], sizeof(CVI_FLOAT));
...
CVI_S32 AE_SetRouteInfo(CVI_U8 sID, AE_WDR_FRAME wdrFrm, ISP_AE_ROUTE_S *routeInfo)
{
    ...
    for (i = 0; i < nodeNum; ++i) {
        ...
        if (AE_GetDebugMode(sID) == 111) {
            printf("i:%d N:%d RT:%u PT:%u RG:%u PG:%u\n", i, realNodeNum, realNodeTime,
                   realNodeGain, realNodeTime, realNodeGain);
        }
    ...
    if (AeInfo[sID].enSlowShutterStatus == AE_ENTER_SLOW_SHUTTER && wdrFrm == AE_LE) {
        ...
        tmpRoute.astRouteNode[i + 1].enIrisFNO     = tmpRoute.astRouteNode[i].enIrisFNO;
        tmpRoute.astRouteNode[i + 1].u32IrisFNOLin = 1 << tmpRoute.astRouteNode[i].enIrisFNO;
        ...
        if (realNodeGain != pstAeExposureAttrInfo[sID]->stAuto.u32GainThreshold) {
            ...
            tmpRoute.astRouteNode[i + 2].enIrisFNO     = tmpRoute.astRouteNode[i].enIrisFNO;
            tmpRoute.astRouteNode[i + 2].u32IrisFNOLin = 1 << tmpRoute.astRouteNode[i].enIrisFNO;
            tmpRoute.u32TotalNum++;
        }
    }
    ...
    *routeInfo = tmpRoute;
    ...
    if (AE_GetDebugMode(sID) == 111) AE_SetDebugMode(sID, 0);
...
CVI_S32 AE_SetRouteExInfo(CVI_U8 sID, AE_WDR_FRAME wdrFrm, ISP_AE_ROUTE_EX_S *routeExInfo)
{
    ...
    for (i = 0; i < nodeNum; ++i) {
        ...
        if (nodeExposure <= minExposure) {
            ...
            realNodeExTime = (nodeExChangeItem == AE_CHANGE_SHUTTER) ? maxTime : preNodeExTime;
            realNodeAGain  = (nodeExChangeItem == AE_CHANGE_AGAIN) ? maxAGain : preNodeAGain;
            realNodeDGain  = (nodeExChangeItem == AE_CHANGE_DGAIN) ? maxDGain : preNodeDGain;
            realNodeIspDGain =
                (nodeExChangeItem == AE_CHANGE_ISPDGAIN) ? maxIspDgain : preNodeIspDGain;
        } else {
            if (i == 0) {
                realNodeExTime = AE_LimitExpTime(sID, nodeTime);
                realNodeAGain =
                    AE_LimitAGain(sID, pstAeRouteExInfo[sID][wdrFrm]->astRouteExNode[i].u32Again);
                realNodeDGain =
                    AE_LimitDGain(sID, pstAeRouteExInfo[sID][wdrFrm]->astRouteExNode[i].u32Dgain);
                realNodeIspDGain = AE_LimitISPDGain(
                    sID, pstAeRouteExInfo[sID][wdrFrm]->astRouteExNode[i].u32IspDgain);
            } else {
                if (nodeExChangeItem == AE_CHANGE_SHUTTER) {
                    ...
                    realNodeAGain = AE_LimitAGain(
                        sID, pstAeRouteExInfo[sID][wdrFrm]->astRouteExNode[i].u32Again);
                    realNodeExTime   = preNodeExTime;
                    realNodeDGain    = preNodeDGain;
                    realNodeIspDGain = preNodeIspDGain;
                } else if (nodeExChangeItem == AE_CHANGE_DGAIN) {
                    realNodeDGain = AE_LimitDGain(
                        sID, pstAeRouteExInfo[sID][wdrFrm]->astRouteExNode[i].u32Dgain);
                    realNodeExTime   = preNodeExTime;
                    realNodeAGain    = preNodeAGain;
                    realNodeIspDGain = preNodeIspDGain;
        ...
        if (AE_GetDebugMode(sID) == 112) {
            ...
            printf("AG:%u PAG:%u DG:%u PDG:%u IG:%u PIG:%u CI:%d\n", realNodeAGain, preNodeAGain,
                   realNodeDGain, preNodeDGain, realNodeIspDGain, preNodeIspDGain,
                   nodeExChangeItem);
        }

        if (realNodeExNum < ISP_AE_ROUTE_EX_MAX_NODES &&
            (realNodeExTime != preNodeExTime || realNodeAGain != preNodeAGain ||
             realNodeDGain != preNodeDGain || realNodeIspDGain != preNodeIspDGain)) {
            ...
            tmpRouteEx.astRouteExNode[realNodeExNum].u32IrisFNOLin =
                1 << tmpRouteEx.astRouteExNode[realNodeExNum].enIrisFNO;
            realNodeExNum++;
    ...
    if (AeInfo[sID].enSlowShutterStatus == AE_ENTER_SLOW_SHUTTER && wdrFrm == AE_LE) {
        ...
        if (nodeExChangeItem == AE_CHANGE_AGAIN) {
            slowShutterEx.astRouteExNode[ssNodeCnt].u32Again =
                (CVI_U64)pstAeExposureAttrInfo[sID]->stAuto.u32GainThreshold * AE_GAIN_BASE *
                AE_GAIN_BASE / (realNodeDGain * realNodeIspDGain);
        } else if (nodeExChangeItem == AE_CHANGE_DGAIN) {
            slowShutterEx.astRouteExNode[ssNodeCnt].u32Dgain =
                (CVI_U64)pstAeExposureAttrInfo[sID]->stAuto.u32GainThreshold * AE_GAIN_BASE *
                AE_GAIN_BASE / (realNodeAGain * realNodeIspDGain);
        } else {
            slowShutterEx.astRouteExNode[ssNodeCnt].u32IspDgain =
                (CVI_U64)pstAeExposureAttrInfo[sID]->stAuto.u32GainThreshold * AE_GAIN_BASE *
                AE_GAIN_BASE / (realNodeAGain * realNodeDGain);
        }
        ...
        slowShutterEx.astRouteExNode[ssNodeCnt].u32Again =
            slowShutterEx.astRouteExNode[ssNodeCnt - 1].u32Again;
        slowShutterEx.astRouteExNode[ssNodeCnt].u32Dgain =
            slowShutterEx.astRouteExNode[ssNodeCnt - 1].u32Dgain;
        slowShutterEx.astRouteExNode[ssNodeCnt].u32IspDgain =
            slowShutterEx.astRouteExNode[ssNodeCnt - 1].u32IspDgain;

        slowShutterEx.astRouteExNode[ssNodeCnt].enIrisFNO =
            tmpRouteEx.astRouteExNode[ssNodeCnt - 1].enIrisFNO;
        ...
        if (realNodeAGain != tmpRouteEx.astRouteExNode[realNodeExNum - 1].u32Again ||
            ...
            slowShutterEx.astRouteExNode[ssNodeCnt].enIrisFNO =
                tmpRouteEx.astRouteExNode[i].enIrisFNO;
            slowShutterEx.astRouteExNode[ssNodeCnt].u32IrisFNOLin =
        ...
        for (j = i + 1; j < tmpRouteEx.u32TotalNum; ++j) {
            ...
            slowShutterEx.astRouteExNode[ssNodeCnt].u32Again =
                tmpRouteEx.astRouteExNode[j].u32Again;
            slowShutterEx.astRouteExNode[ssNodeCnt].u32Dgain =
                tmpRouteEx.astRouteExNode[j].u32Dgain;
            slowShutterEx.astRouteExNode[ssNodeCnt].u32IspDgain =
    ...
    *routeExInfo = (AeInfo[sID].enSlowShutterStatus == AE_ENTER_SLOW_SHUTTER && wdrFrm == AE_LE)
    ...
    if (AE_GetDebugMode(sID) == 112) AE_SetDebugMode(sID, 0);
...
CVI_S32 AE_SetExposureInfo(CVI_U8 sID)
{
    ...
    pstExpInfo->u32ISPDGain =
        AE_LimitISPDGain(sID, AeInfo[sID].stExp[AE_LE].stSensorExpGain.u32ISPDGain);
    totalGain =
        AE_CalTotalGain(pstExpInfo->u32AGain, pstExpInfo->u32DGain, pstExpInfo->u32ISPDGain);
    ...
    if (AeInfo[sID].bWDRMode) {
        ...
        pstExpInfo->u32ShortExpTime =
            AE_LimitWDRSEExpTime(sID, AeInfo[sID].stExp[AE_SE].u32SensorExpTime);
        pstExpInfo->u32AGainSF =
            AE_LimitAGain(sID, AeInfo[sID].stExp[AE_SE].stSensorExpGain.u32AGain);
        pstExpInfo->u32DGainSF =
            AE_LimitDGain(sID, AeInfo[sID].stExp[AE_SE].stSensorExpGain.u32DGain);
        pstExpInfo->u32ISPDGainSF =
            AE_LimitISPDGain(sID, AeInfo[sID].stExp[AE_SE].stSensorExpGain.u32ISPDGain);
        ...
        pstExpInfo->u32RefExpRatio = (CVI_U32)AeInfo[sID].u16MeterMaxLuma[AE_SE] * expRatio /
        ...
        pstExpInfo->bGainSepStatus = (AeInfo[sID].enWDRGainMode == SNS_GAIN_MODE_SHARE ||
                                      AeInfo[sID].enWDRGainMode == SNS_GAIN_MODE_ONLY_LEF)
                                         ? 0
                                         : 1;
    } else {
    ...
    pstExpInfo->u32ISOCalibrate =
        pstExpInfo->u32ISO * 256 / AAA_DIV_0_TO_1(pstAeExposureAttrInfo[sID]->stAuto.u16ISOCalCoef);

    res = AE_SetRouteInfo(sID, AE_LE, &pstExpInfo->stAERoute);
    if (res == CVI_FAILURE) return res;
...
CVI_S32 AE_SetStatisticsConfig(CVI_U8 sID, const ISP_AE_STATISTICS_CFG_S *pstAeStatCfg)
{
    ...
    if (!pstAeStatisticsCfg[sID]) {
        ISP_LOG_INFO("%s\n", "pstAeStatisticsCfg is NULL.");  // todo
        return CVI_FAILURE;
    }
...
CVI_S32 AE_BracketingSetExposure(CVI_U8 sID, CVI_S16 leEv, CVI_S16 seEv)
{
    ...
    if (AeInfo[sID].bWDRMode) AE_GetWDRLESEEntry(sID, &bracketingExp[AE_LE], &bracketingExp[AE_SE]);
    ...
    for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
        ...
        AE_GetExposureTimeIdealLine(sID, bracketing[i].fIdealExpTime,
                                    &bracketing[i].fIdealExpTimeLine);
    ...
    if (AE_GetDebugMode(sID) == 61) {
        ...
        printf("LE:%d %d %d SE:%d %d %d\n", bracketingExp[AE_LE].s16BVEntry,
               bracketingExp[AE_LE].s16TVEntry, bracketingExp[AE_LE].s16SVEntry,
               bracketingExp[AE_SE].s16BVEntry, bracketingExp[AE_SE].s16TVEntry,
               bracketingExp[AE_SE].s16SVEntry);
        printf("exp LE T:%d L:%d-%d SE T:%d L:%d-%d AG:%d DG:%d R:%d\n",
               bracketing[AE_LE].u32ExpTime, bracketing[AE_LE].u32ExpTimeLine,
               AeInfo[sID].stExp[AE_LE].u32SensorExpTimeLine, bracketing[AE_SE].u32ExpTime,
               bracketing[AE_SE].u32ExpTimeLine, AeInfo[sID].stExp[AE_SE].u32SensorExpTimeLine,
               AeInfo[sID].stExp[AE_LE].stExpGain.u32AGain,
               AeInfo[sID].stExp[AE_LE].stExpGain.u32DGain, result);

        for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
            printf("%d %u FL:%d\n", i, AeInfo[sID].u32frmCnt, AeInfo[sID].u16FrameAvgLuma[i]);
            printf("Set expL:%u %u Sensor ExpL:%u\n", bracketing[i].u32ExpTimeLine,
...
CVI_S32 AE_BracketingSetIndex(CVI_U8 sID, CVI_S16 index)
{
    ...
    AE_GetRouteTVAVSVEntry(sID, AE_LE, bracketingExp[AE_LE].s16BVEntry,
                           &bracketingExp[AE_LE].s16TVEntry, &bracketingExp[AE_LE].s16AVEntry,
                           &bracketingExp[AE_LE].s16SVEntry);

    AE_GetRouteTVAVSVEntry(sID, AE_SE, bracketingExp[AE_SE].s16BVEntry,
                           &bracketingExp[AE_SE].s16TVEntry, &bracketingExp[AE_SE].s16AVEntry,
                           &bracketingExp[AE_SE].s16SVEntry);
...
void AE_InitPara(VI_PIPE ViPipe, CVI_BOOL isInit)
{
    ...
    if (!isInit) {
        ...
        AeInfo[sID].u32TotalGainMin             = AE_CalTotalGain(
            AeInfo[sID].u32AGainMin, AeInfo[sID].u32DGainMin, AeInfo[sID].u32ISPDGainMin);
        AeInfo[sID].u32TotalGainMax = AE_CalTotalGain(
            AeInfo[sID].u32AGainMax, AeInfo[sID].u32DGainMax, AeInfo[sID].u32ISPDGainMax);
        ...
        if (u8SensorNum < sID + 1) u8SensorNum = sID + 1;
        ...
        AE_GetGainBySvEntry(sID, AE_GAIN_TOTAL, AeInfo[sID].s16BLCMaxISOEntry,
                            &AeInfo[sID].u32BLCSysGainMax);
        ...
        for (j = 0; j < AeInfo[sID].u8AeMaxFrameNum; ++j) {
            ...
            AeInfo[sID].stInitApex[j].s16BVEntry =
                AeInfo[sID].stInitApex[j].s16TVEntry - AeInfo[sID].stInitApex[j].s16SVEntry;
        ...
        AeInfo[sID].s16LvX100[AE_LE] =
            700 + (AeInfo[sID].stApex[AE_LE].s16BVEntry - EVTT_ENTRY_1_30SEC) * 100 / ENTRY_PER_EV;
    }
...
{
    sID = AE_CheckSensorID(sID);
    if (AeBootInfo[sID]) *bootInfo = *AeBootInfo[sID];
}

void AE_SetDebugMode(CVI_U8 sID, CVI_U8 mode)
{
    sID = AE_CheckSensorID(sID);
    if (mode && u8AeDebugPrintMode[sID] != mode) printf("AE debugM:%d\n", mode);
...
CVI_U32 AE_LimitISONum(CVI_U8 sID, CVI_U32 ISONum)
{
    ...
    if (isLimitISONum) {
        ...
        maxTotalGain = AE_CalTotalGain(pstAeExposureAttrInfo[sID]->stAuto.stAGainRange.u32Max,
                                       ...
                                       pstAeExposureAttrInfo[sID]->stAuto.stISPDGainRange.u32Max);
        minTotalGain =
            AAA_MAX(minTotalGain, pstAeExposureAttrInfo[sID]->stAuto.stSysGainRange.u32Min);
        maxTotalGain =
            AAA_MIN(maxTotalGain, pstAeExposureAttrInfo[sID]->stAuto.stSysGainRange.u32Max);
...
{
    sID = AE_CheckSensorID(sID);
    if (AeInfo[sID].bWDRLEOnly != wdrLEOnly) ISP_LOG_INFO("wdrLEOnly:%d\n", wdrLEOnly);
...
#define RATIO_X_100       100
    ...
    delayFrmNum = (pstAeSmartExposureAttrInfo[sID]->bEnable)
                      ? pstAeSmartExposureAttrInfo[sID]->u16SmartDelayNum
                      : STABLE_FRAME_NUM;
        ...
        if (pstSmartInfo->bEnable) {
            for (i = 0; i < pstSmartInfo->u8Num; ++i) {
                printf("AE sID:%d fid:%u %d N:%d X:%d Y:%d W:%d H:%d FW:%d FH:%d\n", sID,
                       AeInfo[sID].u32frmCnt, i, pstSmartInfo->u8Num, pstSmartInfo->u16PosX[i],
                       pstSmartInfo->u16PosY[i], pstSmartInfo->u16Width[i],
                       pstSmartInfo->u16Height[i], pstSmartInfo->u16FrameWidth,
                       pstSmartInfo->u16FrameHeight);
            }
        } else {
            printf("AE sID:%d fid:%u N:%d\n", sID, AeInfo[sID].u32frmCnt, pstSmartInfo->u8Num);
        }
    }

    if (pstSmartInfo->u8Num == 0 || !pstSmartInfo->bEnable ||
        (!pstAeSmartExposureAttrInfo[sID]->bEnable &&
         !pstAeExposureAttrInfo[sID]->stAuto.bEnableFaceAE)) {
        fdFrmStatusCnt[sID] = (fdFrmStatusCnt[sID] >= 1) ? fdFrmStatusCnt[sID] - 1 : 0;

        if (fdFrmStatusCnt[sID] == 0) AE_ResetFaceDetectInfo(sID);
    ...
    if ((fdPosX + fdWidth > frameWidth) || (fdPosY + fdHeight > frameHeight) || (!fdWidth) ||
        (!fdHeight) || (!gridPerSizeX) || (!gridPerSizeY)) {
    ...
    ratioX100 = (pstAeSmartExposureAttrInfo[sID]->bEnable)
                    ? 100 - pstAeSmartExposureAttrInfo[sID]->u8NarrowRatio
                    : 100 - NARROW_FACE_RATIO;

    if (ratioX100 == 0) ratioX100 = 1;
...
void AE_CalFaceDetectLuma(CVI_U8 sID)
{
    ...
    CVI_U8  rowStartIdx, columnStartIdx, rowEndIdx, columnEndIdx, row, column;
    ...
    if (!AeFaceDetect[sID].bMode) return;
    ...
    if (!AeFaceDetect[sID].u8GridSizeX) AeFaceDetect[sID].u8GridSizeX = 1;

    if (!AeFaceDetect[sID].u8GridSizeY) AeFaceDetect[sID].u8GridSizeY = 1;

    fdGridStartIndex = tmpAEFDPosY / AeFaceDetect[sID].u8GridSizeY * AE_ZONE_COLUMN +
                       tmpAEFDPosX / AeFaceDetect[sID].u8GridSizeX;

    fdGridEndIndex =
        (tmpAEFDPosY + tmpAEFDHeight) / AeFaceDetect[sID].u8GridSizeY * AE_ZONE_COLUMN +
    ...
    if (pstAeSmartExposureAttrInfo[sID]->bEnable) {
        ...
        if (pstAeSmartExposureAttrInfo[sID]->enSmartExpType == OP_TYPE_MANUAL) {
            AeFaceDetect[sID].u16FDTargetLuma = AeFaceDetect[sID].u16FDTargetLuma *
                                                pstAeSmartExposureAttrInfo[sID]->u16ExpCoef /
                                                EXP_COEF_BASE;
        }
    } else {
        AeFaceDetect[sID].u16FDTargetLuma = pstAeExposureAttrInfo[sID]->stAuto.u8FaceTargetLuma
                                            << 2;
    }
    ...
    for (row = rowStartIdx; row <= rowEndIdx; ++row) {
        for (column = columnStartIdx; column <= columnEndIdx; ++column) {
            ...
            tmpBvStep =
                (Log2x100Tbl[tmpGridLuma] - Log2x100Tbl[AeFaceDetect[sID].u16FDTargetLuma]) *
                ENTRY_PER_BV;
            tmpBvStep = (tmpBvStep > 0) ? ((tmpBvStep + 50) / 100) : ((tmpBvStep - 50) / 100);
...
void AE_CalFaceDetectBvStep(CVI_U8 sID)
{
    ...
    if (pstAeSmartExposureAttrInfo[sID]->bEnable) {
        if (AeInfo[sID].u32frmCnt % pstAeSmartExposureAttrInfo[sID]->u8SmartInterval) return;
    }

    faceWeight                     = (pstAeSmartExposureAttrInfo[sID]->bEnable)
                                         ? pstAeSmartExposureAttrInfo[sID]->u8Weight
                                         : pstAeExposureAttrInfo[sID]->stAuto.u8FaceWeight;
    ...
    if (AeFaceDetect[sID].bUpdateInfo || AeFaceDetect[sID].s16CurTargetBv == 0) {
        AeFaceDetect[sID].s16FinalBvStep = (AeFaceDetect[sID].s16EnvBvStep * envWeight +
                                            AeFaceDetect[sID].s16FDEVStep * faceWeight) /
                                           100;
        AeFaceDetect[sID].s16CurTargetBv =
            AeInfo[sID].stApex[AE_LE].s16BVEntry + AeFaceDetect[sID].s16FinalBvStep;
    ...
    if (pstAeSmartExposureAttrInfo[sID]->bEnable) {
        if (pstAeSmartExposureAttrInfo[sID]->enSmartExpType == OP_TYPE_AUTO) {
            ...
            if (expCoefMin > expCoefMax) expCoefMin = expCoefMax;
            ...
            else if (AeFaceDetect[sID].s16FinalBvStep - AeInfo[sID].s16BvStepEntry[AE_LE] <
                     minBvStep)
    ...
    for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
        for (row = 0; row < AeInfo[sID].u8GridVNum; row++) {
            for (column = 0; column < AeInfo[sID].u8GridHNum; column++) {
                ...
                GValue = (pstAeInfo->pstFEAeStat3[0]->au16ZoneAvg[i][row][column][AE_CHANNEL_GR] +
                          pstAeInfo->pstFEAeStat3[0]->au16ZoneAvg[i][row][column][AE_CHANNEL_GB]) /
                         2;
        ...
        for (j = HIST_NUM - 1; j > 0; --j) {
            ...
            if (hisBrightQuaCnt[i] >= hisTotalCnt[i] / 4) {
                AeInfo[sID].u16BrightQuaG[i] =
                    hisBrightQuaSum[i] / AAA_DIV_0_TO_1(hisBrightQuaCnt[i]);
                break;
            }
        }
    }
...
CVI_S32 AE_InitSensorFpsPara(CVI_U8 sID, CVI_FLOAT fps, AE_CTX_S *pstAeCtx)
{
    ...
    if (uMinLineTime % 1000000) offset = 1;

    if (AeInfo[sID].bWDRMode) {
        if (pstAeCtx->stSnsRegister.stAeExp.pfn_cmos_get_inttime_max) {
            pstAeCtx->stSnsRegister.stAeExp.pfn_cmos_get_inttime_max(
                viPipe, manual, ratio, IntTimeMax, IntTimeMin, LFMaxIntTime);
        } else {
        ...
        if (AeInfo[sID].fFps >= 25 || !isInit[sID]) {
            ...
            AeInfo[sID].u32WDRSEExpTimeMax =
                AeInfo[sID].u32WDRSEExpLineMax * AeInfo[sID].fExpLineTime;
            AE_GetTvEntryByTime(sID, AeInfo[sID].u32WDRSEExpTimeMax,
                                &AeInfo[sID].s16WDRSEMinTVEntry);
        }
...
#define GAIN_CALCULATE_NODE (20)
    ...
    if (AeInfo[sID].u8DGainAccuType == AE_ACCURACY_DB) {
        ...
        for (i = AeInfo[sID].u32DGainMin; i <= AeInfo[sID].u32DGainMax; i += gainGap) {
            ...
            preDGain[sID] = dGain;
            if (dGain >= pstAeCtx->stSnsDft.u32MaxDgain) break;
        }
    }
#endif
}
...
CVI_S32 AE_InitSensorPara(VI_PIPE ViPipe, const ISP_AE_PARAM_S *pstAeParam)
{
    ...
    if (pubAttr.f32FrameRate < AeInfo[sID].fMinFps || pubAttr.f32FrameRate > AeInfo[sID].fMaxFps) {
        setDefaultFps = 1;
        pubAttr.f32FrameRate =
            (pstAeParam->u8WDRMode == WDR_MODE_NONE) ? LINEAR_MODE_FPS : WDR_MODE_FPS;
    }
    ...
    AeInfo[sID].bDGainSwitchToAGain =
        (AeInfo[sID].u8DGainAccuType == AE_ACCURACY_DB) ? DGAIN_TO_AGAIN : 0;
    ...
    AE_SetFastBootExposure(sID, pstAeCtx->stSnsDft.u32IntExposure, pstAeCtx->stSnsDft.u32IntAgain,
                           pstAeCtx->stSnsDft.u32IntDgain, 1024);
...
CVI_S32 aeInit(VI_PIPE ViPipe, const ISP_AE_PARAM_S *pstAeParam)
{
    ...
    if (res != CVI_SUCCESS) return CVI_FAILURE;
...
void AE_CheckRouteExRange(CVI_U8 sID, AE_WDR_FRAME wdrFrm, ISP_AE_ROUTE_EX_S *pstRouteEx)
{
    ...
    for (i = 0; i < pstRouteEx->u32TotalNum; ++i) {
        ...
        AAA_LIMIT(pstRouteEx->astRouteExNode[i].u32Again, AeInfo[sID].u32AGainMin,
                  AeInfo[sID].u32AGainMax);
        AAA_LIMIT(pstRouteEx->astRouteExNode[i].u32Dgain, AeInfo[sID].u32DGainMin,
                  AeInfo[sID].u32DGainMax);
...
void AE_CalculateManualBvEntry(CVI_U8 sID, CVI_U32 exposure, CVI_S16 *bvEntry)
{
    ...
    nodeNum   = (pstAeExposureAttrInfo[sID]->bAERouteExValid)
                    ? pstAeRouteExInfo[sID][AE_LE]->u32TotalNum
                    : pstAeRouteInfo[sID][AE_LE]->u32TotalNum;
    ...
    for (i = 0; i < nodeNum; ++i) {
        if (pstAeExposureAttrInfo[sID]->bAERouteExValid) {
            ...
            routeGain =
                AE_CalTotalGain(pstAeRouteExInfo[sID][AE_LE]->astRouteExNode[i].u32Again,
...
void AE_FindROIWeightThr(CVI_U8 sID)
{
    ...
    memcpy(tmpWeight, pstAeStatisticsCfgInfo[sID]->au8Weight,
           AE_WEIGHT_ZONE_ROW * AE_WEIGHT_ZONE_COLUMN * sizeof(CVI_U8));
    qsort(tmpWeight, AE_WEIGHT_ZONE_ROW * AE_WEIGHT_ZONE_COLUMN, sizeof(CVI_U8),
          U8_Comp_SortBigToSmall);
    ...
    if (AeInfo[sID].bParameterUpdate[AE_EXPOSURE_ATTR_UPDATE] ||
        ...
        *pstAeExposureAttrInfo[sID] = *pstAeMpiExposureAttr[sID];
        ...
        if (AeInfo[sID].s16MaxRangeTVEntry - AeInfo[sID].s16MinRangeTVEntry > 1) {
            if (tmpMaxTime > maxTime) AeInfo[sID].s16MinRangeTVEntry += 1;
            if (tmpMinTime < minTime) AeInfo[sID].s16MaxRangeTVEntry -= 1;
        }
        if (pstAeExposureAttrInfo[sID]->stAuto.enGainType == AE_TYPE_ISO) {
            ...
            if (AeInfo[sID].s16MaxRangeISOEntry - AeInfo[sID].s16MinRangeISOEntry > 1) {
                if (tmpMaxISONum > maxISONum) AeInfo[sID].s16MaxRangeISOEntry -= 1;
                if (tmpMinISONum < minISONum) AeInfo[sID].s16MinRangeISOEntry += 1;
            }
        } else {
        ...
        AeInfo[sID].u8AERunInterval =
            AAA_MAX(pstAeExposureAttrInfo[sID]->u8AERunInterval, AeInfo[sID].u8SensorRunInterval);
    ...
    if (AeInfo[sID].bParameterUpdate[AE_ROUTE_UPDATE] ||
        ...
        if (AeInfo[sID].bParameterUpdate[AE_ROUTE_EX_UPDATE] ||
            ...
            *pstAeRouteExInfo[sID][AE_LE] = *pstAeMpiRouteEx[sID][AE_LE];
            ...
            maxGain    = AE_CalTotalGain(
                pstAeRouteExInfo[sID][AE_LE]->astRouteExNode[maxNodeNum].u32Again,
...
CVI_S32 aeRun(VI_PIPE ViPipe, const ISP_AE_INFO_S *pstAeInfo, ISP_AE_RESULT_S *pstAeResult,
              CVI_S32 s32Rsv)
{
    AE_CTX_S             *pstAeCtx;
    static struct timeval firstAeTime[AE_SENSOR_NUM], curAeTime[AE_SENSOR_NUM],
        preAeTime[AE_SENSOR_NUM], proAeTime[AE_SENSOR_NUM];
    ...
    AE_HLprintf("======= i:%d TV:%d SV:%d =======\n", AeInfo[sID].u32frmCnt,
                AeInfo[sID].stApex[0].s16TVEntry, AeInfo[sID].stApex[0].s16SVEntry);
#endif
    ...
    if (AE_IsAeSimMode()) AE_SetAeSimEv(sID);
    ...
    if (AE_GetDebugMode(sID) == 1) {
        ...
        printf("sId:%u Fc:%u PN:%u V:%u H:%u\n", sID, AeInfo[sID].u32frmCnt,
               pstAeExposureAttrInfo[sID]->u8AERunInterval, AeInfo[sID].u8GridVNum,
               AeInfo[sID].u8GridHNum);
        printf("AE CTv:%d %d PTv:%d %d\n", (CVI_S32)curAeTime[sID].tv_sec,
               (CVI_S32)curAeTime[sID].tv_usec, (CVI_S32)preAeTime[sID].tv_sec,
               (CVI_S32)preAeTime[sID].tv_usec);
        printf("PeriodT:%u fps:%d ProT:%u\n", periodT[sID], (CVI_U16)AeInfo[sID].fFps,
               processT[sID]);
...
void AE_GetIspDgainCompensationRange(CVI_U8 sID, AE_EXPOSURE *pStExp, CVI_U32 *minRange,
                                     CVI_U32 *maxRange)
{
    CVI_U32 minISONum, maxISONum;
    ...
    if ((pstAeExposureAttrInfo[sID]->enOpType == OP_TYPE_MANUAL &&
        ...
        if (pstAeExposureAttrInfo[sID]->enOpType == OP_TYPE_MANUAL) {
            manualISONum = AAA_MIN(pstAeExposureAttrInfo[sID]->stManual.u32ISONum, maxISONum);
...
CVI_S32 AE_SetExposure(CVI_U8 sID, AE_EXPOSURE *pStExp)
{
    ...
    for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
        if (!pStExp[i].fIdealExpTime) pStExp[i].fIdealExpTime = pStExp[i].u32ExpTime;
    ...
    if (pstAeExposureAttrInfo[sID]->enOpType == OP_TYPE_MANUAL) {
        CVI_S16 tvEntry, svEntry, bvEntry;
        CVI_U32 sysGain;

        for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
            sysGain = AE_CalTotalGain(pStExp[i].stExpGain.u32AGain, pStExp[i].stExpGain.u32DGain,
                                      pStExp[i].stExpGain.u32ISPDGain);
            AE_GetTvEntryByTime(sID, pStExp[i].u32ExpTime, &tvEntry);
            AE_GetISOEntryByGain(sysGain, &svEntry);
            bvEntry                          = tvEntry - svEntry;
            AeInfo[sID].stApex[i].s16TVEntry = tvEntry;
            AeInfo[sID].stApex[i].s16SVEntry = svEntry;
            AeInfo[sID].stApex[i].s16BVEntry = bvEntry;
            AeInfo[sID].s16PreBvEntry[i]     = bvEntry;
        }
    }
        ...
        if (bSensorPortingCheck) {
            ...
            for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
                printf("fid(%d):%u T:%d Luma:%d time:%u expLine:%u AG:%u DG:%u IG:%u\n", i,
                       AeInfo[sID].u32frmCnt, AeInfo[sID].u16FramePeriodTime,
                       AeInfo[sID].u16CenterG[i], pStExp[i].u32SensorExpTime,
                       pStExp[i].u32SensorExpTimeLine, pStExp[i].stSensorExpGain.u32AGain,
                       pStExp[i].stSensorExpGain.u32DGain, pStExp[i].stSensorExpGain.u32ISPDGain);
            }
            printf("\n");
            ...
            for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
                printf("i:%d Tv E:%d T:%u(%u) %f(%f) ST:%u(%u)\n", i,
                       AeInfo[sID].stApex[i].s16TVEntry, pStExp[i].u32ExpTime,
                       pStExp[i].u32ExpTimeLine, pStExp[i].fIdealExpTime,
                       pStExp[i].fIdealExpTimeLine, pStExp[i].u32SensorExpTime,
                       pStExp[i].u32SensorExpTimeLine);
            ...
            if (AeInfo[sID].bWDRMode) {
                ...
                printf("LE:%u->%u(%u-%u) SE:%u->%u(%u-%u)---Diff:%d %d\n\n",
                       ...
                       pStExp[AE_LE].u32ExpTimeLine - time[1],
                       pStExp[AE_SE].u32ExpTimeLine - time[0]);
            }
            ...
            printf("fid:%u CG:%u FL:%u TL:%u Bs:%d T:%u AG:%u DG:%u ISPDG:%u\n",
                   AeInfo[sID].u32frmCnt, AeInfo[sID].u16CenterG[i], AeInfo[sID].u16FrameLuma[i],
                   AeInfo[sID].u16AdjustTargetLuma[i], AeInfo[sID].s16BvStepEntry[i],
                   AeInfo[sID].stExp[i].u32ExpTime, AeInfo[sID].stExp[i].stExpGain.u32AGain,
...
void AE_CalculateDCFInfo(CVI_U8 sID, ISP_AE_RESULT_S *pstAeResult)
{
    ...
    expTimeDenominator =
        (pstAeResult->u32IntTime[AE_LE]) ? (1000000 / pstAeResult->u32IntTime[AE_LE]) : 1;
    expTimeNumerator = 1;
...
void AE_SetExpToResult(CVI_U8 sID, ISP_AE_RESULT_S *pstAeResult, const AE_EXPOSURE *pStExp)
{
    ...
    pstAeResult->fEvRatio[AE_LE] = (preFrameEv[sID][AE_LE]) ? (CVI_FLOAT)preFrameEv[sID][AE_LE] /
                                                                  AAA_DIV_0_TO_1(curFrameEv[AE_LE])
                                                            : 1;
    ...
    if (AeInfo[sID].bWDRMode) {
        ...
        pstAeResult->u32IspDgainSF =
            AE_LimitISPDGain(sID, pStExp[AE_SE].stSensorExpGain.u32ISPDGain);
        ...
        pstAeResult->fEvRatio[AE_SE] =
            (preFrameEv[sID][AE_SE])
                ? (CVI_FLOAT)preFrameEv[sID][AE_SE] / AAA_DIV_0_TO_1(curFrameEv[AE_SE])
                : 1;
    } else {
    ...
    if (AeInfo[sID].bRegWeightUpdate) {
        memcpy(pstAeResult->stStatAttr.au8WeightTable, pstAeStatisticsCfgInfo[sID]->au8Weight,
    ...
    if (AE_GetDebugMode(sID) == 10) {
        ...
        for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
            printf("%d T:%u(%u) ST:%u(%u) RT:%u AG:%u(%u) DG:%u(%u) IG:%u(%u) ISO:%u %u\n", i,
                   pStExp[i].u32ExpTime, pStExp[i].u32ExpTimeLine, pStExp[i].u32SensorExpTime,
                   pStExp[i].u32SensorExpTimeLine, pstAeResult->u32IntTime[i],
                   pStExp[i].stExpGain.u32AGain, pStExp[i].stSensorExpGain.u32AGain,
                   pStExp[i].stExpGain.u32DGain, pStExp[i].stSensorExpGain.u32DGain,
                   pStExp[i].stExpGain.u32ISPDGain, pStExp[i].stSensorExpGain.u32ISPDGain,
                   AeInfo[sID].u32ISONum[i], AeInfo[sID].u32BLCISONum[i]);
            // printf("Ev:%lu pEv:%lu R:%f\n", curFrameEv[i], preFrameEv[i],
            // pstAeResult->fEvRatio[i]);
        }

        printf("Lv:%d Bs:%d stable:%d\n", pstAeResult->s16CurrentLV,
               AeInfo[sID].s16BvStepEntry[AE_LE], pstAeResult->bStable);
    }
    ...
    if (bTableUpdateEnable) {
        ...
        printf("fid:%u Exp0:%u %u %u %u Exp1:%u %u %u %u ISO:%u LV:%u\n",
               ...
               stRawReplayExpInfo[tableIndex].u32ISPDGain[AE_SE],
               stRawReplayExpInfo[tableIndex].u32ISO, stRawReplayExpInfo[tableIndex].s16LvX100);
#endif
    }

    if (AeInfo[sID].u8RawNum) {
        AeInfo[sID].u8RawBufCnt++;
        if (AeInfo[sID].u8RawBufCnt >= AeInfo[sID].u8RawNum) bTableUpdateEnable = 0;
    }
...
void AE_SaveBootLog(CVI_U8 sID)
{
    ...
    if (bootFrmCnt[sID] < AE_BOOT_MAX_FRAME) {
        for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
            ...
            AeBootInfo[sID]->u16AdjustTargetLuma[i][bootFrmCnt[sID]] =
                AeInfo[sID].u16AdjustTargetLuma[i];
...
void AE_SaveSmoothExpSettingLog(CVI_U8 sID)
{
    ...
    for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
        ...
        AE_LogPrintf("fid(%d, %d):%10d Luma:%4d Lv:%5d Time:%5d ExpL:%4d ", sID, i,
                     AeInfo[sID].u32frmCnt, AeInfo[sID].u16CenterG[i], AeInfo[sID].s16LvX100[AE_LE],
                     AeInfo[sID].stExp[i].u32ExpTime, AeInfo[sID].stExp[i].u32ExpTimeLine);
        AE_LogPrintf("ISO:%10d AG:%6d DG:%6d IspDG:%5d ", AeInfo[sID].u32ISONum[AE_LE],
                     AeInfo[sID].stExp[i].stExpGain.u32AGain,
                     AeInfo[sID].stExp[i].stExpGain.u32DGain,
                     AeInfo[sID].stExp[i].stExpGain.u32ISPDGain);
        AE_LogPrintf("STime:%5d SExpL:%4d BlcISO:%u SAG:%6u SDG:%6u SIG:%5u\n",
                     AeInfo[sID].stExp[i].u32SensorExpTime,
                     AeInfo[sID].stExp[i].u32SensorExpTimeLine, AeInfo[sID].u32BLCISONum[AE_LE],
                     AeInfo[sID].stExp[i].stSensorExpGain.u32AGain,
                     AeInfo[sID].stExp[i].stSensorExpGain.u32DGain,
                     AeInfo[sID].stExp[i].stSensorExpGain.u32ISPDGain);
    }
...
static void AE_SaveLog(CVI_U8 sID, const ISP_AE_RESULT_S *pstAeResult)
{
    ...
    if (AE_Dump2File) return;

    for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
        AE_LogPrintf("%s", AE_GetTimestampStr());
        AE_LogPrintf("fid(%d, %d):%6d Luma:%4d Lv:%5d T:%5d L:%4d ", sID, i, AeInfo[sID].u32frmCnt,
                     AeInfo[sID].u16CenterG[i], AeInfo[sID].s16LvX100[AE_LE],
                     AeInfo[sID].stExp[i].u32ExpTime, AeInfo[sID].stExp[i].u32ExpTimeLine);
        AE_LogPrintf("ISO:%6d AG:%6d DG:%6d IG:%5d ", AeInfo[sID].u32ISONum[AE_LE],
                     AeInfo[sID].stExp[i].stExpGain.u32AGain,
                     AeInfo[sID].stExp[i].stExpGain.u32DGain,
                     AeInfo[sID].stExp[i].stExpGain.u32ISPDGain);
        ...
        AE_LogPrintf("AeL(%d, %d):%d %d TL:%d ATL:%d LO:%d LB:%d HB:%d\n", sID, i,
                     AeInfo[sID].u16FrameLuma[i], AeInfo[sID].u16CenterG[i],
                     AeInfo[sID].u16TargetLuma[i], AeInfo[sID].u16AdjustTargetLuma[i],
                     AeInfo[sID].s16TargetlumaOffset[i], AeInfo[sID].s16TargetLumaLowBound[i],
                     AeInfo[sID].s16TargetLumaHighBound[i]);
        ...
        AE_LogPrintf("Bv(%d, %d):%d pBv:%d Tv:%d Sv:%d\n", sID, i, AeInfo[sID].stApex[i].s16BVEntry,
                     AeInfo[sID].s16PreBvEntry[i], AeInfo[sID].stApex[i].s16TVEntry,
                     AeInfo[sID].stApex[i].s16SVEntry);
        AE_LogPrintf("CM:%d S:%d CS:%d %d LV:%d P:%d LR:%d\n", AeInfo[sID].u8ConvergeMode[i],
                     AeInfo[sID].bIsStable[i], AeInfo[sID].bConvergeStable[i],
                     AeInfo[sID].u8ConvergeSpeed[i], AeInfo[sID].s16LvX100[AE_LE],
                     AeInfo[sID].u8LimitExposurePath[i], AeInfo[sID].u8His255Ratio[i]);
        ...
        if (AeInfo[sID].bEnableSmoothAE && !AeInfo[sID].bMeterEveryFrame) {
            for (j = 0; j < AeInfo[sID].u8MeterFramePeriod; ++j) {
                AE_LogPrintf("%d sBv:%d %d %d\n", AeInfo[sID].u32frmCnt + j,
                             ...
                             AeInfo[sID].stSmoothApex[i][j].s16TVEntry,
                             AeInfo[sID].stSmoothApex[i][j].s16SVEntry);
            }
        }
    }
    ...
    if ((pstAeSmartExposureAttrInfo[sID]->bEnable ||
        ...
        AE_LogPrintf("\nFD(%d) N:%d L:%d TL:%d W:%d Bs:%d EnBs:%d FBs:%d\n", sID,
                     AeFaceDetect[sID].stSmartInfo.u8Num, AeFaceDetect[sID].u16FDLuma,
                     AeFaceDetect[sID].u16FDTargetLuma, pstAeSmartExposureAttrInfo[sID]->u8Weight,
                     AeFaceDetect[sID].s16FDEVStep, AeFaceDetect[sID].s16EnvBvStep,
                     AeFaceDetect[sID].s16FinalBvStep);
        AE_LogPrintf("X:%d Y:%d W:%d H:%d FW:%d FH:%d\n", AeFaceDetect[sID].u16FDPosX,
                     AeFaceDetect[sID].u16FDPosY, AeFaceDetect[sID].u16FDWidth,
                     AeFaceDetect[sID].u16FDHeight, AeFaceDetect[sID].u16FrameWidth,
                     AeFaceDetect[sID].u16FrameHeight);
        AE_LogPrintf("AE X:%d Y:%d W:%d H:%d\n", AeFaceDetect[sID].u16AEFDPosX,
                     AeFaceDetect[sID].u16AEFDPosY, AeFaceDetect[sID].u16AEFDWidth,
                     AeFaceDetect[sID].u16AEFDHeight);
        AE_LogPrintf("GS:%d GE:%d GC:%d WC:%d HC:%d\n", AeFaceDetect[sID].u16AEFDGridStart,
                     AeFaceDetect[sID].u16AEFDGridEnd, AeFaceDetect[sID].u16AEFDGridCount,
                     AeFaceDetect[sID].u8AEFDGridWidthCount,
                     AeFaceDetect[sID].u8AEFDGridHeightCount);
    } else
    ...
    AE_LogPrintf("Res T:%d %d G:%d %d %d Iso:%u BlcIso:%u ExpR:%d stb:%d\n",
                 pstAeResult->u32IntTime[0], pstAeResult->u32IntTime[1], pstAeResult->u32Again,
                 pstAeResult->u32Dgain, pstAeResult->u32IspDgain, pstAeResult->u32Iso,
                 pstAeResult->u32BlcIso, pstAeResult->u32ExpRatio, pstAeResult->bStable);

    AE_LogPrintf(
        "L/S:%d S:%d Off:%d HR:%d %d HBR:%d %d LR:%d %d LBR:%d %d\n\n",
...
{  // dbg cmd: 110 , 16 0 0 0 0
    ...
    statisticsDivide = (AeInfo[sID].u8GridVNum / AE_WEIGHT_ZONE_ROW > 1 ||
                        AeInfo[sID].u8GridHNum / AE_WEIGHT_ZONE_COLUMN > 1)
                           ? 1
                           : 0;
        ...
        for (n = 0; n < AE_CHANNEL_NUM; ++n) {
            ...
            for (j = 0; j < AE_WEIGHT_ZONE_ROW; ++j) {
                for (k = 0; k < AE_WEIGHT_ZONE_COLUMN; ++k) {
                    if (statisticsDivide) {
                        AE_SnapLogPrintf(
                            "%d\t", (AeInfo[sID].pu16AeStatistics[i][2 * j][2 * k][n] +
                                     AeInfo[sID].pu16AeStatistics[i][2 * j][2 * k + 1][n] +
                                     AeInfo[sID].pu16AeStatistics[i][2 * j + 1][2 * k][n] +
                                     AeInfo[sID].pu16AeStatistics[i][2 * j + 1][2 * k + 1][n]) /
                                        4);
                    } else {
...
// Don't modify <==
    ...
    for (i = 0; i < AeInfo[sID].u8AeMaxFrameNum; ++i) {
        ...
        AE_SnapLogPrintf("CM:%d S:%d LV:%d ISO:%d\n", AeInfo[sID].u8ConvergeMode[i],
                         AeInfo[sID].bIsStable[i], AeInfo[sID].s16LvX100[AE_LE],
                         AeInfo[sID].u32ISONum[i]);
        AE_SnapLogPrintf(
            "T:%u(%u) L:%u(%u) AG:%u(%u) DG:%u(%u) IG:%u(%u)\n", AeInfo[sID].stExp[i].u32ExpTime,
            AeInfo[sID].stExp[i].u32SensorExpTime, AeInfo[sID].stExp[i].u32ExpTimeLine,
            AeInfo[sID].stExp[i].u32SensorExpTimeLine, AeInfo[sID].stExp[i].stExpGain.u32AGain,
            AeInfo[sID].stExp[i].stSensorExpGain.u32AGain, AeInfo[sID].stExp[i].stExpGain.u32DGain,
            AeInfo[sID].stExp[i].stSensorExpGain.u32DGain,
            AeInfo[sID].stExp[i].stExpGain.u32ISPDGain,
            AeInfo[sID].stExp[i].stSensorExpGain.u32ISPDGain);
        if (i == 1) AE_SnapLogPrintf("expR:%d\n", AeInfo[sID].u32WDRExpRatio);
    }
}
...
void AE_SaveParameterSetting(void)
{
    ...
    for (sID = 0; sID < u8SensorNum; ++sID) {
        ...
        AE_SnapLogPrintf("TV m:%d M:%d SE:%d\n", AeInfo[sID].s16MinTVEntry,
                         AeInfo[sID].s16MaxTVEntry, AeInfo[sID].s16WDRSEMinTVEntry);
        ...
        AE_SnapLogPrintf("RtEx m:%d M:%d\n", AeInfo[sID].s16MinRouteExTVEntry,
                         AeInfo[sID].s16MaxRouteExTVEntry);
        AE_SnapLogPrintf("Rg m:%d M:%d\n\n", AeInfo[sID].s16MinRangeTVEntry,
                         AeInfo[sID].s16MaxRangeTVEntry);
        AE_SnapLogPrintf("ISO: m:%d M:%d\n", AeInfo[sID].s16MinISOEntry,
                         AeInfo[sID].s16MaxISOEntry);
        ...
        AE_SnapLogPrintf("RtEx m:%d M:%d\n", AeInfo[sID].s16MinRouteExISOEntry,
                         AeInfo[sID].s16MaxRouteExISOEntry);
        AE_SnapLogPrintf("Rg m:%d M:%d\n", AeInfo[sID].s16MinRangeISOEntry,
                         AeInfo[sID].s16MaxRangeISOEntry);
        ...
        if (pstAeMpiExposureAttr[sID] != CVI_NULL) {
            AE_SnapLogPrintf(
                "BP:%d Op:%d RI:%d ExV:%d His:%d M:%d GS:%d\n", pstAeMpiExposureAttr[sID]->bByPass,
                pstAeMpiExposureAttr[sID]->enOpType, pstAeMpiExposureAttr[sID]->u8AERunInterval,
                pstAeMpiExposureAttr[sID]->bAERouteExValid,
            ...
            AE_SnapLogPrintf("GaThr%u Sp:%d BSp:%d Tol:%d\n",
                             pstAeMpiExposureAttr[sID]->stAuto.u32GainThreshold,
                             pstAeMpiExposureAttr[sID]->stAuto.u8Speed,
            ...
            AE_SnapLogPrintf("Comp:%d EvBias:%d\n",
                             pstAeMpiExposureAttr[sID]->stAuto.u8Compensation,
                             pstAeMpiExposureAttr[sID]->stAuto.u16EVBias);
            ...
            AE_SnapLogPrintf("StraM:%d RS:%d Off:%d M:%d\n",
                             ...
                             pstAeMpiExposureAttr[sID]->stAuto.u8MaxHistOffset,
                             pstAeMpiExposureAttr[sID]->stAuto.enAEMode);
            ...
            if (AeInfo[sID].bWDRMode) {
                AE_SnapLogPrintf("GM:%d SG:%d\n", AeInfo[sID].enWDRGainMode,
                                 AeInfo[sID].bWDRUseSameGain);
                AE_SnapLogPrintf("RT:%d R:%d Rm:%d  RM:%d\n",
                                 pstAeMpiWDRExposureAttr[sID]->enExpRatioType,
                                 pstAeMpiWDRExposureAttr[sID]->au32ExpRatio[0],
                                 pstAeMpiWDRExposureAttr[sID]->u32ExpRatioMin,
                                 pstAeMpiWDRExposureAttr[sID]->u32ExpRatioMax);

                AE_SnapLogPrintf("Tol:%d Sp:%d B:%d SEComp:%d\n",
                                 pstAeMpiWDRExposureAttr[sID]->u16Tolerance,
                                 pstAeMpiWDRExposureAttr[sID]->u16Speed,
            ...
            if (pstAeMpiSmartExposureAttr[sID]->bEnable) {
                ...
                AE_SnapLogPrintf(
                    "b:%d Ir:%d T:%d TL:%d C:%d Cm:%d CM:%d I:%d S:%d D:%d W:%d R:%d\n",
...
{
    sID                                                   = AE_CheckSensorID(sID);
    AeInfo[sID].u8SensorPeriod                            = period;
    AeInfo[sID].bParameterUpdate[AE_EXPOSURE_ATTR_UPDATE] = 1;
    return CVI_SUCCESS;
}
...
CVI_S32 AE_GetRawReplayExpBuf(CVI_U8 sID, CVI_U8 *buf, CVI_U32 *bufSize)
{
    ...
    for (i = 0; i < AE_RAW_REPLAY_TABLE_SIZE; ++i) {
        ...
        if (AeInfo[sID].u32RawId - AeInfo[sID].u8SensorPeriod ==
            stRawReplayExpInfo[i].u32FrameID + 1) {
            ispDgainIndex = i;
#ifdef FRAME_ID_CHECK
    ...
    for (i = 0; i < AeInfo[sID].u8RawNum; ++i) {
        ...
        AE_SnapLogPrintf("%u\t%u\t%u\t%u\t%u\t%u\t%u\t%u\t%u\t%d\n",
                         ...
                         stRawReplayExpInfo[tableIdex].u32ISO,
                         stRawReplayExpInfo[tableIdex].s16LvX100);
#ifdef FRAME_ID_CHECK
