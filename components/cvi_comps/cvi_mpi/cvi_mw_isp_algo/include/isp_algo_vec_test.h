...
#define TEST_REPORT_RUN_TIME(enable, desc, code_block)                            \
    do {                                                                          \
...
#define TEST_EQ_VALUE(enable, desc, golden, rvv)                                              \
    do {                                                                                      \
        if ((golden) == (rvv)) {                                                              \
            if (enable)                                                                       \
...
#define TEST_EQ_ARRAY(enable, desc, g, r, len)                                                     \
    do {                                                                                           \
...
#define TEST_EQ_ARRAY3(enable, desc, g1, g2, g3, r1, r2, r3, len)                       \
    do {                                                                                \
...
#define TEST_EQ_OR_LT1_ARRAY3(enable, desc, g1, g2, g3, r1, r2, r3, len)                        \
    do {                                                                                        \
...
#define _TEST_RVVINT_PRINT(SEW, LMUL, MLEN, T)                                             \
    extern inline void __attribute__((                                                     \
        __always_inline__, __gnu_inline__,                                                 \
        __artificial__)) TEST_PRINT_i##SEW##m##LMUL(char *desc, vint##SEW##m##LMUL##_t v,  \
                                                    size_t vl)                             \
    {                                                                                      \
        int##SEW##_t arr[vl];                                                              \
        vse##SEW##_v_i##SEW##m##LMUL(arr, v, vl);                                          \
        printf("printing %s, len: %ld\n", desc, vl);                                       \
        for (size_t i = 0; i < vl; i++) printf("%ld ", (int64_t)arr[i]);                   \
        printf("\n");                                                                      \
    }                                                                                      \
    extern inline void __attribute__((                                                     \
        __always_inline__, __gnu_inline__,                                                 \
        __artificial__)) TEST_PRINT_u##SEW##m##LMUL(char *desc, vuint##SEW##m##LMUL##_t v, \
                                                    size_t vl)                             \
    {                                                                                      \
        uint##SEW##_t arr[vl];                                                             \
        vse##SEW##_v_u##SEW##m##LMUL(arr, v, vl);                                          \
        printf("printing %s, len: %ld\n", desc, vl);                                       \
        for (size_t i = 0; i < vl; i++) printf("%ld ", (uint64_t)arr[i]);                  \
        printf("\n");                                                                      \
    }
