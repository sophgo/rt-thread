...
CVI_S32 isp_algo_demosaic_main(struct demosaic_param_in  *demosaic_param_in,
                               struct demosaic_param_out *demosaic_param_out)
{
    ...
    }
    {
        ...
        demosaic_param_out->ProtectColorGainSlope =
            get_lut_slp(in0, in1, out0, out1, DEMOSAIC_LUT_SLP_FBIT);
    }
    {
        ...
        demosaic_param_out->EdgeGainSlope =
            get_lut_slp(in0, in1, out0, out1, DEMOSAIC_LUT_SLP_FBIT);
    }
    {
        ...
        demosaic_param_out->DetailGainSlope =
            get_lut_slp(in0, in1, out0, out1, DEMOSAIC_LUT_SLP_FBIT);
    }
