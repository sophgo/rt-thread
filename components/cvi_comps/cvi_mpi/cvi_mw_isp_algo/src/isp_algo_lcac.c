...
static CVI_S32 isp_algo_lcac_update_lti_kernel(struct lcac_param_in  *lcac_param_in,
                                               struct lcac_param_out *lcac_param_out);
static CVI_S32 isp_algo_lcac_update_fcf_kernel(struct lcac_param_in  *lcac_param_in,
                                               struct lcac_param_out *lcac_param_out);
static CVI_S32 isp_algo_lcac_update_lti_luma_lut(struct lcac_param_in  *lcac_param_in,
                                                 struct lcac_param_out *lcac_param_out);
static CVI_S32 isp_algo_lcac_update_fcf_luma_lut(struct lcac_param_in  *lcac_param_in,
                                                 struct lcac_param_out *lcac_param_out);
...
CVI_S32 isp_algo_lcac_main(struct lcac_param_in  *lcac_param_in,
                           struct lcac_param_out *lcac_param_out)
{
    // ISP_DEBUG(LOG_INFO, "%s\n", "+");
    CVI_S32 ret = CVI_SUCCESS;
...
static void create_2D_Gaussian_kernel(int filter_size_h, int filter_size_w, int sigma,
                                      float *kernel)
{
...
static void create_1D_Gaussian_kernel(int filter_size, int Mean, int Sigma, int Wgt, int *kernel,
                                      float *tempbuf)
{
    int   x0      = 0;
                                               ...
                                               struct lcac_param_out *lcac_param_out)
{
    ...
    create_2D_Gaussian_kernel(LCAC_FILTER_SIZE_H, LCAC_FILTER_SIZE_W, FCF_GaussLPFSigma,
                              fcf_filter_kernel);
                                                 ...
                                                 struct lcac_param_out *lcac_param_out)
{
    ...
    create_1D_Gaussian_kernel(LCAC_LUMA_LUT_SIZE, FCF_GaussMean, EdgeWgtAdvance_Sigma,
                              EdgeWgtAdvance_Wgt, fcf_luma_lut, tempbuf);
