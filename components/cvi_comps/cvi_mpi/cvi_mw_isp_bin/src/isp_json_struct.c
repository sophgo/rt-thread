...
// -----------------------------------------------------------------------------
static void ISP_AE_ANTIFLICKER_FREQUENCE_E_JSON(int r_w_flag, JSON *j, char *key,
                                                ISP_AE_ANTIFLICKER_FREQUENCE_E *value)
{
    JSON *obj = 0;
...
// -----------------------------------------------------------------------------
static void ISP_ANTIFLICKER_MODE_E_JSON(int r_w_flag, JSON *j, char *key,
                                        ISP_ANTIFLICKER_MODE_E *value)
{
    JSON *obj = 0;
...
// -----------------------------------------------------------------------------
static void ISP_AE_IR_CUT_FORCE_STATUS_JSON(int r_w_flag, JSON *j, char *key,
                                            ISP_AE_IR_CUT_FORCE_STATUS *value)
{
    JSON *obj = 0;
...
// -----------------------------------------------------------------------------
static void ISP_AWB_MULTI_LS_TYPE_E_JSON(int r_w_flag, JSON *j, char *key,
                                         ISP_AWB_MULTI_LS_TYPE_E *value)
{
    JSON *obj = 0;
...
// -----------------------------------------------------------------------------
static void ISP_GAMMA_CURVE_TYPE_E_JSON(int r_w_flag, JSON *j, char *key,
                                        ISP_GAMMA_CURVE_TYPE_E *value)
{
    JSON *obj = 0;
...
// ISP structure - BLC
// -----------------------------------------------------------------------------
static void ISP_BLACK_LEVEL_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                               ISP_BLACK_LEVEL_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_BLACK_LEVEL_AUTO_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                             ISP_BLACK_LEVEL_AUTO_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// ISP structure - DP
// -----------------------------------------------------------------------------
static void ISP_DP_DYNAMIC_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                              ISP_DP_DYNAMIC_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_DP_DYNAMIC_AUTO_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                            ISP_DP_DYNAMIC_AUTO_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_CROSSTALK_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                             ISP_CROSSTALK_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_CROSSTALK_AUTO_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                           ISP_CROSSTALK_AUTO_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_NR_FILTER_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                             ISP_NR_FILTER_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_NR_FILTER_AUTO_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                           ISP_NR_FILTER_AUTO_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_DEMOSAIC_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                            ISP_DEMOSAIC_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_DEMOSAIC_AUTO_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                          ISP_DEMOSAIC_AUTO_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
void ISP_DEMOSAIC_DEMOIRE_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                      ISP_DEMOSAIC_DEMOIRE_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_RGBCAC_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                          ISP_RGBCAC_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_RGBCAC_AUTO_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                        ISP_RGBCAC_AUTO_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// ISP structure - LCAC
// -----------------------------------------------------------------------------
static void ISP_LCAC_GAUSS_COEF_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                            ISP_LCAC_GAUSS_COEF_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
static void ISP_LCAC_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                        ISP_LCAC_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// ISP structure - MLSC
// -----------------------------------------------------------------------------
static void ISP_MESH_SHADING_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                                ISP_MESH_SHADING_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_MESH_SHADING_AUTO_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                              ISP_MESH_SHADING_AUTO_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
int ISP_MESH_SHADING_GAIN_LUT_ATTR_S_GET_MAX_SIZE()
{
    ...
    attr_size +=
        GET_ARRAY_STRING_SIZE("LscGainLut", ISP_MLSC_COLOR_TEMPERATURE_SIZE, gain_lut_size);
...
void ISP_MESH_SHADING_GAIN_LUT_S_WRITE_JSON(ISP_MESH_SHADING_GAIN_LUT_S *plutAttr, char *json_str)
{
    ...
    snprintf(tmpstr, sizeof(tmpstr), "%c%s%c: %d, ", '"', "ColorTemperature", '"',
             plutAttr->ColorTemperature);
...
int ISP_MESH_SHADING_GAIN_LUT_ATTR_S_WRITE_JSON(ISP_MESH_SHADING_GAIN_LUT_ATTR_S *pAttr,
                                                char                             *json_str)
{
    char tmpstr[64] = {0};
...
void ISP_MESH_SHADING_GAIN_LUT_ATTR_S_READ_JSON(ISP_MESH_SHADING_GAIN_LUT_ATTR_S *pAttr,
                                                const char                       *json_str)
{
    ...
    if ((tmpStr = strstr(tmpStr, "LscGainLut"))) {
                                           ...
                                           ISP_MESH_SHADING_GAIN_LUT_ATTR_S *data)
{
    if (r_w_flag == R_FLAG) {
        ...
        if (cvi_json_object_is_type(obj, cvi_json_type_string)) {
            ...
            JSON_A(r_w_flag, ISP_MESH_SHADING_GAIN_LUT_S, LscGainLut,
...
// -----------------------------------------------------------------------------
static void ISP_SATURATION_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                              ISP_SATURATION_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_SATURATION_AUTO_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                            ISP_SATURATION_AUTO_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// ISP structure - CCM
// -----------------------------------------------------------------------------
static void ISP_COLORMATRIX_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                        ISP_COLORMATRIX_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_CCM_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                       ISP_CCM_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
void ISP_CCM_SATURATION_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                    ISP_CCM_SATURATION_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// ISP structure - FSWDR
// -----------------------------------------------------------------------------
static void ISP_FSWDR_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                         ISP_FSWDR_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_FSWDR_AUTO_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                       ISP_FSWDR_AUTO_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// ISP structure - DRC
// -----------------------------------------------------------------------------
static void ISP_DRC_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                       ISP_DRC_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_GAMMA_CURVE_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                        ISP_GAMMA_CURVE_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_DEHAZE_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                          ISP_DEHAZE_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_DEHAZE_AUTO_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                        ISP_DEHAZE_AUTO_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
int ISP_CLUT_ATTR_S_WRITE_JSON(ISP_CLUT_ATTR_S *pAttr, char *json_str)
{
    ...
    snprintf(tmpstr, sizeof(tmpstr), "%c%s%c: %d, ", '"', "UpdateInterval", '"',
             pAttr->UpdateInterval);
    strcat(json_str, tmpstr);
...
// -----------------------------------------------------------------------------
void ISP_CLUT_SATURATION_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                     ISP_CLUT_SATURATION_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
void ISP_VC_ATTR_S_JSON(int r_w_flag, JSON *j, char *key, ISP_VC_ATTR_S *data)
{
    ...
    JSON(r_w_flag, CVI_U8, UpdateInterval);
    JSON(r_w_flag, CVI_U8, MotionThreshold);
...
// ISP structure - DCI
// -----------------------------------------------------------------------------
static void ISP_DCI_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                       ISP_DCI_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// ISP structure - LDCI
// -----------------------------------------------------------------------------
static void ISP_LDCI_GAUSS_COEF_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                            ISP_LDCI_GAUSS_COEF_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
static void ISP_LDCI_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                        ISP_LDCI_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_PRESHARPEN_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                              ISP_PRESHARPEN_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_PRESHARPEN_AUTO_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                            ISP_PRESHARPEN_AUTO_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// ISP structure - TNR
// -----------------------------------------------------------------------------
static void ISP_TNR_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                       ISP_TNR_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
void ISP_TNR_NOISE_MODEL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                     ISP_TNR_NOISE_MODEL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
void ISP_TNR_LUMA_MOTION_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                     ISP_TNR_LUMA_MOTION_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_TNR_GHOST_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                             ISP_TNR_GHOST_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_TNR_GHOST_AUTO_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                           ISP_TNR_GHOST_AUTO_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_TNR_MT_PRT_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                              ISP_TNR_MT_PRT_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_TNR_MT_PRT_AUTO_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                            ISP_TNR_MT_PRT_AUTO_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
void ISP_TNR_MOTION_ADAPT_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                      ISP_TNR_MOTION_ADAPT_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// ISP structure - YNR
// -----------------------------------------------------------------------------
static void ISP_YNR_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                       ISP_YNR_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_YNR_FILTER_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                              ISP_YNR_FILTER_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_YNR_FILTER_AUTO_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                            ISP_YNR_FILTER_AUTO_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// ISP structure - CNR
// -----------------------------------------------------------------------------
static void ISP_CNR_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                       ISP_CNR_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// ISP structure - CAC
// -----------------------------------------------------------------------------
static void ISP_CAC_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                       ISP_CAC_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_SHARPEN_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                           ISP_SHARPEN_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_SHARPEN_AUTO_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                         ISP_SHARPEN_AUTO_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// ISP structure - CA2
// -----------------------------------------------------------------------------
static void ISP_CA2_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                       ISP_CA2_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_YCONTRAST_MANUAL_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                             ISP_YCONTRAST_MANUAL_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_YCONTRAST_AUTO_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                           ISP_YCONTRAST_AUTO_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// ISP structure - NP
// -----------------------------------------------------------------------------
void ISP_CMOS_NOISE_CALIBRATION_S_JSON(int r_w_flag, JSON *j, char *key,
                                       ISP_CMOS_NOISE_CALIBRATION_S *data)
{
    JSON_START(r_w_flag);
...
// ISP
// -----------------------------------------------------------------------------
void ISP_PARAMETER_BUFFER_JSON(int r_w_flag, JSON *j, char *key_word,
                               ISP_Parameter_Structures *data, int idx)
{
    char  key[64] = {0};
    JSON *obj     = NULL;
...
// -----------------------------------------------------------------------------
static void ISP_AE_ROUTE_EX_NODE_S_JSON(int r_w_flag, JSON *j, char *key,
                                        ISP_AE_ROUTE_EX_NODE_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
void ISP_SMART_EXPOSURE_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                    ISP_SMART_EXPOSURE_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_AE_STATISTICS_CFG_S_JSON(int r_w_flag, JSON *j, char *key,
                                         ISP_AE_STATISTICS_CFG_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_AWB_CT_LIMIT_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                         ISP_AWB_CT_LIMIT_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_AWB_CBCR_TRACK_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                           ISP_AWB_CBCR_TRACK_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_AWB_LUM_HISTGRAM_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                             ISP_AWB_LUM_HISTGRAM_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_AWB_IN_OUT_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                       ISP_AWB_IN_OUT_ATTR_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ST_ISP_AWB_GRASS_S_JSON(int r_w_flag, JSON *j, char *key,
                                    struct ST_ISP_AWB_GRASS_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ST_ISP_AWB_INTERFERENCE_S_JSON(int r_w_flag, JSON *j, char *key,
                                           struct ST_ISP_AWB_INTERFERENCE_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ST_ISP_AWB_REGION_S_JSON(int r_w_flag, JSON *j, char *key,
                                     struct ST_ISP_AWB_REGION_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ST_ISP_AWB_CT_WGT_S_JSON(int r_w_flag, JSON *j, char *key,
                                     struct ST_ISP_AWB_CT_WGT_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ST_ISP_AWB_SHIFT_LV_S_JSON(int r_w_flag, JSON *j, char *key,
                                       struct ST_ISP_AWB_SHIFT_LV_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_WB_STATISTICS_CFG_S_JSON(int r_w_flag, JSON *j, char *key,
                                         ISP_WB_STATISTICS_CFG_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
void ISP_AWB_Calibration_Gain_S_JSON(int r_w_flag, JSON *j, char *key,
                                     ISP_AWB_Calibration_Gain_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_AWB_Calibration_Gain_S_EX_JSON(int r_w_flag, JSON *j, char *key,
                                               ISP_AWB_Calibration_Gain_S_EX *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_AF_PRE_FILTER_CFG_S_JSON(int r_w_flag, JSON *j, char *key,
                                         ISP_AF_PRE_FILTER_CFG_S *data)
{
    JSON_START(r_w_flag);
...
// -----------------------------------------------------------------------------
static void ISP_FOCUS_STATISTICS_CFG_S_JSON(int r_w_flag, JSON *j, char *key,
                                            ISP_FOCUS_STATISTICS_CFG_S *data)
{
    JSON_START(r_w_flag);
...
// 3A structure
// -----------------------------------------------------------------------------
static void ISP_STATISTICS_CTRL_U_JSON(int r_w_flag, JSON *j, char *key,
                                       ISP_STATISTICS_CTRL_U *data)
{
    JSON_START(r_w_flag);
...
// 3A
// -----------------------------------------------------------------------------
void ISP_3A_PARAMETER_BUFFER_JSON(int r_w_flag, JSON *j, char *key_word,
                                  ISP_3A_Parameter_Structures *data, int idx)
{
    char  key[64] = {0};
    JSON *obj     = NULL;
