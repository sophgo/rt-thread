...
#define JSON_DEBUG_PRINT(title, json_info)                                             \
    {                                                                                  \
        ISP_DAEMON2_DEBUG_EX(                                                          \
            LOG_DEBUG, "%s:\n%s", title,                                               \
            ISPD2_json_object_to_json_string_ext(json_info, JSON_C_TO_STRING_SPACED)); \
    }
...
// -----------------------------------------------------------------------------
void CVI_ISPD2_Utils_ComposeMessage(TJSONRpcContentOut *ptContentOut, CVI_S32 s32StatusCode,
                                    const char *pszMessage);
void CVI_ISPD2_Utils_ComposeAPIErrorMessage(TJSONRpcContentOut *ptContentOut);
void CVI_ISPD2_Utils_ComposeAPIErrorMessageEX(TJSONRpcContentOut *ptContentOut,
                                              const char         *pszMessage);
...
CVI_S32 CVI_ISPD2_Utils_GetCurrentVPSSInfo(const TISPDeviceInfo *ptDevInfo, CVI_S32 *pVPSSGrp,
                                           CVI_S32 *pVPSSChn);
