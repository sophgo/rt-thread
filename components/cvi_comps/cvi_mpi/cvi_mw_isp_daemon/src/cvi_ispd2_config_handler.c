...
void CVI_ISPD2_ConfigMessageHandler(TISPD2HandlerInfo *ptHandlerInfo)
{
    ...
    CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_SetDemosaicDemoireAttr,
                          "CVI_ISP_SetDemosaicDemoireAttr");
    CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_GetDemosaicDemoireAttr,
    ...
    CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_SetMeshShadingGainLutAttr,
                          "CVI_ISP_SetMeshShadingGainLutAttr");
    CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_GetMeshShadingGainLutAttr,
    ...
    CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_SetCCMSaturationAttr,
                          "CVI_ISP_SetCCMSaturationAttr");
    CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_GetCCMSaturationAttr,
    ...
    CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_SetClutSaturationAttr,
                          "CVI_ISP_SetClutSaturationAttr");
    CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_GetClutSaturationAttr,
                          "CVI_ISP_GetClutSaturationAttr");
    ...
    CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_SetTNRNoiseModelAttr,
                          "CVI_ISP_SetTNRNoiseModelAttr");
    CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_GetTNRNoiseModelAttr,
                          "CVI_ISP_GetTNRNoiseModelAttr");
    CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_SetTNRLumaMotionAttr,
                          "CVI_ISP_SetTNRLumaMotionAttr");
    CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_GetTNRLumaMotionAttr,
                          "CVI_ISP_GetTNRLumaMotionAttr");
    ...
    CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_SetTNRMotionAdaptAttr,
                          "CVI_ISP_SetTNRMotionAdaptAttr");
    CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_GetTNRMotionAdaptAttr,
                          "CVI_ISP_GetTNRMotionAdaptAttr");
    ...
    CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_SetSmartExposureAttr,
                          "CVI_ISP_SetSmartExposureAttr");
    CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_ISP_GetSmartExposureAttr,
    ...
    // VI & VPSS
    CVI_ISPD2_REGISTER_CB(CVI_ISPD2_CBFunc_VI_VPSS_GetLDCChnSize, "CVI_VI_VPSS_GetChnLDCSize");
