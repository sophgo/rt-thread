...
void ISP_YNR_MOTION_NR_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                   ISP_YNR_MOTION_NR_ATTR_S *data);
void ISP_CNR_ATTR_S_JSON(int r_w_flag, JSON *j, char *key, ISP_CNR_ATTR_S *data);
void ISP_CNR_MOTION_NR_ATTR_S_JSON(int r_w_flag, JSON *j, char *key,
                                   ISP_CNR_MOTION_NR_ATTR_S *data);
