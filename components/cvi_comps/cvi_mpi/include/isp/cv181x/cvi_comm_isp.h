...
typedef struct _ISP_TNR_MANUAL_ATTR_S {
	...
	CVI_U8 MtFiltMode; /*RW; Range:[0x0, 0x1]*/
...
typedef struct _ISP_TNR_AUTO_ATTR_S {
	...
	CVI_U8 MtFiltMode[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x1]*/
...
typedef struct _ISP_TNR_LUMA_MOTION_MANUAL_ATTR_S {
	...
	CVI_U8 MtLumaMode; /*RW; Range:[0x0, 0x1]*/
...
typedef struct _ISP_TNR_LUMA_MOTION_AUTO_ATTR_S {
	...
	CVI_U8 MtLumaMode[ISP_AUTO_ISO_STRENGTH_NUM]; /*RW; Range:[0x0, 0x1]*/
