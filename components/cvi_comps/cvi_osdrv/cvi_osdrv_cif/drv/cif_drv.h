...
#define CNTP_CSI_MAC0_INT_ID (26)
#define CNTP_CSI_MAC1_INT_ID (27)
#define CNTP_CSI_MAC2_INT_ID (28)
...
#define SENSOR_MAC2_BASE (0x0A0C6000)

#define SENSOR_CSI0_BASE (0x0A0C2400)
#define SENSOR_CSI1_BASE (0x0A0C4400)
#define SENSOR_CSI2_BASE (0x0A0C6400)

// CAM_PLL
#define CLK_CAM0_SRC_DIV (0x030028C0)
#define CLK_CAM1_SRC_DIV (0x030028C4)
#define CLK_CAM2_SRC_DIV (0x030028C8)

#define CAMPLL_37P125M (0x00200001)
#define CAMPLL_27M (0x002c0001)
#define CAMPLL_25M (0x000c0301)
#define CAMPLL_24M (0x00210201)
...
#define SET_VIP_SYS_2_CLK_DIV(s, v)                                  \
    mmio_write_32(CV181X_SYS_CLOCK_BASE + REG_DIV_CLK_SRC_VIP_SYS_2, \
...
// phy reset
#define CV181X_SYS_RESET_BASE 0x03003000
#define CSI_PHY_REG_08 (CV181X_SYS_RESET_BASE + 0x8)
