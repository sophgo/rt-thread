...
#ifndef IVE_PRINTK_LEVEL
#define IVE_PRINTK_LEVEL 3
#endif

#define ive_printf(level, fmt, arg...) \
		do { \
			if (level < IVE_PRINTK_LEVEL) \
...
struct _IVE_IP_BLOCK_S {
	uintptr_t IVE_TOP; /* NULL if not initialized. */
	uintptr_t IMG_IN; /* NULL if not initialized. */
	uintptr_t RDMA_IMG1; /* NULL if not initialized. */
	uintptr_t MAP; /* NULL if not initialized. */
	uintptr_t HIST; /* NULL if not initialized. */
	uintptr_t HIST_WDMA; /* NULL if not initialized. */
	uintptr_t INTG; /* NULL if not initialized. */
	uintptr_t INTG_WDMA; /* NULL if not initialized. */
	uintptr_t SAD; /* NULL if not initialized. */
	uintptr_t SAD_WDMA; /* NULL if not initialized. */
	uintptr_t SAD_WDMA_THR; /* NULL if not initialized. */
	uintptr_t NCC; /* NULL if not initialized. */
	uintptr_t GMM_MODEL_RDMA_0; /* NULL if not initialized. */
	uintptr_t GMM_MODEL_RDMA_1; /* NULL if not initialized. */
	uintptr_t GMM_MODEL_RDMA_2; /* NULL if not initialized. */
	uintptr_t GMM_MODEL_RDMA_3; /* NULL if not initialized. */
	uintptr_t GMM_MODEL_RDMA_4; /* NULL if not initialized. */
	uintptr_t GMM_MODEL_WDMA_0; /* NULL if not initialized. */
	uintptr_t GMM_MODEL_WDMA_1; /* NULL if not initialized. */
	uintptr_t GMM_MODEL_WDMA_2; /* NULL if not initialized. */
	uintptr_t GMM_MODEL_WDMA_3; /* NULL if not initialized. */
	uintptr_t GMM_MODEL_WDMA_4; /* NULL if not initialized. */
	uintptr_t GMM_MATCH_WDMA; /* NULL if not initialized. */
	uintptr_t GMM; /* NULL if not initialized. */
	uintptr_t GMM_FACTOR_RDMA; /* NULL if not initialized. */
	uintptr_t BG_MATCH_FGFLAG_RDMA; /* NULL if not initialized. */
	uintptr_t BG_MATCH_BGMODEL_0_RDMA; /* NULL if not initialized. */
	uintptr_t BG_MATCH_BGMODEL_1_RDMA; /* NULL if not initialized. */
	uintptr_t BG_MATCH_DIFFFG_WDMA; /* NULL if not initialized. */
	uintptr_t BG_MATCH_IVE_MATCH_BG; /* NULL if not initialized. */
	uintptr_t BG_UPDATE_FG_WDMA; /* NULL if not initialized. */
	uintptr_t BG_UPDATE_BGMODEL_0_WDMA; /* NULL if not initialized. */
	uintptr_t BG_UPDATE_BGMODEL_1_WDMA; /* NULL if not initialized. */
	uintptr_t BG_UPDATE_CHG_WDMA; /* NULL if not initialized. */
	uintptr_t BG_UPDATE_UPDATE_BG; /* NULL if not initialized. */
	uintptr_t FILTEROP_RDMA; /* NULL if not initialized. */
	uintptr_t FILTEROP_WDMA_Y; /* NULL if not initialized. */
	uintptr_t FILTEROP_WDMA_C; /* NULL if not initialized. */
	uintptr_t FILTEROP; /* NULL if not initialized. */

	uintptr_t CCL; /* NULL if not initialized. */
	uintptr_t CCL_SRC_RDMA; /* NULL if not initialized. */
	uintptr_t CCL_DST_WDMA; /* NULL if not initialized. */
	uintptr_t CCL_REGION_WDMA; /* NULL if not initialized. */
	uintptr_t CCL_SRC_RDMA_RELABEL; /* NULL if not initialized. */
	uintptr_t CCL_DST_WDMA_RELABEL; /* NULL if not initialized. */

	uintptr_t DMAF; /* NULL if not initialized. */
	uintptr_t DMAF_WDMA; /* NULL if not initialized. */
	uintptr_t DMAF_RDMA; /* NULL if not initialized. */
	uintptr_t LK; /* NULL if not initialized. */
	uintptr_t RDMA_EIGVAL; /* NULL if not initialized. */
	uintptr_t WDMA; /* NULL if not initialized. */
	uintptr_t RDMA; /* NULL if not initialized. */
	uintptr_t CMDQ; /* NULL if not initialized. */
};
