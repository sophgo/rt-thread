 ...
 */
s32 gdc_begin_job(struct cvi_ldc_vdev    *wdev,
 ...
 * @return Error code (0 if successful)
 */
s32 gdc_cancel_job(struct cvi_ldc_vdev *wdev, u64 hHandle);
...
s32 gdc_set_buf_wrap(struct cvi_ldc_vdev *wdev, const struct ldc_buf_wrap_cfg *cfg);
