...
#if 0//def CVI_H26X_USE_ION_MEM
int vdi_allocate_ion_memory(unsigned long core_idx, vpu_buffer_t *vb, int is_cached, const char *str);
...
int vdi_wait_interrupt(unsigned long core_idx, int timeout, uint64_t *pu64TimeStamp);
