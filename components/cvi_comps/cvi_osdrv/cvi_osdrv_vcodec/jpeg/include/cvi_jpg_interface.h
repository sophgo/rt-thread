...
// #define REENCODE_JPEG_SUPERFRAME
...
typedef enum _CVI_JPEG_OP_ {
	...
	CVI_JPEG_OP_START = (6 << CVI_JPEG_OP_SHIFT),
	CVI_JPEG_OP_SET_SBM_ENABLE = (7 << CVI_JPEG_OP_SHIFT),
	CVI_JPEG_OP_SET_RC_PARAM = (8 << CVI_JPEG_OP_SHIFT),
	CVI_JPEG_OP_SHOW_CHN_INFO = (9 << CVI_JPEG_OP_SHIFT),
