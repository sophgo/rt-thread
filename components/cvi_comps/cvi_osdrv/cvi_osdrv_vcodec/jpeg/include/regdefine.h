...
#define MJPEG_PIC_START_REG (NPT_BASE + 0x000)
		// [3] - start partial encoding  [2] - pic stop
		// en/decoding[1] - pic init en/decoding [0] - pic
		// start en/decoding
#define MJPEG_PIC_STATUS_REG (NPT_BASE + 0x004)
		// [8] - stop [7:4] - partial buffer interrupt [3] -
		// overflow, [2] - bbc interrupt, [1] - error, [0] -
		// done
#define MJPEG_PIC_ERRMB_REG (NPT_BASE + 0x008)
		// [27:24] - error restart idx, [23:12] - error MCU
		// pos X, [11:0] - error MCU pos Y
#define MJPEG_PIC_SETMB_REG (NPT_BASE + 0x00C)
		// [27:16] - MCU pos X, [11:0] - MCU pos Y

#define MJPEG_PIC_CTRL_REG (NPT_BASE + 0x010)
		// [12:7] huffman table index [6] - user huffman en,
		// [4] - TC direction, [3] - encoder enable, [1:0] -
		// operation mode
...
#define MJPEG_IF_INFO_REG (NPT_BASE + 0x024)
		// [1] - sensor interface clear, [0] - display
		// interface clear
#define MJPEG_CLP_INFO_REG (NPT_BASE + 0x028)
#define MJPEG_OP_INFO_REG (NPT_BASE + 0x02C)
		// [31:16] - # of line in 1 partial buffer, [5:3] - #
		// of partial buffers [2:0] - # of request
...
#define MJPEG_GBU_CTRL_REG (NPT_BASE + 0x100)
		// [3] - GBU flush for encoding  [2] - init GBU for
		// decoding [1] - init GBU ff emulation for decoding
		// [0] - reserved
...
#define MJPEG_BBC_STRM_CTRL_REG (NPT_BASE + 0x234)
		// [31] - end of bitstream file  [23:0] - stream
		// counter
