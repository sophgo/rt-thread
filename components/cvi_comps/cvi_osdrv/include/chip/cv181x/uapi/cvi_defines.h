...
#define IS_CHIP_CV182X(x) (((x) == E_CHIPID_CV1820) || ((x) == E_CHIPID_CV1821) || ((x) == E_CHIPID_CV1822) || ((x) == E_CHIPID_CV1823) || ((x) == E_CHIPID_CV1825) || ((x) == E_CHIPID_CV1826))

#define IS_CHIP_CV181X(x) (((x) == E_CHIPID_CV1820A) || ((x) == E_CHIPID_CV1821A) || ((x) == E_CHIPID_CV1822A) || ((x) == E_CHIPID_CV1823A) || ((x) == E_CHIPID_CV1825A) || ((x) == E_CHIPID_CV1826A) || ((x) == E_CHIPID_CV1810C) || ((x) == E_CHIPID_CV1811C) || ((x) == E_CHIPID_CV1812C) || ((x) == E_CHIPID_CV1810H) || ((x) == E_CHIPID_CV1811H) || ((x) == E_CHIPID_CV1812H) || ((x) == E_CHIPID_CV1813H))

#define IS_CHIP_CV180X(x) (((x) == E_CHIPID_CV1800B) || ((x) == E_CHIPID_CV1801B) || ((x) == E_CHIPID_CV1800C) || ((x) == E_CHIPID_CV1801C))

#define IS_CHIP_PKG_TYPE_QFN(x) (((x) == E_CHIPID_CV1820A) || ((x) == E_CHIPID_CV1821A) || ((x) == E_CHIPID_CV1822A) || ((x) == E_CHIPID_CV1810C) || ((x) == E_CHIPID_CV1811C) || ((x) == E_CHIPID_CV1812C) || ((x) == E_CHIPID_CV1800B) || ((x) == E_CHIPID_CV1801B) || ((x) == E_CHIPID_CV1800C) || ((x) == E_CHIPID_CV1801C))
