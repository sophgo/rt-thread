...
int gc2053_read_register(VI_PIPE ViPipe, int addr)
{
    ...
    return sensor_i2c_read(i2c_id, gc2053_i2c_addr, (CVI_U32)addr, gc2053_addr_byte,
                           gc2053_data_byte);
}
...
int gc2053_write_register(VI_PIPE ViPipe, int addr, int data)
{
    ...
    return sensor_i2c_write(i2c_id, gc2053_i2c_addr, (CVI_U32)addr, gc2053_addr_byte, (CVI_U32)data,
                            gc2053_data_byte);
}
...
int gc2053_probe(VI_PIPE ViPipe)
{
    ...
    usleep(50);
    if (gc2053_i2c_init(ViPipe) != CVI_SUCCESS) return CVI_FAILURE;
