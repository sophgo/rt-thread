...
#include "sc035hgs_1L_cmos_param.h"
#include "cvi_comm_cif.h"

#define DIV_0_TO_1(a)   ((0 == (a)) ? 1 : (a))
#define DIV_0_TO_1_FLOAT(a) ((((a) < 1E-10) && ((a) > -1E-10)) ? 1 : (a))
#define SC035HGS_1L_ID 35
/****************************************************************************
 * global variables                                                            *
 ****************************************************************************/

ISP_SNS_STATE_S *g_pastSC035HGS_1L[VI_MAX_PIPE_NUM] = {CVI_NULL};

#define SC035HGS_1L_SENSOR_GET_CTX(dev, pstCtx)   (pstCtx = g_pastSC035HGS_1L[dev])
#define SC035HGS_1L_SENSOR_SET_CTX(dev, pstCtx)   (g_pastSC035HGS_1L[dev] = pstCtx)
#define SC035HGS_1L_SENSOR_RESET_CTX(dev)         (g_pastSC035HGS_1L[dev] = CVI_NULL)
#define SC035HGS_1L_I2C_ADDR_1 0x30
#define SC035HGS_1L_I2C_ADDR_2 0x31
#define SC035HGS_1L_I2C_ADDR_3 0x32
#define SC035HGS_1L_I2C_ADDR_4 0x33
#define SC035HGS_1L_I2C_ADDR_IS_VALID(addr)	((addr) == SC035HGS_1L_I2C_ADDR_1 || \
											 (addr) == SC035HGS_1L_I2C_ADDR_2 || \
											 (addr) == SC035HGS_1L_I2C_ADDR_3 || \
											 (addr) == SC035HGS_1L_I2C_ADDR_4)

ISP_SNS_COMMBUS_U g_aunSC035HGS_1L_BusInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cDev = 2},
	[1 ... VI_MAX_PIPE_NUM - 1] = { .s8I2cDev = -1}
};

CVI_U16 g_au16SC035HGS_1L_GainMode[VI_MAX_PIPE_NUM] = {0};
CVI_U16 g_au16SC035HGS_1L_L2SMode[VI_MAX_PIPE_NUM] = {0};

ISP_SNS_MIRRORFLIP_TYPE_E g_aeSc035hgs_MirrorFip[VI_MAX_PIPE_NUM] = {0};
...
#define SC035HGS_1L_FULL_LINES_MAX  (0xFFFF)

/*****SC035HGS_1L Register Address*****/
#define SC035HGS_1L_EXP_H_ADDR                     (0x3e01)
#define SC035HGS_1L_EXP_L_ADDR                     (0x3e02)

#define SC035HGS_1L_AGAIN_H_ADDR                   (0x3e08)
#define SC035HGS_1L_AGAIN_L_ADDR                   (0x3e09)

#define SC035HGS_1L_DGAIN_H_ADDR                   (0x3e06)
#define SC035HGS_1L_DGAIN_L_ADDR                   (0x3e07)

#define SC035HGS_1L_VMAX_H_ADDR                    (0x320e)
#define SC035HGS_1L_VMAX_L_ADDR                    (0x320f)

#define SC035HGS_1L_GAIN_MAGIC_0_ADDR              (0x3314)
#define SC035HGS_1L_GAIN_MAGIC_1_ADDR              (0x3317)
#define SC035HGS_1L_GAIN_MAGIC_2_ADDR              (0x3631)
#define SC035HGS_1L_GAIN_MAGIC_3_ADDR              (0x3630)

#define SC035HGS_1L_RES_IS_480P(w, h)      ((w) <= 640 && (h) <= 480)

static CVI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	const SC035HGS_1L_MODE_S *pstMode;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;

	CMOS_CHECK_POINTER(pstAeSnsDft);
	SC035HGS_1L_SENSOR_GET_CTX(ViPipe, pstSnsState);
	CMOS_CHECK_POINTER(pstSnsState);

	pstMode = &g_astSC035HGS_1L_mode[pstSnsState->u8ImgMode];
#if 0
	memset(&pstAeSnsDft->stAERouteAttr, 0, sizeof(ISP_AE_ROUTE_S));
#endif
	pstAeSnsDft->u32FullLinesStd = pstSnsState->u32FLStd;
	pstAeSnsDft->u32FlickerFreq = 50 * 256;
	pstAeSnsDft->u32FullLinesMax = SC035HGS_1L_FULL_LINES_MAX;
...
static CVI_S32 cmos_fps_set(VI_PIPE ViPipe, CVI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	u32Vts = g_astSC035HGS_1L_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	f32MaxFps = g_astSC035HGS_1L_mode[pstSnsState->u8ImgMode].f32MaxFps;
	f32MinFps = g_astSC035HGS_1L_mode[pstSnsState->u8ImgMode].f32MinFps;

	switch (pstSnsState->u8ImgMode) {
	case SC035HGS_1L_MODE_640X480P120:
		...
		u32VMAX = (u32VMAX > SC035HGS_1L_FULL_LINES_MAX) ? SC035HGS_1L_FULL_LINES_MAX : u32VMAX;
		break;
	default:
...
static CVI_S32 cmos_get_wdr_size(VI_PIPE ViPipe, ISP_SNS_ISP_INFO_S *pstIspCfg)
{
	const SC035HGS_1L_MODE_S *pstMode = CVI_NULL;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
...
static CVI_S32 cmos_set_wdr_mode(VI_PIPE ViPipe, CVI_U8 u8Mode)
{
	...
	switch (u8Mode) {
	case WDR_MODE_NONE:
		pstSnsState->u8ImgMode = SC035HGS_1L_MODE_640X480P120;
		pstSnsState->enWDRMode = WDR_MODE_NONE;
		pstSnsState->u32FLStd = g_astSC035HGS_1L_mode[pstSnsState->u8ImgMode].u32VtsDef;
...
static CVI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_SYNC_INFO_S *pstSnsSyncInfo)
{
	...
	if ((pstSnsState->bSyncInit == CVI_FALSE) || (pstSnsRegsInfo->bConfig == CVI_FALSE)) {
		...
		pstCfg0->snsCfg.unComBus.s8I2cDev = g_aunSC035HGS_1L_BusInfo[ViPipe].s8I2cDev;
		...
		for (i = 0; i < pstCfg0->snsCfg.u32RegNum; i++) {
			...
			pstI2c_data[i].u8DevAddr = sc035hgs_1L_i2c_addr;
			pstI2c_data[i].u32AddrByteNum = sc035hgs_1L_addr_byte;
			pstI2c_data[i].u32DataByteNum = sc035hgs_1L_data_byte;
		}

		switch (pstSnsState->enWDRMode) {
		case WDR_MODE_NONE:
			//Linear Mode Regs
			pstI2c_data[LINEAR_EXP_H_ADDR].u32RegAddr = SC035HGS_1L_EXP_H_ADDR;
			pstI2c_data[LINEAR_EXP_L_ADDR].u32RegAddr = SC035HGS_1L_EXP_L_ADDR;
			pstI2c_data[LINEAR_AGAIN_H_ADDR].u32RegAddr = SC035HGS_1L_AGAIN_H_ADDR;
			pstI2c_data[LINEAR_AGAIN_H_ADDR].u8DelayFrmNum = 1;
			pstI2c_data[LINEAR_AGAIN_L_ADDR].u32RegAddr = SC035HGS_1L_AGAIN_L_ADDR;
			pstI2c_data[LINEAR_AGAIN_L_ADDR].u8DelayFrmNum = 1;
			pstI2c_data[LINEAR_DGAIN_H_ADDR].u32RegAddr = SC035HGS_1L_DGAIN_H_ADDR;
			pstI2c_data[LINEAR_DGAIN_H_ADDR].u8DelayFrmNum = 1;
			pstI2c_data[LINEAR_DGAIN_L_ADDR].u32RegAddr = SC035HGS_1L_DGAIN_L_ADDR;
			pstI2c_data[LINEAR_DGAIN_L_ADDR].u8DelayFrmNum = 1;
			pstI2c_data[LINEAR_VMAX_H_ADDR].u32RegAddr = SC035HGS_1L_VMAX_H_ADDR;
			pstI2c_data[LINEAR_VMAX_L_ADDR].u32RegAddr = SC035HGS_1L_VMAX_L_ADDR;
			pstI2c_data[LINEAR_GAIN_MAGIC_0_ADDR].bUpdate = CVI_FALSE;
			pstI2c_data[LINEAR_GAIN_MAGIC_0_ADDR].u32RegAddr = SC035HGS_1L_GAIN_MAGIC_0_ADDR;
			pstI2c_data[LINEAR_GAIN_MAGIC_1_ADDR].bUpdate = CVI_FALSE;
			pstI2c_data[LINEAR_GAIN_MAGIC_1_ADDR].u32RegAddr = SC035HGS_1L_GAIN_MAGIC_1_ADDR;
			pstI2c_data[LINEAR_GAIN_MAGIC_2_ADDR].bUpdate = CVI_FALSE;
			pstI2c_data[LINEAR_GAIN_MAGIC_2_ADDR].u32RegAddr = SC035HGS_1L_GAIN_MAGIC_2_ADDR;
			pstI2c_data[LINEAR_GAIN_MAGIC_3_ADDR].bUpdate = CVI_FALSE;
			pstI2c_data[LINEAR_GAIN_MAGIC_3_ADDR].u32RegAddr = SC035HGS_1L_GAIN_MAGIC_3_ADDR;
			break;
		default:
			CVI_TRACE_SNS(CVI_DBG_ERR, "Not support WDR: %d\n", pstSnsState->enWDRMode);
			return CVI_FAILURE;
...
static CVI_S32 cmos_set_image_mode(VI_PIPE ViPipe, ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
	...
	if (pstSensorImageMode->f32Fps <= 120) {
		if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
			if (SC035HGS_1L_RES_IS_480P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
				u8SensorImageMode = SC035HGS_1L_MODE_640X480P120;
			} else {
...
static CVI_VOID sensor_mirror_flip(VI_PIPE ViPipe, ISP_SNS_MIRRORFLIP_TYPE_E eSnsMirrorFlip)
{
	...
	if (pstSnsState->bInit == CVI_TRUE && g_aeSc035hgs_MirrorFip[ViPipe] != eSnsMirrorFlip) {
		sc035hgs_1L_mirror_flip(ViPipe, eSnsMirrorFlip);
		g_aeSc035hgs_MirrorFip[ViPipe] = eSnsMirrorFlip;
	}
}
...
static CVI_S32 sensor_rx_attr(VI_PIPE ViPipe, SNS_COMBO_DEV_ATTR_S *pstRxAttr)
{
	...
	memcpy(pstRxAttr, &sc035hgs_1L_rx_attr, sizeof(*pstRxAttr));

	pstRxAttr->img_size.width = g_astSC035HGS_1L_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Width;
	pstRxAttr->img_size.height = g_astSC035HGS_1L_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Height;
	if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
...
{
	SNS_COMBO_DEV_ATTR_S *pstRxAttr = &sc035hgs_1L_rx_attr;
	int i;
...
static CVI_S32 cmos_init_sensor_exp_function(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc)
{
	...
	pstSensorExpFunc->pfn_cmos_sensor_init = sc035hgs_1L_init;
	pstSensorExpFunc->pfn_cmos_sensor_exit = sc035hgs_1L_exit;
...
{
	if (SC035HGS_1L_I2C_ADDR_IS_VALID(s32I2cAddr))
		sc035hgs_1L_i2c_addr = s32I2cAddr;
}

static CVI_S32 sc035hgs_1L_set_bus_info(VI_PIPE ViPipe, ISP_SNS_COMMBUS_U unSNSBusInfo)
{
	g_aunSC035HGS_1L_BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static CVI_S32 sensor_ctx_init(VI_PIPE ViPipe)
{
	...
	SC035HGS_1L_SENSOR_SET_CTX(ViPipe, pastSnsStateCtx);
...
static CVI_VOID sensor_ctx_exit(VI_PIPE ViPipe)
{
	...
	SC035HGS_1L_SENSOR_RESET_CTX(ViPipe);
}
...
static CVI_S32 sensor_register_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	stSnsAttrInfo.eSensorId = SC035HGS_1L_ID;
...
static CVI_S32 sensor_unregister_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	s32Ret = CVI_ISP_SensorUnRegCallBack(ViPipe, SC035HGS_1L_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AE_SensorUnRegCallBack(ViPipe, pstAeLib, SC035HGS_1L_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function to ae lib failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AWB_SensorUnRegCallBack(ViPipe, pstAwbLib, SC035HGS_1L_ID);
	if (s32Ret != CVI_SUCCESS) {
...
static CVI_S32 sensor_set_init(VI_PIPE ViPipe, ISP_INIT_ATTR_S *pstInitAttr)
{
	...
	g_au16SC035HGS_1L_GainMode[ViPipe] = pstInitAttr->enGainMode;
	g_au16SC035HGS_1L_L2SMode[ViPipe] = pstInitAttr->enL2SMode;

	return CVI_SUCCESS;
}

ISP_SNS_OBJ_S stSnsSC035HGS_1L_Obj = {
	.pfnRegisterCallback    = sensor_register_callback,
	.pfnUnRegisterCallback  = sensor_unregister_callback,
	.pfnStandby             = sc035hgs_1L_standby,
	.pfnRestart             = sc035hgs_1L_restart,
	.pfnMirrorFlip          = sensor_mirror_flip,
	.pfnWriteReg            = sc035hgs_1L_write_register,
	.pfnReadReg             = sc035hgs_1L_read_register,
	.pfnSetBusInfo          = sc035hgs_1L_set_bus_info,
