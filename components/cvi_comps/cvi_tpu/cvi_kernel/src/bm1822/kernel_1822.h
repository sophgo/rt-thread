...
static inline void assert_same_shape_3(const tl_t *a, const tl_t *b, const tl_t *c)
{
    assert_same_shape(a, b);
    assert_same_shape(a, c);
}

static inline void assert_same_shape_4(const tl_t *a, const tl_t *b, const tl_t *c, const tl_t *d)
{
    assert_same_shape_3(a, b, c);
    assert_same_shape(a, d);
}

static inline void assert_same_shape_5(const tl_t *t0, const tl_t *t1, const tl_t *t2,
                                       const tl_t *t3, const tl_t *t4)
{
    assert_same_shape_3(t0, t1, t2);
    assert_same_shape_3(t0, t3, t4);
}

static inline void assert_same_shape_6(const tl_t *t0, const tl_t *t1, const tl_t *t2,
                                       const tl_t *t3, const tl_t *t4, const tl_t *t5)
{
...
static inline void check_tiu_tensor_2(const tl_t *t0, const tl_t *t1)
{
    check_tiu_tensor(t0);
    check_tiu_tensor(t1);
}

static inline void check_tiu_tensor_3(const tl_t *t0, const tl_t *t1, const tl_t *t2)
{
    check_tiu_tensor(t0);
    check_tiu_tensor_2(t1, t2);
}

static inline void check_tiu_tensor_4(const tl_t *t0, const tl_t *t1, const tl_t *t2,
                                      const tl_t *t3)
{
...
static inline void check_tiu_tensor_5(const tl_t *t0, const tl_t *t1, const tl_t *t2,
                                      const tl_t *t3, const tl_t *t4)
{
    check_tiu_tensor_3(t0, t1, t2);
...
static inline void check_tiu_tensor_6(const tl_t *t0, const tl_t *t1, const tl_t *t2,
                                      const tl_t *t3, const tl_t *t4, const tl_t *t5)
{
    check_tiu_tensor_3(t0, t1, t2);
