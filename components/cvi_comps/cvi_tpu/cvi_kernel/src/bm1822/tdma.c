...
static void check_tdma_vlc_matrix_compressed_mg(const bmk1822_compressed_matrix_tgmem_t *t)
{
    ASSERT(t);
...
{
    desc_pair_t *dp = bm1822_get_desc_pair(ctx, BMK1822_TDMA);
    ...
    const bmk1822_tdma_l2l_tensor_lrn_shift_param_t *p)
{
    ...
    ASSERT(p->src->shape.h * p->src->shape.w == p->dst->shape.h * p->dst->shape.w);
    ...
    else
    {
        ...
        uint32_t offset =
            (p->dst->start_address % ctx->chip_info.lmem_size) + ((start_mem + (p->dst->shape.c - p->lrn_step)) / ctx->chip_info.npu_num) * p->dst->stride.c;
...
static bmk1822_op_t *tdma_l2tg_tensor_copy(
    ctx_t                                       *ctx,
...
static bmk1822_op_t *tdma_l2tg_bf16_tensor_copy(
    ctx_t                                       *ctx,
    const bmk1822_tdma_l2tg_tensor_copy_param_t *p,
    uint64_t                                     dst_addr)
{
...
static bmk1822_op_t *tdma_l2tg_tensor_copy_nc_transposed(
    ctx_t                                                     *ctx,
    ...
    uint64_t                                                   dst_addr)
{
    ...
    ASSERT(p->dst->shape.h * p->dst->shape.w == p->src->shape.h * p->src->shape.w);
...
static bmk1822_op_t *tdma_l2tg_bf16_tensor_copy_nc_transposed(
    ctx_t                                                     *ctx,
    const bmk1822_tdma_l2tg_tensor_copy_nc_transposed_param_t *p,
    uint64_t                                                   dst_addr)
{
...
static bmk1822_op_t *tdma_l2tg_tensor_copy_cw_transposed(
    ctx_t                                                     *ctx,
...
static bmk1822_op_t *tdma_l2tg_bf16_tensor_copy_cw_transposed(
    ctx_t                                                     *ctx,
    const bmk1822_tdma_l2tg_tensor_copy_cw_transposed_param_t *p,
    uint64_t                                                   dst_addr)
{
...
static bmk1822_op_t *tdma_l2tg_tensor_copy_compressed(
    ctx_t                                                  *ctx,
...
static bmk1822_op_t *tdma_l2tg_tensor_fill_constant(
    ctx_t                                                *ctx,
...
static bmk1822_op_t *tdma_l2tg_matrix_copy(
    ctx_t                                       *ctx,
...
static bmk1822_op_t *tdma_l2tg_matrix_copy_compressed(
    ctx_t                                                  *ctx,
...
static bmk1822_op_t *tdma_l2tg_bf16_matrix_copy(
    ctx_t                                       *ctx,
    const bmk1822_tdma_l2tg_matrix_copy_param_t *p,
    uint64_t                                     dst_addr)
{
...
static bmk1822_op_t *tdma_l2tg_general_copy(
    ctx_t                                        *ctx,
...
static bmk1822_op_t *tdma_l2tg_bf16_general_copy(
    ctx_t                                             *ctx,
...
static bmk1822_op_t *tdma_tg2l_tensor_copy(
    ctx_t                                       *ctx,
...
static bmk1822_op_t *tdma_tg2l_bf16_tensor_copy(
    ctx_t                                       *ctx,
    const bmk1822_tdma_tg2l_tensor_copy_param_t *p,
    uint64_t                                     src_addr)
{
...
static bmk1822_op_t *tdma_tg2l_tensor_copy_nc_transposed(
    ctx_t                                                     *ctx,
...
static bmk1822_op_t *tdma_tg2l_bf16_tensor_copy_nc_transposed(
    ctx_t                                                     *ctx,
    const bmk1822_tdma_tg2l_tensor_copy_nc_transposed_param_t *p,
    uint64_t                                                   src_addr)
{
...
static bmk1822_op_t *tdma_tg2l_tensor_copy_chw_rotated(
    ctx_t                                                   *ctx,
...
static bmk1822_op_t *tdma_tg2l_tensor_copy_decompressed(
    ctx_t                                                    *ctx,
...
static bmk1822_op_t *tdma_tg2l_tensor_fill_constant(
    ctx_t                                                *ctx,
...
static bmk1822_op_t *tdma_tg2l_bf16_tensor_fill_constant(
    ctx_t                                                *ctx,
    const bmk1822_tdma_tg2l_tensor_fill_constant_param_t *p)
{
    check_tdma_tl_bf16(p->dst);
...
static bmk1822_op_t *tdma_tg2l_matrix_copy(
    ctx_t                                       *ctx,
...
static bmk1822_op_t *tdma_tg2l_matrix_copy_decompressed(
    ctx_t                                                    *ctx,
...
static bmk1822_op_t *tdma_tg2l_bf16_matrix_copy(
    ctx_t                                       *ctx,
    const bmk1822_tdma_tg2l_matrix_copy_param_t *p,
    uint64_t                                     src_addr)
{
...
static bmk1822_op_t *tdma_tg2l_matrix_copy_row_col_transposed(
    ctx_t                                                          *ctx,
    ...
    uint64_t                                                        src_addr)
{
    ...
    ASSERT(p->dst->shape.c == (uint32_t)ceiling_func(p->src->shape.row, p->dst->shape.w));
...
static bmk1822_op_t *tdma_tg2l_general_copy(
    ctx_t                                        *ctx,
...
static bmk1822_op_t *tdma_tg2l_bf16_general_copy(
    ctx_t                                             *ctx,
 ...
 * Direction: TG2TG
 */
static bmk1822_op_t *bmk1822_gdma_copy_gmem(
...
static bmk1822_op_t *bmk1822_gdma_bf16_copy_gmem(
    bmk1822_context_t                            *ctx,
    const bmk1822_tdma_tg2tg_tensor_copy_param_t *p,
    uint8_t                                       u8_trans_fmt)
{
...
bmk1822_op_t *bmk1822_tdma_tg2tg_tensor_copy(
    ...
    const bmk1822_tdma_tg2tg_tensor_copy_param_t *p)
{
    bmk1822_gdma_copy_gmem(ctx, p, 2);
    return NULL;
}
...
bmk1822_op_t *bmk1822_tdma_tg2tg_bf16_tensor_copy(
    ...
    const bmk1822_tdma_tg2tg_tensor_copy_param_t *p)
{
    bmk1822_gdma_bf16_copy_gmem(ctx, p, 2);
    return NULL;
}
...
bmk1822_op_t *bmk1822_tdma_tg2tg_general_copy(
    ...
    const bmk1822_tdma_tg2tg_tensor_copy_param_t *p)
{
    bmk1822_gdma_copy_gmem(ctx, p, 1);
    return NULL;
}
...
bmk1822_op_t *bmk1822_tdma_tg2tg_bf16_general_copy(
    ...
    const bmk1822_tdma_tg2tg_tensor_copy_param_t *p)
{
    bmk1822_gdma_bf16_copy_gmem(ctx, p, 1);
    return NULL;
}
