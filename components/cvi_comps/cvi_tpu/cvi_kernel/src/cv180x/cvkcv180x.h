...
void            cvkcv180x_set_layer_id(struct cvikernel_context *ctx, uint16_t layer_id);
cvk_tl_t       *cvkcv180x_lmem_alloc_tensor(struct cvikernel_context *ctx, cvk_tl_shape_t shape,
                                            cvk_fmt_t fmt, int eu_align);
cvk_ml_t       *cvkcv180x_lmem_alloc_matrix(struct cvikernel_context *ctx, cvk_ml_shape_t shape,
                                            cvk_fmt_t fmt, int eu_align);
cvk_ml_t       *cvkcv180x_lmem_alloc_ps32_matrix(struct cvikernel_context *ctx, cvk_ml_shape_t shape,
                                                 cvk_fmt_t fmt, int eu_align);
void            cvkcv180x_lmem_free_tensor(struct cvikernel_context *ctx, const cvk_tl_t *tl);
void            cvkcv180x_lmem_free_matrix(struct cvikernel_context *ctx, const cvk_ml_t *ml);
void            cvkcv180x_lmem_init_tensor(struct cvikernel_context *ctx, cvk_tl_t *tl, cvk_tl_shape_t shape,
                                           cvk_fmt_t fmt, int eu_align);
void            cvkcv180x_lmem_init_matrix(struct cvikernel_context *ctx, cvk_ml_t *ml, cvk_ml_shape_t shape,
                                           cvk_fmt_t fmt, int eu_align);
cvk_tl_stride_t cvkcv180x_tl_default_stride(struct cvikernel_context *ctx, cvk_tl_shape_t shape,
                                            cvk_fmt_t fmt, int eu_align);
cvk_tg_stride_t cvkcv180x_tg_default_stride(struct cvikernel_context *ctx, cvk_tg_shape_t shape,
                                            cvk_fmt_t fmt);
cvk_ml_shape_t  cvkcv180x_ml_default_shape(struct cvikernel_context *ctx, uint32_t row, uint32_t col,
                                           cvk_fmt_t fmt);
cvk_ml_stride_t cvkcv180x_ml_default_stride(struct cvikernel_context *ctx, cvk_ml_shape_t shape,
                                            cvk_fmt_t fmt, int eu_align);
cvk_ml_shape_t  cvkcv180x_ml_shape_t1(struct cvikernel_context *ctx, uint32_t len, cvk_fmt_t fmt);
uint32_t        cvkcv180x_lmem_tensor_to_size(struct cvikernel_context *ctx, cvk_tl_shape_t shape,
                                              cvk_fmt_t fmt, int eu_align);
uint32_t        cvkcv180x_lmem_matrix_to_size(struct cvikernel_context *ctx, cvk_ml_shape_t shape,
                                              cvk_fmt_t fmt, int eu_align);
uint32_t        cvkcv180x_lmem_ps32_matrix_to_size(struct cvikernel_context *ctx, cvk_ml_shape_t shape,
                                                   cvk_fmt_t fmt, int eu_align);
void            cvkcv180x_gmem_init_tensor(struct cvikernel_context *ctx, cvk_tg_t *tg, cvk_tg_shape_t shape,
                                           cvk_fmt_t fmt);

/* Local to Local DMA API */
void cvkcv180x_tdma_l2l_tensor_copy(struct cvikernel_context               *ctx,
                                    const cvk_tdma_l2l_tensor_copy_param_t *param);
void cvkcv180x_tdma_l2l_bf16_tensor_copy(struct cvikernel_context               *ctx,
                                         const cvk_tdma_l2l_tensor_copy_param_t *param);
void cvkcv180x_tdma_l2l_tensor_lrn_shift(struct cvikernel_context                    *ctx,
                                         const cvk_tdma_l2l_tensor_lrn_shift_param_t *param);

/* Local to Global DMA API */
void cvkcv180x_tdma_l2g_tensor_copy(struct cvikernel_context               *ctx,
                                    const cvk_tdma_l2g_tensor_copy_param_t *param);
void cvkcv180x_tdma_l2g_bf16_tensor_copy(struct cvikernel_context               *ctx,
                                         const cvk_tdma_l2g_tensor_copy_param_t *param);
...
void cvkcv180x_tdma_l2g_bf16_tensor_copy_cw_transposed(
    struct cvikernel_context *ctx, const cvk_tdma_l2g_tensor_copy_cw_transposed_param_t *param);
void cvkcv180x_tdma_l2g_matrix_copy(struct cvikernel_context               *ctx,
                                    const cvk_tdma_l2g_matrix_copy_param_t *param);
void cvkcv180x_tdma_l2g_bf16_matrix_copy(struct cvikernel_context               *ctx,
                                         const cvk_tdma_l2g_matrix_copy_param_t *param);
void cvkcv180x_tdma_l2g_general_copy(struct cvikernel_context                *ctx,
                                     const cvk_tdma_l2g_general_copy_param_t *param);
void cvkcv180x_tdma_l2g_bf16_general_copy(struct cvikernel_context                     *ctx,
                                          const cvk_tdma_l2g_bf16_general_copy_param_t *param);

/* Global to Local DMA API */
void cvkcv180x_tdma_g2l_tensor_copy(struct cvikernel_context               *ctx,
                                    const cvk_tdma_g2l_tensor_copy_param_t *param);
void cvkcv180x_tdma_g2l_bf16_tensor_copy(struct cvikernel_context               *ctx,
                                         const cvk_tdma_g2l_tensor_copy_param_t *param);
...
void cvkcv180x_tdma_g2l_matrix_copy(struct cvikernel_context               *ctx,
                                    const cvk_tdma_g2l_matrix_copy_param_t *param);
void cvkcv180x_tdma_g2l_bf16_matrix_copy(struct cvikernel_context               *ctx,
                                         const cvk_tdma_g2l_matrix_copy_param_t *param);
...
void cvkcv180x_tdma_g2l_general_copy(struct cvikernel_context                *ctx,
                                     const cvk_tdma_g2l_general_copy_param_t *param);
void cvkcv180x_tdma_g2l_bf16_general_copy(struct cvikernel_context                     *ctx,
                                          const cvk_tdma_g2l_bf16_general_copy_param_t *param);

/* Global to Global DMA API */
void cvkcv180x_tdma_g2g_tensor_copy(struct cvikernel_context               *ctx,
                                    const cvk_tdma_g2g_tensor_copy_param_t *param);
void cvkcv180x_tdma_g2g_general_copy(struct cvikernel_context               *ctx,
                                     const cvk_tdma_g2g_tensor_copy_param_t *param);
void cvkcv180x_tdma_g2g_bf16_general_copy(struct cvikernel_context               *ctx,
                                          const cvk_tdma_g2g_tensor_copy_param_t *param);
void cvkcv180x_tdma_g2g_bf16_tensor_copy(struct cvikernel_context               *ctx,
                                         const cvk_tdma_g2g_tensor_copy_param_t *param);

/* TIU API */
void cvkcv180x_tiu_mul(struct cvikernel_context *ctx, const cvk_tiu_mul_param_t *param);
void cvkcv180x_tiu_mul_qm(struct cvikernel_context *ctx, const cvk_tiu_mul_qm_param_t *param);
void cvkcv180x_tiu_mac(struct cvikernel_context *ctx, const cvk_tiu_mac_param_t *param);
void cvkcv180x_tiu_add(struct cvikernel_context *ctx, const cvk_tiu_add_param_t *param);
void cvkcv180x_tiu_sub(struct cvikernel_context *ctx, const cvk_tiu_sub_param_t *param);
void cvkcv180x_tiu_max(struct cvikernel_context *ctx, const cvk_tiu_max_param_t *param);
void cvkcv180x_tiu_min(struct cvikernel_context *ctx, const cvk_tiu_min_param_t *param);
void cvkcv180x_tiu_and_int8(struct cvikernel_context *ctx, const cvk_tiu_and_int8_param_t *param);
void cvkcv180x_tiu_arith_shift(struct cvikernel_context          *ctx,
                               const cvk_tiu_arith_shift_param_t *param);
void cvkcv180x_tiu_and_int16(struct cvikernel_context *ctx, const cvk_tiu_and_int16_param_t *param);
void cvkcv180x_tiu_or_int8(struct cvikernel_context *ctx, const cvk_tiu_or_int8_param_t *param);
void cvkcv180x_tiu_or_int16(struct cvikernel_context *ctx, const cvk_tiu_or_int16_param_t *param);
void cvkcv180x_tiu_xor_int8(struct cvikernel_context *ctx, const cvk_tiu_xor_int8_param_t *param);
void cvkcv180x_tiu_xor_int16(struct cvikernel_context *ctx, const cvk_tiu_xor_int16_param_t *param);
void cvkcv180x_tiu_copy(struct cvikernel_context *ctx, const cvk_tiu_copy_param_t *param);
void cvkcv180x_tiu_lookup_table(struct cvikernel_context           *ctx,
                                const cvk_tiu_lookup_table_param_t *param);
void cvkcv180x_tiu_bf16_lookup_interp_table(struct cvikernel_context                       *ctx,
                                            const cvk_tiu_bf16_lookup_interp_table_param_t *param);
void cvkcv180x_tiu_pt_convolution(struct cvikernel_context             *ctx,
                                  const cvk_tiu_pt_convolution_param_t *param);
void cvkcv180x_tiu_convolution(struct cvikernel_context          *ctx,
                               const cvk_tiu_convolution_param_t *param);
void cvkcv180x_tiu_max_pooling(struct cvikernel_context          *ctx,
                               const cvk_tiu_max_pooling_param_t *param);
void cvkcv180x_tiu_average_pooling(struct cvikernel_context              *ctx,
                                   const cvk_tiu_average_pooling_param_t *param);
void cvkcv180x_tiu_pt_depthwise_convolution(struct cvikernel_context                       *ctx,
                                            const cvk_tiu_depthwise_pt_convolution_param_t *param);
void cvkcv180x_tiu_depthwise_convolution(struct cvikernel_context                    *ctx,
                                         const cvk_tiu_depthwise_convolution_param_t *param);
void cvkcv180x_tiu_matrix_multiplication(struct cvikernel_context                    *ctx,
                                         const cvk_tiu_matrix_multiplication_param_t *param);
void cvkcv180x_tiu_matrix_multiplication_qm(struct cvikernel_context                       *ctx,
                                            const cvk_tiu_matrix_multiplication_qm_param_t *param);
void cvkcv180x_tiu_ge(cvk_context_t *ctx, const cvk_tiu_ge_param_t *p);
void cvkcv180x_tiu_min_pooling(cvk_context_t *ctx, const cvk_tiu_min_pooling_param_t *p);
