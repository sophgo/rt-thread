...
static ec_desc_t *emit_tdma_cmdbuf(cvk_context_t *ctx, tdma_reg_t *reg)
{
    ...
    desc_pair_t    *dp       = cvkcv180x_get_desc_pair(ctx, CV180X_TDMA);
    ...
    const cvk_tdma_l2l_tensor_copy_param_t *p)
{
    ...
    if (status)
    {
        printf("cvkcv180x l2l: wrong parameter\n");
        return;
    }
    ...
    const cvk_tdma_l2l_tensor_copy_param_t *p)
{
    ...
    if (status)
    {
        printf("cvkcv180x l2l bf16: wrong parameter\n");
        return;
    }
    ...
    const cvk_tdma_l2l_tensor_lrn_shift_param_t *p)
{
    ...
    CHECK(status, p->src->shape.h * p->src->shape.w == p->dst->shape.h * p->dst->shape.w);
    ...
    else
    {
        ...
        uint32_t offset =
            (p->dst->start_address % ctx->info.lmem_size) + ((start_mem + (p->dst->shape.c - p->lrn_step)) / ctx->info.npu_num) * p->dst->stride.c;
    ...
    if (status)
    {
        printf("cvkcv180x tdma l2l lrn shift: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                dst_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x l2g: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                dst_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x l2g bf16: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                              dst_addr)
{
    ...
    CHECK(status, p->dst->shape.h * p->dst->shape.w == p->src->shape.h * p->src->shape.w);
    ...
    if (status)
    {
        printf("cvcv180x l2g nc tp: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                              dst_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x: l2g bf16 nc tp: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                              dst_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x l2g cw tp: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                              dst_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x l2g bf16 cw tp: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                           dst_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x: l2g cmpr: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                         dst_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x l2g fill const: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                dst_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x l2g matrix: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                           dst_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x l2g matrix cmpr: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                dst_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x l2g bf16 matrix: wrong paramter\n");
        return;
    }
    ...
    uint64_t                                 dst_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x l2g general: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                      dst_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x l2g bf16 general: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                src_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x g2l: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                src_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x g2l bf16: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                              src_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x g2l nc tp: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                              src_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x g2l bf16 nc tp: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                            src_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x g2l chw: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                             src_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x g2l cmpr: wrong parameter\n");
        return;
    }
    ...
    const cvk_tdma_g2l_tensor_fill_constant_param_t *p)
{
    ...
    if (status)
    {
        printf("cvkcv180x g2l fill const: wrong parameter\n");
        return;
    }
    ...
    const cvk_tdma_g2l_tensor_fill_constant_param_t *p)
{
    ...
    if (status)
    {
        printf("cvkcv180x g2l bf16 fill const: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                src_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x g2l matrix: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                             src_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x g2l matrix cmpr: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                src_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x g2l bf16 matrix: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                                   src_addr)
{
    ...
    CHECK(status, p->dst->shape.c == (uint32_t)ceiling_func(p->src->shape.row, p->dst->shape.w));
    ...
    if (status)
    {
        printf("cvkcv180x g2l matrix tp: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                 src_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x g2l general: wrong parameter\n");
        return;
    }
    ...
    uint64_t                                      src_addr)
{
    ...
    if (status)
    {
        printf("cvkcv180x g2l bf16 general: wrong parameter\n");
        return;
    }
 ...
 * Direction: TG2TG
 */
static void cvkcv180x_tdma_copy_gmem(
    cvk_context_t                          *ctx,
...
static void cvkcv180x_tdma_bf16_copy_gmem(
    cvk_context_t                          *ctx,
    const cvk_tdma_g2g_tensor_copy_param_t *p,
    uint8_t                                 u8_trans_fmt)
{
    ...
    if (status)
    {
        printf("cvkcv180x bf16 gmem: wrong parameter\n");
        return;
    }
...
void cvkcv180x_tdma_g2g_tensor_copy(
    ...
    const cvk_tdma_g2g_tensor_copy_param_t *p)
{
    cvkcv180x_tdma_copy_gmem(ctx, p, 2);
}
...
void cvkcv180x_tdma_g2g_bf16_tensor_copy(
    ...
    const cvk_tdma_g2g_tensor_copy_param_t *p)
{
    cvkcv180x_tdma_bf16_copy_gmem(ctx, p, 2);
}
...
void cvkcv180x_tdma_g2g_general_copy(
    ...
    const cvk_tdma_g2g_tensor_copy_param_t *p)
{
    cvkcv180x_tdma_copy_gmem(ctx, p, 1);
}
...
void cvkcv180x_tdma_g2g_bf16_general_copy(
    ...
    const cvk_tdma_g2g_tensor_copy_param_t *p)
{
    cvkcv180x_tdma_bf16_copy_gmem(ctx, p, 1);
}
