...
void cvkcv181x_tiu_or_int8(
    cvk_context_t                 *ctx,
    const cvk_tiu_or_int8_param_t *p)
{
    int8_t status = 0;
    ...
    if (status)
    {
        printf("cvkcv181x tiu or: wrong parameter\n");
        return;
    }
...
void cvkcv181x_tiu_or_int16(
    cvk_context_t                  *ctx,
    const cvk_tiu_or_int16_param_t *p)
{
    int8_t status  = 0;
