...
{
    static const MajorVersion values[] = {MajorVersion_value};
    return values;
}

inline const char * const *EnumNamesMajorVersion()
{
    static const char * const names[2] = {"value", nullptr};
    return names;
}
...
{
    static const MinorVersion values[] = {MinorVersion_value};
    return values;
}
...
{
    static const SubMinorVersion values[] = {SubMinorVersion_value};
    return values;
}
...
{
    static const DType values[] = {DType_FP32, DType_INT32, DType_UINT32, DType_BF16,
...
{
    static const char * const names[9] = {"FP32", "INT32", "UINT32", "BF16", "INT16",
                                          "UINT16", "INT8", "UINT8", nullptr};
    return names;
}
...
{
    static const QuantType values[] = {QuantType_NONE, QuantType_BF16, QuantType_INT8_SYM,
                                       QuantType_INT8_ASYM};
    return values;
}
...
{
    static const char * const names[5] = {"NONE", "BF16", "INT8_SYM", "INT8_ASYM", nullptr};
    return names;
}
...
{
    static const RoutineType values[] = {RoutineType_TPU, RoutineType_CPU};
    return values;
}

inline const char * const *EnumNamesRoutineType()
{
    static const char * const names[3] = {"TPU", "CPU", nullptr};
    return names;
}
...
{
    static const SectionType values[] = {SectionType_WEIGHT, SectionType_CMDBUF,
...
{
    static const char * const names[6] = {"WEIGHT", "CMDBUF", "FUNC_X86",
                                          "FUNC_AARCH64", "DMABUF", nullptr};
    return names;
}
...
struct Shape FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    {
        return VerifyTableStart(verifier) && VerifyOffsetRequired(verifier, VT_DIM) && verifier.VerifyVector(dim()) && verifier.EndTable();
    }
};
...
inline flatbuffers::Offset<Shape> CreateShape(
    flatbuffers::FlatBufferBuilder &_fbb, flatbuffers::Offset<flatbuffers::Vector<int64_t>> dim = 0)
{
...
inline flatbuffers::Offset<Shape> CreateShapeDirect(flatbuffers::FlatBufferBuilder &_fbb,
                                                    const std::vector<int64_t>     *dim = nullptr)
{
    auto dim__ = dim ? _fbb.CreateVector<int64_t>(*dim) : 0;
    return cvi::model::CreateShape(_fbb, dim__);
}
...
struct QuantInfo FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<uint8_t>(verifier, VT_TYPE) && VerifyField<float>(verifier, VT_MAX_VALUE) && VerifyField<float>(verifier, VT_MIN_VALUE) && VerifyField<float>(verifier, VT_ZERO_POINT) && VerifyField<float>(verifier, VT_QSCALE) && verifier.EndTable();
    }
};
...
inline flatbuffers::Offset<QuantInfo> CreateQuantInfo(
    flatbuffers::FlatBufferBuilder &_fbb, cvi::model::QuantType type = cvi::model::QuantType_NONE,
    float max_value = 0.0f, float min_value = 0.0f, float zero_point = 0.0f, float qscale = 0.0f)
{
...
struct Tensor FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<uint32_t>(verifier, VT_TENSOR_ID) && VerifyOffsetRequired(verifier, VT_NAME) && verifier.VerifyString(name()) && VerifyField<int64_t>(verifier, VT_OFFSET) && VerifyField<uint8_t>(verifier, VT_DTYPE) && VerifyOffsetRequired(verifier, VT_SHAPE) && verifier.VerifyTable(shape()) && VerifyOffset(verifier, VT_STRIDE) && verifier.VerifyTable(stride()) && VerifyOffset(verifier, VT_QUANT) && verifier.VerifyTable(quant()) && VerifyField<uint8_t>(verifier, VT_OVERWROTE) && VerifyOffset(verifier, VT_SCALE) && verifier.VerifyVector(scale()) && VerifyOffset(verifier, VT_MEAN) && verifier.VerifyVector(mean()) && VerifyOffset(verifier, VT_PIXEL_FORMAT) && verifier.VerifyString(pixel_format()) && VerifyField<uint8_t>(verifier, VT_ALIGNED) && VerifyField<uint32_t>(verifier, VT_SIZE) && verifier.EndTable();
    }
};
...
inline flatbuffers::Offset<Tensor> CreateTensor(
    flatbuffers::FlatBufferBuilder &_fbb, uint32_t tensor_id = 0,
    flatbuffers::Offset<flatbuffers::String> name = 0, int64_t offset = 0,
    ...
    flatbuffers::Offset<cvi::model::QuantInfo> quant = 0, bool overwrote = false,
    flatbuffers::Offset<flatbuffers::Vector<float>> scale = 0,
    flatbuffers::Offset<flatbuffers::Vector<float>> mean  = 0,
    flatbuffers::Offset<flatbuffers::String> pixel_format = 0, bool aligned = false,
    uint32_t size = 0)
{
...
inline flatbuffers::Offset<Tensor> CreateTensorDirect(
    flatbuffers::FlatBufferBuilder &_fbb, uint32_t tensor_id = 0, const char *name = nullptr,
    int64_t offset = 0, cvi::model::DType dtype = cvi::model::DType_FP32,
    flatbuffers::Offset<cvi::model::Shape>     shape  = 0,
    flatbuffers::Offset<cvi::model::Shape>     stride = 0,
    flatbuffers::Offset<cvi::model::QuantInfo> quant = 0, bool overwrote = false,
    const std::vector<float> *scale = nullptr, const std::vector<float> *mean = nullptr,
    const char *pixel_format = nullptr, bool aligned = false, uint32_t size = 0)
{
    ...
    return cvi::model::CreateTensor(_fbb, tensor_id, name__, offset, dtype, shape, stride, quant,
                                    overwrote, scale__, mean__, pixel_format__, aligned, size);
}
...
struct Weight FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_NAME) && verifier.VerifyString(name()) && VerifyField<int64_t>(verifier, VT_OFFSET) && VerifyField<uint32_t>(verifier, VT_SIZE) && VerifyOffset(verifier, VT_SHAPE) && verifier.VerifyTable(shape()) && VerifyField<uint8_t>(verifier, VT_TYPE) && verifier.EndTable();
    }
};
...
inline flatbuffers::Offset<Weight> CreateWeight(flatbuffers::FlatBufferBuilder          &_fbb,
                                                flatbuffers::Offset<flatbuffers::String> name = 0,
                                                int64_t offset = 0, uint32_t size = 0,
                                                flatbuffers::Offset<cvi::model::Shape> shape = 0,
...
inline flatbuffers::Offset<Weight> CreateWeightDirect(
    flatbuffers::FlatBufferBuilder &_fbb, const char *name = nullptr, int64_t offset = 0,
    uint32_t size = 0, flatbuffers::Offset<cvi::model::Shape> shape = 0,
    cvi::model::DType type = cvi::model::DType_FP32)
{
    auto name__ = name ? _fbb.CreateString(name) : 0;
    return cvi::model::CreateWeight(_fbb, name__, offset, size, shape, type);
}
...
struct PreProcessHints FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_COLOR) && verifier.VerifyString(color()) && VerifyField<float>(verifier, VT_RAW_SCALE) && VerifyOffset(verifier, VT_MEAN) && verifier.VerifyString(mean()) && VerifyOffset(verifier, VT_STD) && verifier.VerifyString(std()) && VerifyField<float>(verifier, VT_INPUT_SCALE) && VerifyOffset(verifier, VT_DATA_FORMAT) && verifier.VerifyString(data_format()) && verifier.EndTable();
    }
};
...
inline flatbuffers::Offset<PreProcessHints> CreatePreProcessHints(
    flatbuffers::FlatBufferBuilder &_fbb, flatbuffers::Offset<flatbuffers::String> color = 0,
    float raw_scale = 0.0f, flatbuffers::Offset<flatbuffers::String> mean = 0,
    flatbuffers::Offset<flatbuffers::String> std = 0, float input_scale = 0.0f,
...
inline flatbuffers::Offset<PreProcessHints> CreatePreProcessHintsDirect(
    flatbuffers::FlatBufferBuilder &_fbb, const char *color = nullptr, float raw_scale = 0.0f,
    const char *mean = nullptr, const char *std = nullptr, float input_scale = 0.0f,
    const char *data_format = nullptr)
{
    ...
    return cvi::model::CreatePreProcessHints(_fbb, color__, raw_scale, mean__, std__, input_scale,
                                             data_format__);
}
...
struct PostProcessHints FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<uint8_t>(verifier, VT_DONE_SOFTMAX) && verifier.EndTable();
    }
};
...
struct PostProcessHintsBuilder
{
    ...
    {
        fbb_.AddElement<uint8_t>(PostProcessHints::VT_DONE_SOFTMAX,
                                 static_cast<uint8_t>(done_softmax), 0);
    }
...
inline flatbuffers::Offset<PostProcessHints> CreatePostProcessHints(
    flatbuffers::FlatBufferBuilder &_fbb, bool done_softmax = false)
{
...
struct TpuRoutine FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_CMDBUF_SECTION) && verifier.VerifyString(cmdbuf_section()) && VerifyOffset(verifier, VT_DMABUF_SECTION) && verifier.VerifyString(dmabuf_section()) && verifier.EndTable();
    }
};
...
inline flatbuffers::Offset<TpuRoutine> CreateTpuRoutineDirect(flatbuffers::FlatBufferBuilder &_fbb,
                                                              ...
                                                              const char                     *dmabuf_section = nullptr)
{
    ...
    return cvi::model::CreateTpuRoutine(_fbb, cmdbuf_section__, dmabuf_section__);
}
...
struct CpuRoutine FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyOffsetRequired(verifier, VT_FUNCTION_SECTION) && verifier.VerifyString(function_section()) && VerifyOffsetRequired(verifier, VT_FUNCTION_ARGS) && verifier.VerifyVector(function_args()) && verifier.EndTable();
    }
};
...
inline flatbuffers::Offset<CpuRoutine> CreateCpuRoutineDirect(
    flatbuffers::FlatBufferBuilder &_fbb, const char *function_section = nullptr,
    const std::vector<uint8_t> *function_args = nullptr)
{
    ...
    return cvi::model::CreateCpuRoutine(_fbb, function_section__, function_args__);
}
...
struct Routine FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<uint8_t>(verifier, VT_TYPE) && VerifyOffset(verifier, VT_IN_TENSORS) && verifier.VerifyVector(in_tensors()) && verifier.VerifyVectorOfStrings(in_tensors()) && VerifyOffset(verifier, VT_OUT_TENSORS) && verifier.VerifyVector(out_tensors()) && verifier.VerifyVectorOfStrings(out_tensors()) && VerifyOffset(verifier, VT_TPU_ROUTINE) && verifier.VerifyTable(tpu_routine()) && VerifyOffset(verifier, VT_CPU_ROUTINE) && verifier.VerifyTable(cpu_routine()) && verifier.EndTable();
    }
};
...
inline flatbuffers::Offset<Routine> CreateRoutine(
    ...
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>>> in_tensors =
        0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>>> out_tensors =
        0,
...
{
    auto in_tensors__ =
        in_tensors ? _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>>(*in_tensors) : 0;
    auto out_tensors__ =
        out_tensors ? _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>>(*out_tensors) : 0;
    return cvi::model::CreateRoutine(_fbb, type, in_tensors__, out_tensors__, tpu_routine,
                                     cpu_routine);
}
...
struct Program FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<cvi::model::Tensor>> *>(
            VT_TENSOR_MAP);
    }
    const flatbuffers::Vector<flatbuffers::Offset<cvi::model::Routine>> *routines() const
    {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<cvi::model::Routine>> *>(
            VT_ROUTINES);
    }
    ...
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<uint32_t>(verifier, VT_BATCH_NUM) && VerifyField<uint32_t>(verifier, VT_NEURON_SIZE) && VerifyOffsetRequired(verifier, VT_INPUT_TENSORS) && verifier.VerifyVector(input_tensors()) && verifier.VerifyVectorOfStrings(input_tensors()) && VerifyOffsetRequired(verifier, VT_OUTPUT_TENSORS) && verifier.VerifyVector(output_tensors()) && verifier.VerifyVectorOfStrings(output_tensors()) && VerifyOffsetRequired(verifier, VT_TENSOR_MAP) && verifier.VerifyVector(tensor_map()) && verifier.VerifyVectorOfTables(tensor_map()) && VerifyOffsetRequired(verifier, VT_ROUTINES) && verifier.VerifyVector(routines()) && verifier.VerifyVectorOfTables(routines()) && VerifyField<uint32_t>(verifier, VT_SHARED_GMEM) && VerifyField<uint32_t>(verifier, VT_PRIVATE_GMEM) && verifier.EndTable();
    }
};
...
struct ProgramBuilder
{
    ...
    void add_routines(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<cvi::model::Routine>>> routines)
    {
...
inline flatbuffers::Offset<Program> CreateProgram(
    flatbuffers::FlatBufferBuilder &_fbb, uint32_t batch_num = 0, uint32_t neuron_size = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>>>
        input_tensors = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>>>
                                                                                      output_tensors = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<cvi::model::Tensor>>> tensor_map =
        0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<cvi::model::Routine>>> routines = 0,
    uint32_t shared_gmem = 0, uint32_t private_gmem = 0)
{
...
inline flatbuffers::Offset<Program> CreateProgramDirect(
    ...
    uint32_t shared_gmem = 0, uint32_t private_gmem = 0)
{
    auto input_tensors__ =
        input_tensors ? _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>>(*input_tensors)
                      : 0;
    auto output_tensors__ =
        output_tensors
            ? _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>>(*output_tensors)
            : 0;
    auto tensor_map__ =
        tensor_map ? _fbb.CreateVector<flatbuffers::Offset<cvi::model::Tensor>>(*tensor_map) : 0;
    auto routines__ =
        routines ? _fbb.CreateVector<flatbuffers::Offset<cvi::model::Routine>>(*routines) : 0;
    return cvi::model::CreateProgram(_fbb, batch_num, neuron_size, input_tensors__,
                                     output_tensors__, tensor_map__, routines__, shared_gmem,
                                     private_gmem);
}
...
struct Section FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<uint8_t>(verifier, VT_TYPE) && VerifyOffsetRequired(verifier, VT_NAME) && verifier.VerifyString(name()) && VerifyField<uint32_t>(verifier, VT_SIZE) && VerifyField<uint32_t>(verifier, VT_OFFSET) && VerifyField<uint8_t>(verifier, VT_ENCRYPT) && VerifyField<uint8_t>(verifier, VT_COMPRESS) && VerifyField<uint32_t>(verifier, VT_DECOMPRESSED_SIZE) && verifier.EndTable();
    }
};
...
inline flatbuffers::Offset<Section> CreateSection(
    ...
    flatbuffers::Offset<flatbuffers::String> name = 0, uint32_t size = 0, uint32_t offset = 0,
    bool encrypt = false, bool compress = false, uint32_t decompressed_size = 0)
{
...
inline flatbuffers::Offset<Section> CreateSectionDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    cvi::model::SectionType type = cvi::model::SectionType_WEIGHT, const char *name = nullptr,
    uint32_t size = 0, uint32_t offset = 0, bool encrypt = false, bool compress = false,
    uint32_t decompressed_size = 0)
{
    auto name__ = name ? _fbb.CreateString(name) : 0;
    return cvi::model::CreateSection(_fbb, type, name__, size, offset, encrypt, compress,
                                     decompressed_size);
}
...
struct Model FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<cvi::model::Weight>> *>(
            VT_WEIGHT_MAP);
    }
    const flatbuffers::Vector<flatbuffers::Offset<cvi::model::Program>> *programs() const
    {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<cvi::model::Program>> *>(
            VT_PROGRAMS);
    }
    const flatbuffers::Vector<flatbuffers::Offset<cvi::model::Section>> *sections() const
    {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<cvi::model::Section>> *>(
            VT_SECTIONS);
    }
    ...
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyFieldRequired<cvi::model::Version>(verifier, VT_VERSION) && VerifyOffsetRequired(verifier, VT_NAME) && verifier.VerifyString(name()) && VerifyOffset(verifier, VT_BUILD_TIME) && verifier.VerifyString(build_time()) && VerifyOffset(verifier, VT_PREPROCESS_HINTS) && verifier.VerifyTable(preprocess_hints()) && VerifyOffset(verifier, VT_POSTPROCESS_HINTS) && verifier.VerifyTable(postprocess_hints()) && VerifyOffset(verifier, VT_WEIGHT_MAP) && verifier.VerifyVector(weight_map()) && verifier.VerifyVectorOfTables(weight_map()) && VerifyOffsetRequired(verifier, VT_PROGRAMS) && verifier.VerifyVector(programs()) && verifier.VerifyVectorOfTables(programs()) && VerifyOffsetRequired(verifier, VT_SECTIONS) && verifier.VerifyVector(sections()) && verifier.VerifyVectorOfTables(sections()) && VerifyOffset(verifier, VT_TARGET) && verifier.VerifyString(target()) && VerifyOffset(verifier, VT_MLIR_VERSION) && verifier.VerifyString(mlir_version()) && verifier.EndTable();
    }
};
...
struct ModelBuilder
{
    ...
    void add_programs(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<cvi::model::Program>>> programs)
    {
        fbb_.AddOffset(Model::VT_PROGRAMS, programs);
    }
    void add_sections(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<cvi::model::Section>>> sections)
    {
...
inline flatbuffers::Offset<Model> CreateModel(
    flatbuffers::FlatBufferBuilder &_fbb, const cvi::model::Version *version = 0,
    flatbuffers::Offset<flatbuffers::String>                                          name              = 0,
    ...
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<cvi::model::Weight>>> weight_map =
        0,
...
inline flatbuffers::Offset<Model> CreateModelDirect(
    flatbuffers::FlatBufferBuilder &_fbb, const cvi::model::Version *version = 0,
    const char *name = nullptr, const char *build_time = nullptr,
    flatbuffers::Offset<cvi::model::PreProcessHints>             preprocess_hints  = 0,
    flatbuffers::Offset<cvi::model::PostProcessHints>            postprocess_hints = 0,
    ...
    const char *target = nullptr, const char *mlir_version = nullptr)
{
    auto name__       = name ? _fbb.CreateString(name) : 0;
    auto build_time__ = build_time ? _fbb.CreateString(build_time) : 0;
    auto weight_map__ =
        weight_map ? _fbb.CreateVector<flatbuffers::Offset<cvi::model::Weight>>(*weight_map) : 0;
    auto programs__ =
        programs ? _fbb.CreateVector<flatbuffers::Offset<cvi::model::Program>>(*programs) : 0;
    auto sections__ =
        sections ? _fbb.CreateVector<flatbuffers::Offset<cvi::model::Section>>(*sections) : 0;
    auto target__       = target ? _fbb.CreateString(target) : 0;
    auto mlir_version__ = mlir_version ? _fbb.CreateString(mlir_version) : 0;
    return cvi::model::CreateModel(_fbb, version, name__, build_time__, preprocess_hints,
                                   postprocess_hints, weight_map__, programs__, sections__,
                                   target__, mlir_version__);
}
