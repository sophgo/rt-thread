...
struct IntAttr FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_KEY) && verifier.VerifyString(key()) && VerifyField<int32_t>(verifier, VT_VALUE) && verifier.EndTable();
    }
};
...
inline flatbuffers::Offset<IntAttr> CreateIntAttr(flatbuffers::FlatBufferBuilder          &_fbb,
...
inline flatbuffers::Offset<IntAttr> CreateIntAttrDirect(flatbuffers::FlatBufferBuilder &_fbb,
                                                        const char                     *key   = nullptr,
                                                        int32_t                         value = 0)
{
    auto key__ = key ? _fbb.CreateString(key) : 0;
    return cvi::cpu_op::CreateIntAttr(_fbb, key__, value);
}
...
struct FloatAttr FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_KEY) && verifier.VerifyString(key()) && VerifyField<float>(verifier, VT_VALUE) && verifier.EndTable();
    }
};
...
inline flatbuffers::Offset<FloatAttr> CreateFloatAttrDirect(flatbuffers::FlatBufferBuilder &_fbb,
                                                            const char                     *key   = nullptr,
                                                            float                           value = 0.0f)
{
    auto key__ = key ? _fbb.CreateString(key) : 0;
    return cvi::cpu_op::CreateFloatAttr(_fbb, key__, value);
}
...
struct BoolAttr FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_KEY) && verifier.VerifyString(key()) && VerifyField<uint8_t>(verifier, VT_VALUE) && verifier.EndTable();
    }
};
...
inline flatbuffers::Offset<BoolAttr> CreateBoolAttrDirect(flatbuffers::FlatBufferBuilder &_fbb,
                                                          const char                     *key   = nullptr,
                                                          bool                            value = false)
{
    auto key__ = key ? _fbb.CreateString(key) : 0;
    return cvi::cpu_op::CreateBoolAttr(_fbb, key__, value);
}
...
struct StrAttr FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_KEY) && verifier.VerifyString(key()) && VerifyOffset(verifier, VT_VALUE) && verifier.VerifyString(value()) && verifier.EndTable();
    }
};
...
inline flatbuffers::Offset<StrAttr> CreateStrAttrDirect(flatbuffers::FlatBufferBuilder &_fbb,
                                                        const char                     *key   = nullptr,
                                                        const char                     *value = nullptr)
{
    auto key__   = key ? _fbb.CreateString(key) : 0;
    auto value__ = value ? _fbb.CreateString(value) : 0;
    return cvi::cpu_op::CreateStrAttr(_fbb, key__, value__);
}
...
struct IntArrayAttr FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_KEY) && verifier.VerifyString(key()) && VerifyOffset(verifier, VT_VALUE) && verifier.VerifyVector(value()) && verifier.EndTable();
    }
};
    ...
    const std::vector<int32_t> *value = nullptr)
{
    ...
    return cvi::cpu_op::CreateIntArrayAttr(_fbb, key__, value__);
}
    ...
    const std::vector<float> *value = nullptr)
{
    ...
    return cvi::cpu_op::CreateFloatArrayAttr(_fbb, key__, value__);
}
...
struct Attribute FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_FLOAT_ATTR) && verifier.VerifyTable(float_attr()) && VerifyOffset(verifier, VT_BOOL_ATTR) && verifier.VerifyTable(bool_attr()) && VerifyOffset(verifier, VT_INT_ATTR) && verifier.VerifyTable(int_attr()) && VerifyOffset(verifier, VT_STR_ATTR) && verifier.VerifyTable(str_attr()) && VerifyOffset(verifier, VT_FLOAT_ARRAY_ATTR) && verifier.VerifyTable(float_array_attr()) && VerifyOffset(verifier, VT_INT_ARRAY_ATTR) && verifier.VerifyTable(int_array_attr()) && verifier.EndTable();
    }
};
...
struct Parameter FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<cvi::cpu_op::Attribute>> *>(
            VT_ATTRIBUTES);
    }
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_ATTRIBUTES) && verifier.VerifyVector(attributes()) && verifier.VerifyVectorOfTables(attributes()) && verifier.EndTable();
    }
};
...
struct ParameterBuilder
{
    ...
    flatbuffers::uoffset_t          start_;
    void                            add_attributes(
                                   flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<cvi::cpu_op::Attribute>>>
                                       attributes)
    {
...
{
    auto attributes__ =
        attributes ? _fbb.CreateVector<flatbuffers::Offset<cvi::cpu_op::Attribute>>(*attributes)
                   : 0;
    return cvi::cpu_op::CreateParameter(_fbb, attributes__);
}
...
inline bool VerifyParameterBuffer(flatbuffers::Verifier &verifier)
{
    return verifier.VerifyBuffer<cvi::cpu_op::Parameter>(nullptr);
}

inline bool VerifySizePrefixedParameterBuffer(flatbuffers::Verifier &verifier)
{
    return verifier.VerifySizePrefixedBuffer<cvi::cpu_op::Parameter>(nullptr);
}

inline void FinishParameterBuffer(flatbuffers::FlatBufferBuilder             &fbb,
                                  flatbuffers::Offset<cvi::cpu_op::Parameter> root)
{
    fbb.Finish(root);
}

inline void FinishSizePrefixedParameterBuffer(flatbuffers::FlatBufferBuilder             &fbb,
                                              flatbuffers::Offset<cvi::cpu_op::Parameter> root)
{
