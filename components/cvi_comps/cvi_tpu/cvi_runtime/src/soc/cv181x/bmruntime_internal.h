...
bmerr_t  cvi181x_dmabuf_relocate(uint8_t *dmabuf, uint64_t dmabuf_devaddr, uint32_t original_size,
...
void     cvi181x_arraybase_set(uint8_t *dmabuf, uint32_t arraybase0L, uint32_t arraybase1L,
