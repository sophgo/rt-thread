...
void               bmk1822_dmabuf_relocate(uint8_t *dmabuf, uint64_t dmabuf_devaddr, uint32_t original_size,
...
void               bmk1822_arraybase_set(uint8_t *dmabuf, uint32_t arraybase0L, uint32_t arraybase1L,
...
void bmk1822_add_dependency(bmk1822_context_t *ctx, bmk1822_op_t *before, bmk1822_op_t *after);

void bmk1822_cpu_op(bmk1822_context_t *ctx, const char *op_name, char *params, int size);
...
typedef struct
{
    ...
    uint8_t
            int8_rnd_mode; // <! 0 is round to nearset even, 1 is toward zero, currently used by lut
    uint8_t eu_align;
...
bmk1822_op_t *bmk1822_tdma_l2l_tensor_copy(bmk1822_context_t                          *ctx,
                                           const bmk1822_tdma_l2l_tensor_copy_param_t *p);

bmk1822_op_t *bmk1822_tdma_l2l_bf16_tensor_copy(bmk1822_context_t                          *ctx,
                                                const bmk1822_tdma_l2l_tensor_copy_param_t *p);
...
bmk1822_op_t *bmk1822_tdma_l2l_tensor_lrn_shift(bmk1822_context_t                               *ctx,
...
bmk1822_op_t *bmk1822_tdma_l2t_tensor_copy(bmk1822_context_t                           *ctx,
                                           const bmk1822_tdma_l2tg_tensor_copy_param_t *p);

bmk1822_op_t *bmk1822_tdma_l2g_tensor_copy(bmk1822_context_t                           *ctx,
                                           const bmk1822_tdma_l2tg_tensor_copy_param_t *p);

bmk1822_op_t *bmk1822_tdma_l2g_bf16_tensor_copy(bmk1822_context_t                           *ctx,
                                                const bmk1822_tdma_l2tg_tensor_copy_param_t *p);
...
bmk1822_op_t *bmk1822_tdma_l2t_tensor_copy_nc_transposed(
    bmk1822_context_t *ctx, const bmk1822_tdma_l2tg_tensor_copy_nc_transposed_param_t *p);
...
bmk1822_op_t *bmk1822_tdma_l2t_tensor_copy_cw_transposed(
    bmk1822_context_t *ctx, const bmk1822_tdma_l2tg_tensor_copy_cw_transposed_param_t *p);
...
bmk1822_op_t *bmk1822_tdma_l2g_tensor_copy_compressed(
    bmk1822_context_t *ctx, const bmk1822_tdma_l2tg_tensor_copy_compressed_param_t *p);
...
bmk1822_op_t *bmk1822_tdma_l2g_tensor_fill_constant(
    bmk1822_context_t *ctx, const bmk1822_tdma_l2tg_tensor_fill_constant_param_t *p);
...
bmk1822_op_t *bmk1822_tdma_l2g_matrix_copy(bmk1822_context_t                           *ctx,
                                           const bmk1822_tdma_l2tg_matrix_copy_param_t *p);

bmk1822_op_t *bmk1822_tdma_l2g_bf16_matrix_copy(bmk1822_context_t                           *ctx,
                                                const bmk1822_tdma_l2tg_matrix_copy_param_t *p);
...
bmk1822_op_t *bmk1822_tdma_l2t_general_copy(bmk1822_context_t                            *ctx,
                                            const bmk1822_tdma_l2tg_general_copy_param_t *p);

bmk1822_op_t *bmk1822_tdma_l2g_general_copy(bmk1822_context_t                            *ctx,
                                            const bmk1822_tdma_l2tg_general_copy_param_t *p);

bmk1822_op_t *bmk1822_tdma_l2g_bf16_general_copy(
    bmk1822_context_t *ctx, const bmk1822_tdma_l2tg_bf16_general_copy_param_t *p);
...
bmk1822_op_t *bmk1822_tdma_t2l_tensor_copy(bmk1822_context_t                           *ctx,
                                           const bmk1822_tdma_tg2l_tensor_copy_param_t *p);

bmk1822_op_t *bmk1822_tdma_g2l_tensor_copy(bmk1822_context_t                           *ctx,
                                           const bmk1822_tdma_tg2l_tensor_copy_param_t *p);

bmk1822_op_t *bmk1822_tdma_g2l_bf16_tensor_copy(bmk1822_context_t                           *ctx,
                                                const bmk1822_tdma_tg2l_tensor_copy_param_t *p);
...
bmk1822_op_t *bmk1822_tdma_t2l_tensor_copy_nc_transposed(
    bmk1822_context_t *ctx, const bmk1822_tdma_tg2l_tensor_copy_nc_transposed_param_t *p);
...
bmk1822_op_t *bmk1822_tdma_t2l_tensor_copy_chw_rotated(
    bmk1822_context_t *ctx, const bmk1822_tdma_tg2l_tensor_copy_chw_rotated_param_t *p);
...
bmk1822_op_t *bmk1822_tdma_t2l_tensor_copy_decompressed(
    bmk1822_context_t *ctx, const bmk1822_tdma_tg2l_tensor_copy_decompressed_param_t *p);
...
bmk1822_op_t *bmk1822_tdma_tg2l_tensor_fill_constant(
    bmk1822_context_t *ctx, const bmk1822_tdma_tg2l_tensor_fill_constant_param_t *p);
...
bmk1822_op_t *bmk1822_tdma_g2l_matrix_copy_decompressed(
    bmk1822_context_t *ctx, const bmk1822_tdma_tg2l_matrix_copy_decompressed_param_t *p);
...
bmk1822_op_t *bmk1822_tdma_l2g_matrix_copy_compressed(
    bmk1822_context_t *ctx, const bmk1822_tdma_l2tg_matrix_copy_compressed_param_t *p);
...
bmk1822_op_t *bmk1822_tdma_t2l_matrix_copy(bmk1822_context_t                           *ctx,
                                           const bmk1822_tdma_tg2l_matrix_copy_param_t *p);

bmk1822_op_t *bmk1822_tdma_g2l_matrix_copy(bmk1822_context_t                           *ctx,
                                           const bmk1822_tdma_tg2l_matrix_copy_param_t *p);

bmk1822_op_t *bmk1822_tdma_g2l_bf16_matrix_copy(bmk1822_context_t                           *ctx,
                                                const bmk1822_tdma_tg2l_matrix_copy_param_t *p);
...
bmk1822_op_t *bmk1822_tdma_t2l_matrix_copy_row_col_transposed(
    bmk1822_context_t *ctx, const bmk1822_tdma_tg2l_matrix_copy_row_col_transposed_param_t *p);
...
bmk1822_op_t *bmk1822_tdma_t2l_general_copy(bmk1822_context_t                            *ctx,
                                            const bmk1822_tdma_tg2l_general_copy_param_t *p);

bmk1822_op_t *bmk1822_tdma_g2l_general_copy(bmk1822_context_t                            *ctx,
                                            const bmk1822_tdma_tg2l_general_copy_param_t *p);

bmk1822_op_t *bmk1822_tdma_g2l_bf16_general_copy(
    bmk1822_context_t *ctx, const bmk1822_tdma_tg2l_bf16_general_copy_param_t *p);
...
bmk1822_op_t *bmk1822_tdma_tg2tg_general_copy(bmk1822_context_t                            *ctx,
                                              const bmk1822_tdma_tg2tg_tensor_copy_param_t *p);

bmk1822_op_t *bmk1822_tdma_tg2tg_bf16_general_copy(bmk1822_context_t                            *ctx,
                                                   const bmk1822_tdma_tg2tg_tensor_copy_param_t *p);

bmk1822_op_t *bmk1822_tdma_tg2tg_tensor_copy(bmk1822_context_t                            *ctx,
                                             const bmk1822_tdma_tg2tg_tensor_copy_param_t *p);

bmk1822_op_t *bmk1822_tdma_tg2tg_bf16_tensor_copy(bmk1822_context_t                            *ctx,
                                                  const bmk1822_tdma_tg2tg_tensor_copy_param_t *p);
...
bmk1822_op_t *bmk1822_tiu_element_wise_mul(bmk1822_context_t                          *ctx,
...
bmk1822_op_t *bmk1822_tiu_element_wise_mul_qdm(bmk1822_context_t                              *ctx,
...
bmk1822_op_t *bmk1822_tiu_element_wise_mac(bmk1822_context_t                          *ctx,
...
bmk1822_op_t *bmk1822_tiu_element_wise_add(bmk1822_context_t                          *ctx,
...
bmk1822_op_t *bmk1822_tiu_element_wise_sub(bmk1822_context_t                          *ctx,
...
bmk1822_op_t *bmk1822_tiu_element_wise_max(bmk1822_context_t                          *ctx,
...
bmk1822_op_t *bmk1822_tiu_element_wise_min(bmk1822_context_t                          *ctx,
...
bmk1822_op_t *bmk1822_tiu_element_wise_ge(bmk1822_context_t                         *ctx,
                                          const bmk1822_tiu_element_wise_ge_param_t *p);

bmk1822_op_t *bmk1822_tiu_bf16_element_wise_ge(bmk1822_context_t                         *ctx,
                                               const bmk1822_tiu_element_wise_ge_param_t *p);
...
bmk1822_op_t *bmk1822_tiu_element_wise_arith_shift(
    bmk1822_context_t *ctx, const bmk1822_tiu_element_wise_arith_shift_param_t *p);
...
bmk1822_op_t *bmk1822_tiu_element_wise_and_int8(bmk1822_context_t                               *ctx,
...
bmk1822_op_t *bmk1822_tiu_element_wise_and_int16(
    bmk1822_context_t *ctx, const bmk1822_tiu_element_wise_and_int16_param_t *p);
...
bmk1822_op_t *bmk1822_tiu_element_wise_or_int8(bmk1822_context_t                              *ctx,
...
bmk1822_op_t *bmk1822_tiu_element_wise_or_int16(bmk1822_context_t                               *ctx,
...
bmk1822_op_t *bmk1822_tiu_element_wise_xor_int8(bmk1822_context_t                               *ctx,
...
bmk1822_op_t *bmk1822_tiu_element_wise_xor_int16(
    bmk1822_context_t *ctx, const bmk1822_tiu_element_wise_xor_int16_param_t *p);
...
bmk1822_op_t *bmk1822_tiu_element_wise_copy(bmk1822_context_t                           *ctx,
...
bmk1822_op_t *bmk1822_tiu_mdsum(bmk1822_context_t *ctx, const bmk1822_tiu_mdsum_param_t *p);
...
bmk1822_op_t *bmk1822_tiu_lookup_table(bmk1822_context_t                      *ctx,
...
bmk1822_op_t *bmk1822_tiu_convolution(bmk1822_context_t                     *ctx,
...
bmk1822_op_t *bmk1822_tiu_convolution_qdm(bmk1822_context_t                         *ctx,
...
bmk1822_op_t *bmk1822_tiu_max_pooling(bmk1822_context_t                     *ctx,
...
bmk1822_op_t *bmk1822_tiu_min_pooling(bmk1822_context_t                     *ctx,
                                      const bmk1822_tiu_min_pooling_param_t *p);

bmk1822_op_t *bmk1822_tiu_bf16_min_pooling(bmk1822_context_t                     *ctx,
                                           const bmk1822_tiu_min_pooling_param_t *p);
...
bmk1822_op_t *bmk1822_tiu_average_pooling(bmk1822_context_t                         *ctx,
...
bmk1822_op_t *bmk1822_tiu_depthwise_convolution(bmk1822_context_t                               *ctx,
...
bmk1822_op_t *bmk1822_tiu_depthwise_convolution_qdm(
    bmk1822_context_t *ctx, const bmk1822_tiu_depthwise_convolution_qdm_param_t *p);
...
bmk1822_op_t *bmk1822_tiu_matrix_multiplication(bmk1822_context_t                               *ctx,
...
bmk1822_op_t *bmk1822_tiu_matrix_multiplication_qdm(
    bmk1822_context_t *ctx, const bmk1822_tiu_matrix_multiplication_qdm_param_t *p);

/*
 * Helpers
 */

bmk1822_tensor_lmem_stride_t bmk1822_tensor_lmem_default_stride(bmk1822_context_t          *ctx,
                                                                bmk1822_tensor_lmem_shape_t s,
                                                                fmt_t fmt_type, int eu_align);

bmk1822_tensor_tgmem_stride_t bmk1822_tensor_tgmem_default_stride(bmk1822_tensor_tgmem_shape_t s,
                                                                  fmt_t                        fmt_type);

bmk1822_matrix_lmem_shape_t bmk1822_matrix_lmem_default_shape(bmk1822_context_t *ctx, uint32_t row,
                                                              uint32_t col, fmt_t fmt_type);

bmk1822_matrix_lmem_shape_t bmk1822_matrix_lmem_shape_t1(bmk1822_context_t *ctx, uint32_t len,
                                                         fmt_t fmt_type);

bmk1822_matrix_lmem_stride_t bmk1822_matrix_lmem_default_stride(bmk1822_context_t          *ctx,
                                                                bmk1822_matrix_lmem_shape_t s,
                                                                fmt_t fmt, int eu_align);

bmk1822_tensor_lmem_t *bmk1822_lmem_alloc_tensor(bmk1822_context_t          *ctx,
                                                 bmk1822_tensor_lmem_shape_t s, fmt_t fmt,
                                                 int eu_align);

void bmk1822_lmem_init_tensor(bmk1822_context_t *ctx, bmk1822_tensor_lmem_t *tl,
                              bmk1822_tensor_lmem_shape_t shape, fmt_t fmt, int eu_align);

bmk1822_tensor_lmem_t *bmk1822_lmem_alloc_ps32_tensor(bmk1822_context_t          *ctx,
                                                      bmk1822_tensor_lmem_shape_t s, fmt_t fmt,
                                                      int eu_align);

void bmk1822_lmem_free_tensor(bmk1822_context_t *ctx, const bmk1822_tensor_lmem_t *t);

bmk1822_matrix_lmem_t *bmk1822_lmem_alloc_matrix(bmk1822_context_t          *ctx,
                                                 bmk1822_matrix_lmem_shape_t s, fmt_t fmt,
                                                 int eu_align);

void bmk1822_lmem_init_matrix(bmk1822_context_t *ctx, bmk1822_matrix_lmem_t *ml,
                              bmk1822_matrix_lmem_shape_t shape, fmt_t fmt, int eu_align);

bmk1822_matrix_lmem_t *bmk1822_lmem_alloc_ps32_matrix(bmk1822_context_t          *ctx,
                                                      bmk1822_matrix_lmem_shape_t s, fmt_t fmt,
                                                      int eu_align);

void bmk1822_lmem_free_matrix(bmk1822_context_t *ctx, const bmk1822_matrix_lmem_t *t);

uint32_t bmk1822_lmem_tensor_to_size(bmk1822_context_t *ctx, bmk1822_tensor_lmem_shape_t s,
                                     fmt_t fmt, int eu_align);

uint32_t bmk1822_lmem_matrix_to_size(bmk1822_context_t *ctx, bmk1822_matrix_lmem_shape_t s,
                                     fmt_t fmt, int eu_align);

uint32_t bmk1822_lmem_ps32_matrix_to_size(bmk1822_context_t *ctx, bmk1822_matrix_lmem_shape_t s,
                                          fmt_t fmt, int eu_align);
