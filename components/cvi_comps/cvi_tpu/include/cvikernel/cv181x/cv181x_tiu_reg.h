...
static inline void emit_tiu_reg(const tiu_reg_t *r, uint32_t *_p)
{
    ...
    p[27]                = (r->opd2_b_str & ((1u << 16) - 1)) | ((r->dummy7 & ((1u << 12) - 1)) << 16) | ((r->rsvd6 & ((1u << 4) - 1)) << 28);
    p[26]                = (r->opd2_h_str & ((1u << 16) - 1)) | ((r->opd2_w_str & ((1u << 16) - 1)) << 16);
    p[25]                = (r->opd2_n_str & ((1u << 16) - 1)) | ((r->opd2_c_str & ((1u << 16) - 1)) << 16);
    p[24]                = (r->opd1_w_str & ((1u << 16) - 1)) | ((r->opd1_b_str & ((1u << 16) - 1)) << 16);
    p[23]                = (r->opd1_h_str & ((1u << 16) - 1)) | ((r->dummy6 & ((1u << 12) - 1)) << 16) | ((r->rsvd5 & ((1u << 4) - 1)) << 28);
    p[22]                = (r->opd1_n_str & ((1u << 16) - 1)) | ((r->opd1_c_str & ((1u << 16) - 1)) << 16);
    p[21]                = (r->opd0_w_str & ((1u << 16) - 1)) | ((r->opd0_b_str & ((1u << 16) - 1)) << 16);
    p[20]                = (r->opd0_c_str & ((1u << 16) - 1)) | ((r->opd0_h_str & ((1u << 16) - 1)) << 16);
    p[19]                = (r->opd0_n_str & ((1u << 16) - 1)) | ((r->dummy5 & ((1u << 12) - 1)) << 16) | ((r->rsvd4 & ((1u << 4) - 1)) << 28);
    p[18]                = (r->res0_w_str & ((1u << 16) - 1)) | ((r->res0_b_str & ((1u << 16) - 1)) << 16);
    p[17]                = (r->res0_c_str & ((1u << 16) - 1)) | ((r->res0_h_str & ((1u << 16) - 1)) << 16);
    p[16]                = (r->layer_info & ((1u << 16) - 1)) | ((r->res0_n_str & ((1u << 16) - 1)) << 16);
    p[15]                = (r->opd2_h & ((1u << 12) - 1)) | ((r->opd2_w & ((1u << 12) - 1)) << 12) | ((r->dummy4 & ((1u << 4) - 1)) << 24) | ((r->rsvd3 & ((1u << 4) - 1)) << 28);
    p[14]                = ((r->opd1_w >> 4) & ((1u << 8) - 1)) | ((r->opd2_n & ((1u << 12) - 1)) << 8) | ((r->opd2_c & ((1u << 12) - 1)) << 20);
    p[13]                = ((r->opd1_n >> 8) & ((1u << 4) - 1)) | ((r->opd1_c & ((1u << 12) - 1)) << 4) | ((r->opd1_h & ((1u << 12) - 1)) << 16) | ((r->opd1_w & ((1u << 4) - 1)) << 28);
    p[12]                = (r->opd0_h & ((1u << 12) - 1)) | ((r->opd0_w & ((1u << 12) - 1)) << 12) | ((r->opd1_n & ((1u << 8) - 1)) << 24);
    p[11]                = (r->opd0_n & ((1u << 12) - 1)) | ((r->opd0_c & ((1u << 12) - 1)) << 12) | ((r->dummy3 & ((1u << 4) - 1)) << 24) | ((r->rsvd2 & ((1u << 4) - 1)) << 28);
    p[10]                = (r->opd2_addr & ((1u << 16) - 1)) | ((r->opt_opd0_const & 1) << 16) | ((r->opt_opd1_const & 1) << 17) | ((r->opt_opd2_const & 1) << 18) | ((r->short_nchwstr_same & 1) << 19) | ((r->short_res0_str & ((1u << 2) - 1)) << 20) | ((r->short_opd0_str & ((1u << 2) - 1)) << 22) | ((r->short_opd1_str & ((1u << 2) - 1)) << 24) | ((r->short_opd2_str & ((1u << 2) - 1)) << 26) | ((r->dummy2 & ((1u << 4) - 1)) << 28);
    p[9]                 = ((r->opd0_addr >> 8) & ((1u << 16) - 1)) | ((r->opd1_addr & ((1u << 16) - 1)) << 16);
    p[8]                 = (r->res0_addr & ((1u << 24) - 1)) | ((r->opd0_addr & ((1u << 8) - 1)) << 24);
    p[7]                 = ((r->res0_h >> 8) & ((1u << 4) - 1)) | ((r->res0_w & ((1u << 12) - 1)) << 4) | ((r->conv_op_x_str & ((1u << 5) - 1)) << 16) | ((r->conv_op_y_str & ((1u << 5) - 1)) << 21) | ((r->cmd_pre_exe & ((1u << 2) - 1)) << 26) | ((r->rsvd1 & ((1u << 4) - 1)) << 28);
    p[6]                 = (r->res0_n & ((1u << 12) - 1)) | ((r->res0_c & ((1u << 12) - 1)) << 12) | ((r->res0_h & ((1u << 8) - 1)) << 24);
    p[5]                 = (r->opd0_ins_val & ((1u << 16) - 1)) | ((r->conv_opd0_up_pad & ((1u << 4) - 1)) << 16) | ((r->conv_opd0_dn_pad & ((1u << 4) - 1)) << 20) | ((r->conv_opd0_lf_pad & ((1u << 4) - 1)) << 24) | ((r->conv_opd0_rt_pad & ((1u << 4) - 1)) << 28);
    p[4]                 = (r->conv_opd0_x_ins0 & ((1u << 4) - 1)) | ((r->conv_opd0_y_ins0 & ((1u << 4) - 1)) << 4) | ((r->conv_opd0_x_ins0_last & ((1u << 4) - 1)) << 8) | ((r->conv_opd0_y_ins0_last & ((1u << 4) - 1)) << 12) | ((r->conv_opd1_x_ins0 & ((1u << 4) - 1)) << 16) | ((r->conv_opd1_y_ins0 & ((1u << 4) - 1)) << 20) | ((r->dummy0 & ((1u << 8) - 1)) << 24);
    p[3]                 = (r->opt_res0_sign & 1) | ((r->opt_opd0_sign & 1) << 1) | ((r->opt_opd1_sign & 1) << 2) | ((r->opt_opd2_sign & 1) << 3) | ((r->opt_res0_seg & ((1u << 2) - 1)) << 4) | ((r->opt_opd0_seg & ((1u << 2) - 1)) << 6) | ((r->opt_opd1_seg & ((1u << 2) - 1)) << 8) | ((r->opt_opd2_seg & 1) << 10) | ((r->ps32_md & ((1u << 2) - 1)) << 11) | ((r->double_conv & 1) << 13) | ((r->opt_left_tran & 1) << 14) | ((r->fp_round_typ & 1) << 15) | ((r->opt_relu_typ & ((1u << 2) - 1)) << 16) | ((r->opt_relu_value & ((1u << 8) - 1)) << 18) | ((r->cmd_pre_exe_typ & 1) << 26) | ((r->opt_res_add & 1) << 27) | ((r->rsvd0 & ((1u << 4) - 1)) << 28);
    p[2]                 = (r->quan_m & (((uint64_t)1 << 32) - 1));
    p[1]                 = (r->cmd_id_tpu & ((1u << 16) - 1)) | ((r->cmd_id_gdma & ((1u << 16) - 1)) << 16);
    p[0]                 = (r->cmd_en & 1) | ((r->cmd_end & 1) << 1) | ((r->cmd_id_en & 1) << 2) | ((r->cmd_keep & 1) << 3) | ((r->cmd_intr_en & 1) << 4) | ((r->tsk_typ & ((1u << 4) - 1)) << 5) | ((r->tsk_eu_typ & ((1u << 5) - 1)) << 9) | ((r->tsk_opd_num & ((1u << 2) - 1)) << 14) | ((r->opt_res_shift & ((1u << 6) - 1)) << 16) | ((r->opt_left_shift & ((1u << 5) - 1)) << 22) | ((r->opt_shift_typ & 1) << 27) | ((r->opt_rshift_typ & 1) << 28) | ((r->dummy1 & 1) << 29) | ((r->opd_typ & 1) << 30) | ((r->opt_chl_quan & 1) << 31);
}
...
{
#define trace_one_reg(name) printf("  %s: 0x%llx\n", #name, (ullong)r->name)
