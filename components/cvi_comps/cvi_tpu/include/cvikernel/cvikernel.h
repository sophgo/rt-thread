...
typedef struct cvikernel_operations
{
    ...
    cvk_tl_t *(*lmem_alloc_tensor)(struct cvikernel_context *ctx, cvk_tl_shape_t shape,
                                   cvk_fmt_t fmt, int eu_align);

    cvk_ml_t *(*lmem_alloc_matrix)(struct cvikernel_context *ctx, cvk_ml_shape_t shape,
                                   cvk_fmt_t fmt, int eu_align);

    cvk_ml_t *(*lmem_alloc_ps32_matrix)(struct cvikernel_context *ctx, cvk_ml_shape_t shape,
                                        cvk_fmt_t fmt, int eu_align);
    ...
    void (*lmem_init_tensor)(struct cvikernel_context *ctx, cvk_tl_t *tl, cvk_tl_shape_t shape,
                             cvk_fmt_t fmt, int eu_align);

    void (*lmem_init_matrix)(struct cvikernel_context *ctx, cvk_ml_t *ml, cvk_ml_shape_t shape,
                             cvk_fmt_t fmt, int eu_align);

    cvk_tl_stride_t (*tl_default_stride)(struct cvikernel_context *ctx, cvk_tl_shape_t shape,
                                         cvk_fmt_t fmt, int eu_align);

    cvk_tg_stride_t (*tg_default_stride)(struct cvikernel_context *ctx, cvk_tg_shape_t shape,
                                         cvk_fmt_t fmt);

    cvk_ml_shape_t (*ml_default_shape)(struct cvikernel_context *ctx, uint32_t row, uint32_t col,
                                       cvk_fmt_t fmt);

    cvk_ml_stride_t (*ml_default_stride)(struct cvikernel_context *ctx, cvk_ml_shape_t shape,
                                         cvk_fmt_t fmt, int eu_align);

    cvk_ml_shape_t (*ml_shape_t1)(struct cvikernel_context *ctx, uint32_t len, cvk_fmt_t fmt);

    uint32_t (*lmem_tensor_to_size)(struct cvikernel_context *ctx, cvk_tl_shape_t shape,
                                    cvk_fmt_t fmt, int eu_align);

    uint32_t (*lmem_matrix_to_size)(struct cvikernel_context *ctx, cvk_ml_shape_t shape,
                                    cvk_fmt_t fmt, int eu_align);

    uint32_t (*lmem_ps32_matrix_to_size)(struct cvikernel_context *ctx, cvk_ml_shape_t shape,
                                         cvk_fmt_t fmt, int eu_align);

    void (*gmem_init_tensor)(struct cvikernel_context *ctx, cvk_tg_t *tg, cvk_tg_shape_t shape,
                             cvk_fmt_t fmt);

    /* Local to Local DMA API */
    void (*tdma_l2l_tensor_copy)(struct cvikernel_context               *ctx,
                                 const cvk_tdma_l2l_tensor_copy_param_t *param);
    void (*tdma_l2l_bf16_tensor_copy)(struct cvikernel_context               *ctx,
                                      const cvk_tdma_l2l_tensor_copy_param_t *param);
    void (*tdma_l2l_tensor_lrn_shift)(struct cvikernel_context                    *ctx,
    ...
    void (*tdma_l2g_bf16_tensor_copy)(struct cvikernel_context               *ctx,
                                      const cvk_tdma_l2g_tensor_copy_param_t *param);
    ...
    void (*tdma_l2g_tensor_fill_constant)(struct cvikernel_context                        *ctx,
    ...
    void (*tdma_l2g_bf16_matrix_copy)(struct cvikernel_context               *ctx,
                                      const cvk_tdma_l2g_matrix_copy_param_t *param);
    void (*tdma_l2g_general_copy)(struct cvikernel_context                *ctx,
                                  const cvk_tdma_l2g_general_copy_param_t *param);
    void (*tdma_l2g_bf16_general_copy)(struct cvikernel_context                     *ctx,
    ...
    void (*tdma_g2l_bf16_tensor_copy)(struct cvikernel_context               *ctx,
                                      const cvk_tdma_g2l_tensor_copy_param_t *param);
    ...
    void (*tdma_g2l_tensor_fill_constant)(struct cvikernel_context                        *ctx,
    ...
    void (*tdma_g2l_bf16_matrix_copy)(struct cvikernel_context               *ctx,
                                      const cvk_tdma_g2l_matrix_copy_param_t *param);
    ...
    void (*tdma_g2l_bf16_general_copy)(struct cvikernel_context                     *ctx,
    ...
    void (*tdma_g2g_general_copy)(struct cvikernel_context               *ctx,
                                  const cvk_tdma_g2g_tensor_copy_param_t *param);
    void (*tdma_g2g_bf16_general_copy)(struct cvikernel_context               *ctx,
                                       const cvk_tdma_g2g_tensor_copy_param_t *param);
    void (*tdma_g2g_bf16_tensor_copy)(struct cvikernel_context               *ctx,
                                      const cvk_tdma_g2g_tensor_copy_param_t *param);
    ...
    void (*tiu_bf16_lookup_interp_table)(struct cvikernel_context                       *ctx,
    ...
    void (*tiu_pt_depthwise_convolution)(struct cvikernel_context                       *ctx,
                                         const cvk_tiu_depthwise_pt_convolution_param_t *param);
    void (*tiu_depthwise_convolution)(struct cvikernel_context                    *ctx,
                                      const cvk_tiu_depthwise_convolution_param_t *param);
    void (*tiu_matrix_multiplication)(struct cvikernel_context                    *ctx,
                                      const cvk_tiu_matrix_multiplication_param_t *param);
    void (*tiu_matrix_multiplication_qm)(struct cvikernel_context                       *ctx,
...
typedef struct
{
    ...
    void (*bf16_table_shape)(struct cvikernel_context *ctx, cvk_tl_shape_t *shape);
