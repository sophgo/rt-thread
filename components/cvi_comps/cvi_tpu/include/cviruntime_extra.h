 ...
 */
CVI_KFUNC_HANDLE CVI_NN_PrepareMatrixMulKernelFunc(CVI_RT_HANDLE ctx, CVI_FMT fmt, uint32_t m,
                                                   uint32_t k, uint32_t n);
/*
 */
CVI_KFUNC_HANDLE CVI_NN_PrepareGrayImageLightKernelFunc(CVI_RT_HANDLE ctx, uint32_t ih, uint32_t iw,
                                                        uint32_t kernel_sz);
/*
