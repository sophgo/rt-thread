...
/**
    \defgroup glob_defs CSI Global Defines
...
/**
  \ingroup    core_register
  \defgroup   CLINT Core-Local Interrupt Controller (CLINT)
...
/**
  \ingroup    core_register
  \defgroup   PMP Physical Memory Protection (PMP)
...
/**
  \ingroup  core_register
  \defgroup CINT     Core Local Interrupt (CLINT)
...
/**
  ...
  \defgroup Core_VICFunctions VIC Functions
 ...
 */
__STATIC_INLINE void plic_enable_irq(uint64_t plic_base, int32_t IRQn)
{
...
/**
  ...
  \param [in]      IRQn  External interrupt number. Value cannot be negative.
 */
__STATIC_INLINE void plic_disable_irq(uint64_t plic_base, int32_t IRQn)
{
    PLIC_Type *plic = (PLIC_Type *)plic_base;
#if defined(CONFIG_RISCV_SMODE) && CONFIG_RISCV_SMODE
    plic->PLIC_H0_SIE[IRQn/32] = plic->PLIC_H0_SIE[IRQn/32] & (~(0x1 << (IRQn%32)));
...
/**
  ...
  \param [in]      IRQn  External interrupt number. Value cannot be negative.
 */
__STATIC_INLINE void plic_enable_sirq(uint64_t plic_base, int32_t IRQn)
{
    plic_enable_irq(plic_base, IRQn);
}
...
/**
  ...
  \param [in]      IRQn  External interrupt number. Value cannot be negative.
 */
__STATIC_INLINE void plic_disable_sirq(uint64_t plic_base, int32_t IRQn)
{
    plic_disable_irq(plic_base, IRQn);
}
 ...
 */
__STATIC_INLINE uint32_t plic_get_enabled_irq(uint64_t plic_base, int32_t IRQn)
{
    PLIC_Type *plic = (PLIC_Type *)plic_base;
#if defined(CONFIG_RISCV_SMODE) && CONFIG_RISCV_SMODE
 ...
 */
__STATIC_INLINE uint32_t plic_get_pending_irq(uint64_t plic_base, int32_t IRQn)
{
    PLIC_Type *plic = (PLIC_Type *)plic_base;
 ...
 */
__STATIC_INLINE void plic_set_pending_irq(uint64_t plic_base, int32_t IRQn)
{
    PLIC_Type *plic = (PLIC_Type *)plic_base;
...
/**
  ...
  \param [in]      IRQn  External interrupt number. Value cannot be negative.
 */
__STATIC_INLINE void plic_clear_pending_irq(uint64_t plic_base, int32_t IRQn)
{
    PLIC_Type *plic = (PLIC_Type *)plic_base;
 ...
 */
__STATIC_INLINE void plic_set_prio(uint64_t plic_base, int32_t IRQn, uint32_t priority)
{
    PLIC_Type *plic = (PLIC_Type *)plic_base;
 ...
 */
__STATIC_INLINE uint32_t plic_get_prio(uint64_t plic_base, int32_t IRQn)
{
    PLIC_Type *plic = (PLIC_Type *)plic_base;
 ...
 */
__STATIC_INLINE void plic_set_vector(int32_t IRQn, uint64_t handler)
{
    if (IRQn >= 0 && IRQn < 1024) {
...
/**
  ...
  \param [in]      IRQn  Interrupt number.
 */
__STATIC_INLINE uint32_t plic_get_vector(int32_t IRQn)
{
    if (IRQn >= 0 && IRQn < 1024) {
        uint64_t *vectors = (uint64_t *)__get_MTVT();
...
/*@} end of Core_VICFunctions */

/* ##########################   PMP functions  #################################### */
/**
  \ingroup  Core_FunctionInterface
  \defgroup Core_PMPFunctions PMP Functions
  \brief    Functions that manage interrupts and exceptions via the VIC.
  @{
 */
...
/**
  ...
  */
__STATIC_INLINE void mpu_config_region(uint32_t idx, uint32_t base_addr, region_size_e size,
...
/**
  ...
  \param [in]  idx        memory protected region (0, 1, 2, ..., 15).
  */
__STATIC_INLINE void mpu_disable_region(uint32_t idx)
{
    __set_PMPxCFG(idx, __get_PMPxCFG(idx) & (~PMP_PMPCFG_A_Msk));
}

/*@} end of Core_PMPFunctions */
 ...
 */
__STATIC_INLINE uint32_t clint_config(uint64_t clint_base, uint32_t ticks, int32_t IRQn)
{
...
__STATIC_INLINE void coret_reset_value(uint64_t clint_base)
{
    uint32_t value = 0x0;
    CLINT_Type *clint = (CLINT_Type *)clint_base;
 ...
 */
__STATIC_INLINE uint64_t clint_get_load(uint64_t clint_base)
{
    CLINT_Type *clint = (CLINT_Type *)clint_base;
#if defined(CONFIG_RISCV_SMODE) && CONFIG_RISCV_SMODE
    uint64_t value = (((uint64_t)clint->STIMECMPH0) << 32) + (uint64_t)clint->STIMECMPL0;
...
/**
  ...
  \return          CORE timer counter value.
 */
__STATIC_INLINE uint32_t clint_get_loadh(uint64_t clint_base)
{
    CLINT_Type *clint = (CLINT_Type *)clint_base;
#if defined(CONFIG_RISCV_SMODE) && CONFIG_RISCV_SMODE
    uint64_t value = (((uint64_t)clint->STIMECMPH0) << 32) + (uint64_t)clint->STIMECMPL0;
...
/**
  ...
  \return          CORE timer counter value.
 */
__STATIC_INLINE uint64_t clint_get_value(void)
{
    uint64_t result;
...
/**
  ...
  \return          CORE timer counter value.
 */
__STATIC_INLINE uint32_t clint_get_valueh(void)
{
    uint64_t result;
...
/**
  \ingroup  Core_FunctionInterface
  \defgroup Core_CacheFunctions Cache Functions
...
/**
  ...
  */
__STATIC_INLINE int icache_is_enable()
{
...
*/
__STATIC_INLINE void icache_invalid_range(uint64_t *addr, int64_t dsize)
{
#if (__ICACHE_PRESENT == 1U)
    ...
    if (cpu_work_mode == MACHINE_MODE) {
        while (op_size > 0) {
            __ICACHE_IPA(op_addr);
            op_addr += linesize;
            op_size -= linesize;
        }
    } else if (cpu_work_mode == SUPERVISOR_MODE) {
        while (op_size > 0) {
            __ICACHE_IVA(op_addr);
            op_addr += linesize;
            op_size -= linesize;
        }
    }
...
/**
  ...
  */
__STATIC_INLINE int dcache_is_enable()
{
    uint32_t cache = __get_MHCR();
...
/**
  ...
  \note
  */
__STATIC_INLINE void l2cache_invalid(void)
{
...
/**
  ...
  \note
  */
__STATIC_INLINE void l2cache_clean(void)
{
#if (__L2CACHE_PRESENT == 1U)
    __DSB();
    __ISB();
...
/**
  ...
  \note
  */
__STATIC_INLINE void l2cache_clean_invalid(void)
{
#if (__L2CACHE_PRESENT == 1U)
    __DSB();
    __ISB();
...
/**
  ...
  \param[in]   dsize   size of memory block (in number of bytes)
*/
__STATIC_INLINE void dcache_invalid_range(uint64_t *addr, int64_t dsize)
{
#if (__DCACHE_PRESENT == 1U)
    int64_t op_size = dsize + (uint64_t)addr % 64;
    uint64_t op_addr = (uint64_t)addr;
...
/**
  ...
  \param[in]   dsize   size of memory block (in number of bytes)
*/
__STATIC_INLINE void dcache_clean_range(uint64_t *addr, int64_t dsize)
{
...
*/
__STATIC_INLINE void dcache_clean_invalid_range(uint64_t *addr, int64_t dsize)
{
#if (__DCACHE_PRESENT == 1U)
    int64_t op_size = dsize + (uint64_t)addr % 64;
    uint64_t op_addr = (uint64_t) addr;
...
/**
  ...
  */
__STATIC_INLINE void cache_set_range (uint64_t index, uint64_t baseAddr, uint64_t size, uint64_t enable)
{
    ;
}
...
/**
  ...
  */
__STATIC_INLINE void cache_enable_profile(void)
{
    ;
}
...
/**
  ...
  */
__STATIC_INLINE void cache_disable_profile(void)
{
    ;
}
...
/**
  ...
  */
__STATIC_INLINE void cache_reset_profile(void)
{
    ;
}
...
/**
  ...
  */
__STATIC_INLINE uint64_t cache_get_access_time(void)
{
    return 0;
}
...
/**
  ...
  */
__STATIC_INLINE uint64_t cache_get_miss_time(void)
{
    return 0;
}

/*@} end of Core_CacheFunctions */


/* ##########################  MMU functions  #################################### */
/**
  \ingroup  Core_FunctionInterface
  \defgroup Core_MMUFunctions MMU Functions
...
/**
  ...
  \details
  */
__STATIC_INLINE void mmu_enable(mmu_mode_e mode)
{
...
/**
  ...
  \details
  */
__STATIC_INLINE void mmu_invalid_tlb_all(void)
{
...
/**
  ...
  \details
  */
__STATIC_INLINE void mmu_invalid_tlb_by_asid(unsigned long asid)
{
...
/**
  ...
  \details
  */
__STATIC_INLINE void mmu_invalid_tlb_by_page(unsigned long asid, unsigned long addr)
{
...
/**
  ...
  \details
  */
__STATIC_INLINE void mmu_invalid_tlb_by_range(unsigned long asid, page_size_e page_size, unsigned long start_addr, unsigned long end_addr)
{
 ...
 */
__STATIC_INLINE uint64_t irq_save(void)
{
    uint64_t result;
#if defined(CONFIG_RISCV_SMODE) && CONFIG_RISCV_SMODE
 ...
 */
__STATIC_INLINE void irq_restore(uint64_t irq_state)
{
#if defined(CONFIG_RISCV_SMODE) && CONFIG_RISCV_SMODE
 ...
 */
__STATIC_INLINE int vlenb_get_value(void)
{
    int result;
